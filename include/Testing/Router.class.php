...
class Router {
    ...
    private function getHeaderTitle($action_name) {
        $header_title = array(
            'index' => $GLOBALS['Language']->getText('plugin_testing', 'service_lbl_key'),
    ...
    private function getService(Codendi_Request $request) {
        if ($this->service == null) {
            ...
            $this->service = $project->getService('plugin_testing');
        }
        return $this->service;
    }
    ...
    private function displayHeader(
        ...
        if ($this->userIsAdmin($request)) {
            $toolbar[] = array(
                ...
                'url'   => TESTING_BASE_URL .'/?'. http_build_query(array(
