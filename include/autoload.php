...
function autoloade7a66df186fb8b127c5cfe9efc52279d($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\botmattermost\\senderservices\\notificationbuilder' => '/SenderServices/NotificationBuilder.php',
...
spl_autoload_register('autoloade7a66df186fb8b127c5cfe9efc52279d');
