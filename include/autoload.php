...
function autoloadb5a72436d418df2fce02f9c3e0aeac0d($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\botmattermost\\botmattermostdeleted' => '/BotMattermost/BotMattermostDeleted.php',
...
spl_autoload_register('autoloadb5a72436d418df2fce02f9c3e0aeac0d');
