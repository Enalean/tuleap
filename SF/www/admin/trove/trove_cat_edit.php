...
$HTML->header(array(title=>$LANG->getText('admin_trove_cat_edit','title')));
?>

<H2><?php echo $LANG->getText('admin_trove_cat_edit','header'); ?></H2>
...
print ('<OPTION value="0"');
	...
	print ('>'.$LANG->getText('admin_trove_cat_edit','root')."\n");
