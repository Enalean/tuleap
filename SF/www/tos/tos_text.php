...
<p>
<h2>CodeX Terms of Service Agreement</h2>
</p>
...
<p>
A person's use of CodeX and any of its Services (as defined below) at
any time is subject to CodeX's then-current Terms of Service ("TOS"),
which may be updated from time to time as set forth below. Each user can
review the then-current TOS at any time at:
<a href="http://codex.xerox.com/tos/tos.php">http://codex.xerox.com/tos/tos.php.</a>.  In addition, each user's use of
...
reference into the TOS.  A user's use of  CodeX and/or its Services
constitutes full acceptance of and agreement to the TOS; if a user does not
accept our TOS, he or she is not granted rights to use CodeX or any of
its Services, as defined herein, and should refrain from accessing
CodeX and its Services.
</p>
...
<p>
CodeX reserves the right at any time and from time to time to modify
or discontinue, temporarily or permanently, CodeX or any Service
...
CodeX shall not be liable to any user or other third party for any
...
<p>
CodeX is a website owned and operated by Xerox for
the purpose of fostering the cross-organizational software development as well as content and source code sharing under
 the terms of the Xerox Code eXchange Policy.  CodeX currently offers users access to a
...
thereunder.    CodeX cannot and will not be liable for any loss or
...
CodeX of any unauthorized use of his or her password or account or any
...
that the user, and not the CodeX team, is entirely responsible for all Content
that he or she uploads, posts, emails or otherwise transmits via CodeX
or any Service. No user shall transmit Content or otherwise conduct or
participate in any activities on CodeX and/or any Service which, in
the opinion of CodeX's counsel, are in contradiction with Xerox internal policies.
</p>

<p>
CodeX will not pre-screen or review Content, but CodeX reserves
the right to refuse or delete any Content of which it becomes aware which it
reasonably deems not to fulfill the Purpose. In addition, CodeX shall
...
otherwise illegal.  <!-- LJ CodeX, in its sole and absolute discretion, may
...
us to protect the rights, property or personal safety of CodeX, its
users and the public -->. CodeX does not control the Content posted via
the Service and, as such, does not guarantee the accuracy, integrity or
quality of such Content. Under no circumstances will CodeX be liable
...
transmitted via CodeX or any Service thereon.
</p>
...
<p>
CodeX may establish general practices and limits concerning use of the
Services, as defined by posted Service-specific Rules.  While CodeX
will use reasonable efforts to <a href="/docman/display_doc.php?docid=17&group_id=1#whyhost-backup" target="side_window">/back up</a> site data and make such data
available in the event of loss or deletion, CodeX has no
...
by any Service. CodeX reserves the right to mark as "inactive" and
archive accounts and/or projects that are inactive for an extended period of
time. CodeX reserves the right to change these general practices and
...
<p>
CodeX's termination of any user's access to CodeX or any Service
hereunder may be effected without notice and, on such termination,
CodeX may immediately deactivate or delete user's account and/or bar
any further access to such files, that Service or CodeX.  CodeX
...
or any other matters to the <a href="/contact.php">CodeX Support Team</a>.
</p>


<p>
Content owned by Xerox Inc. copyright 2000, Xerox Inc.  All rights reserved.
</p>
