...
svn_header(array ('title'=>'Subversion Browsing',
...
echo '<FORM name="commit_form" ACTION="'. $PHP_SELF .'" METHOD="GET">
	...
	<INPUT TYPE="HIDDEN" NAME="set" VALUE="custom">
        <TR align="center"><TD><b>Revision</b></TD><TD><b>Commiter</b></TD><TD><b>Path</b></TD><TD><b>Keyword search in log message</b></TD>'.
'</TR>'.
