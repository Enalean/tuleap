...
<p>The CodeX Bug Tracking System (BTS) offers a rich set of features to help you sort your bug selection in the most convenient way. 
...
(<img src="/images/up_arrow.gif" border="0">) or 
down (<img src="/images/dn_arrow.gif" border="0">) arrow 
...
<p>Also notice that At any point in the multi-column sort process, a click
on one of the sort criteria displayed in the list (criteria 1 > criteria 2 > criteria 3...) 
will bring you back in the sort criteria list. Using this feature you can
easily test various sorting strategies. 
