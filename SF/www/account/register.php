...
function register_valid($confirm_hash)	{
    global $HTTP_POST_VARS, $G_USER, $Language;
...
<?php print $Language->getText('account_register', 'tz_directions'); ?>
<P>
...
<p>
<?php print $Language->getText('account_register', 'mandatory', array($star)); ?>
</p>
