...
<P>
All <B>support questions</B> related to <?php print $GLOBALS['sys_name']; ?> use should be submitted through the <?php print $GLOBALS['sys_name']; ?>  
...
<A href="mailto:codex-contact@codex.xerox.com">[ <?php print $GLOBALS['sys_name']; ?> contact ]</A>

<P>Alternatively, you may also contact any member of the <A href="staff.php">[ <?php print $GLOBALS['sys_name']; ?> Team ]</A> individually directly via email.
