...
insert into service (service_id, group_id, label, description, short_name, link, is_active, is_used, scope, rank) VALUES (7, 100, 'Patches', 'Patch Manager', 'patch', '/patch/?group_id=$group_id', 0, 0, 'system', 70);
