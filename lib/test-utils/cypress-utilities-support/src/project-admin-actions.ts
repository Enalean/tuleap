...
function preventAccidentallyContinuingTheTestAsProjectAdmin(): void {
    cy.anonymousSession();
}

export function registerProjectAdminCommands(): void {
    ...
    Cypress.Commands.add(
        ...
        (project_unix_name: string, visibility: string): void => {
            ...
            cy.get("[data-test=project-details-short-description-input]").type(
    ...
    Cypress.Commands.add(
        "enableService",
        (project_name: string, service_short_name: string): void => {
