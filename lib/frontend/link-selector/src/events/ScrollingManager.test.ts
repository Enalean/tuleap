...
describe("ScrollingManager", () => {
    function getModalElements(): {
        ...
        wrapper_element.setAttribute("class", "link-selector-component-wrapper");
    ...
    describe("findListPickerFirstScrollableParent", () => {
        it("should return the first scrollable parent of the link-selector", () => {
            ["overflow", "overflow-y", "overflow-x"].forEach((overflow_property) => {
                ["auto", "scroll"].forEach((overflow_value) => {
                    ...
                    expect(
                        scrolling_manager.findLinkSelectorFirstScrollableParent(wrapper_element)
    ...
    describe("scrolling lock/unlock", () => {
        ...
        describe("lockScrolling", () => {
            it("should not lock the page scrolling when the link-selector is not in a modal", () => {
            ...
            it("should lock the page scrolling when the link-selector is not in a modal", () => {
                const { wrapper_element } = getModalElements();
                const scrolling_manager = new ScrollingManager(wrapper_element);
