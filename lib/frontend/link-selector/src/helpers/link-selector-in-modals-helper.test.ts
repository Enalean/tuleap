...
import { isLinkSelectorInAModal } from "./link-selector-in-modals-helper";

describe("link-selector-in-modals-helper", () => {
    ...
    describe("isLinkSelectorInAModal", () => {
        it("should return true when the wrapper element is in a tlp modal", () => {
            ...
            expect(isLinkSelectorInAModal(wrapper_element)).toBe(true);
        });
        ...
        it("should return false otherwise", () => {
            ...
            expect(isLinkSelectorInAModal(wrapper_element)).toBe(false);
        });
    });
});
