...
export const buildSelectedValueBadgeElement = (
    ...
    render(
        html`
            <span
                data-test="link-selector-selected-value"
                class="link-selector-selected-value-badge tlp-badge-primary tlp-badge-outline"
                data-item-id="${item.id}"
            >
                <span
                    role="presentation"
                    data-test="remove-value-button"
                    class="link-selector-value-remove-button"
