...
import type { LinkSelectorTemplatingCallback } from "../../src/type";
import type { LinkSelectorItem } from "../../src/items/GroupCollection";
...
const getItemValue = (item: LinkSelectorItem): string => {
