...
export class ListItemHighlighter {
    ...
    public getHighlightedItem(): Element | null {
        return this.dropdown_list_element.querySelector(".lazybox-item-highlighted");
    }

    public highlightItem(item_to_highlight: Element): void {
        this.removeHighlights();
        item_to_highlight.classList.add("lazybox-item-highlighted");
    }

    private removeHighlights(): void {
        this.dropdown_list_element
            .querySelectorAll(".lazybox-item-highlighted")
            .forEach((item) => item.classList.remove("lazybox-item-highlighted"));
    }
