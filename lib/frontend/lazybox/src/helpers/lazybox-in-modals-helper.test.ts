...
import { isLazyboxInAModal } from "./lazybox-in-modals-helper";

describe("lazybox-in-modals-helper", () => {
    ...
    describe("isLazyboxInAModal", () => {
        it("should return true when the wrapper element is in a tlp modal", () => {
            ...
            expect(isLazyboxInAModal(wrapper_element)).toBe(true);
        });
        ...
        it("should return false otherwise", () => {
            ...
            expect(isLazyboxInAModal(wrapper_element)).toBe(false);
        });
    });
});
