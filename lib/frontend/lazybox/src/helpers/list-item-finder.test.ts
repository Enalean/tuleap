...
describe("list-item-finder", () => {
    ...
    function generateList(): {
        ...
        item_2.setAttribute("class", "lazybox-dropdown-option-value-disabled");
        ...
        item_4.setAttribute("class", "lazybox-dropdown-option-value-disabled");
        const item_5 = document.createElement("li");
        item_5.setAttribute("class", "lazybox-dropdown-option-value");
