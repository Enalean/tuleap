...
export class ScrollingManager {
    ...
    constructor(private readonly wrapper_element: HTMLElement) {
        this.first_scrollable_parent = this.findListPickerFirstScrollableParent(
    ...
    public lockScrolling(): void {
        if (isListPickerInAModal(this.wrapper_element)) {
    ...
    public findListPickerFirstScrollableParent(wrapper_element: HTMLElement): HTMLElement | null {
