...
describe("svg-arrow-path", () => {
    describe("getDownRightArrow", () => {
        it("Computes a down right path", () => {
            expect(
                removeExtraWhitespaces(getDownRightArrow(100, 100, TASK_HEIGHT_IN_PX)),
        ...
        it("Zigzags if width is lesser than thresold", () => {
            expect(
                removeExtraWhitespaces(getDownRightArrow(threshold - 10, 100, TASK_HEIGHT_IN_PX)),
            ).toMatchInlineSnapshot(
    ...
    describe("getDownLeftArrow", () => {
        it("Computes a down right path", () => {
            expect(
                removeExtraWhitespaces(getDownLeftArrow(100, 100, TASK_HEIGHT_IN_PX)),
            ).toMatchInlineSnapshot(
    ...
    describe("getUpRightArrow", () => {
        it("Computes a down right path", () => {
            expect(
                removeExtraWhitespaces(getUpRightArrow(100, 100, TASK_HEIGHT_IN_PX)),
            ).toMatchInlineSnapshot(
        ...
        it("Zigzags if width is lesser than thresold", () => {
            expect(
                removeExtraWhitespaces(getUpRightArrow(threshold - 10, 100, TASK_HEIGHT_IN_PX)),
            ).toMatchInlineSnapshot(
    ...
    describe("getUpLeftArrow", () => {
        it("Computes a down right path", () => {
            expect(
                removeExtraWhitespaces(getUpLeftArrow(100, 100, TASK_HEIGHT_IN_PX)),
            ).toMatchInlineSnapshot(
