...
Requires:	php(language) >= 5.3, tuleap-plugin-agiledashboard, tuleap-plugin-botmattermost
...
%{__cp} -ar db include site-content template ChangeLog README.mkd VERSION $RPM_BUILD_ROOT/%{_datadir}/tuleap/plugins/botmattermost_agiledashboard
