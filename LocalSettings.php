...
function SetupPermissionsFromRoles () {
	...
	$rs = $g->getRoles() ;
$wgGroupPermissions['*']['read'] = 1;

$wgGroupPermissions['*']['edit']               = 1;
$wgGroupPermissions['*']['writeapi']           = 1;
$wgGroupPermissions['*']['createpage']         = 1;
$wgGroupPermissions['*']['createtalk']         = 1;
$wgGroupPermissions['*']['minoredit']          = 1;
$wgGroupPermissions['*']['move']               = 1;
$wgGroupPermissions['*']['move-subpages']      = 1;
$wgGroupPermissions['*']['move-rootuserpages'] = 1;
$wgGroupPermissions['*']['delete']             = 1;
$wgGroupPermissions['*']['undelete']           = 1;
	foreach ($rs as $r) {
