...
<xsl:template name="book.titlepage.recto">
  ...
  <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" border-after-color="black" 
            ...
            margin-left="-1pc"
            margin-right="-1pc">
          <fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" padding-before="-1.25em" padding-after="10em" display-align="center" text-align="center">
            <fo:external-graphic xmlns:fo="http://www.w3.org/1999/XSL/Format" content-width="auto"
                                 height="auto"
                                 content-height="auto"
                                 width="auto"
...
<xsl:template name="book.titlepage.verso">
  ...
  <!-- CX-SBT: Add the revision history -->
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="bookinfo/revhistory"/>
  
  <!-- CX-SBT: Just authogroup, copyright and legalnotice -->
...
<!-- CX-SBT: Use a bigger font -->
<xsl:template match="title" mode="book.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="36pt" space-before="18.6624pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="division.title">
...
<!-- CX-SBT: Use an italic font + adjust margin -->
<xsl:template match="subtitle" mode="book.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" font-weight="normal" text-align="center" font-size="20pt" space-before="15.552pt" font-family="{$title.font.family}" font-style="italic" margin-left="1.5em" margin-right="1.5em">
...
<!-- CX-SBT: Add a space before this block -->
...
<!-- CX-SBT: Add a space beofre this block -->
<xsl:template match="copyright" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style" space-before="20em">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="chapter.titlepage.recto.style" margin-left="{$title.margin.left}" font-size="22pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="component.title">
