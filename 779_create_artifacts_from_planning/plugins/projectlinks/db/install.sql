--
-- Table structure for table 'plugin_projectlinks_link_type'
--
...
CREATE TABLE plugin_projectlinks_link_type (
...
--
-- Table structure for table 'plugin_projectlinks_relationship'
--
-- link_type_id:      Index to plugin_projectlinks_link_type table to define the link
...
CREATE TABLE plugin_projectlinks_relationship (
