...
class GraphOnTrackersV5_Report extends Error{ 
    ...
    */    
    ...
    function fetchData(){
        ...
        $sql = sprintf('SELECT *
                        FROM plugin_graphontrackersv5_report_graphic 
    ...
    */
    ...
    function update() {
        $sql = sprintf("UPDATE plugin_graphontrackersv5_report_graphic 
    ...
    */
    ...
    function delete() {
        ...
        $sql = sprintf('DELETE FROM plugin_graphontrackersv5_report_graphic 
                        WHERE report_graphic_id=%d',
                        db_ei($this->id)
                      );
    ...
    public static function create($atid, $user_id, $name, $description, $scope) {
        ...
        if($res && db_affected_rows($res)) {
            $report = new GraphOnTrackersV5_Report(db_insertid($res));
        }
        return $report;
    }
