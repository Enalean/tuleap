...
class SystemEvent_COMPUTE_MD5SUM_Test extends UnitTestCase {
    ...
    public function testComputeMd5sumSucceed() {
        ...
        $file->setReturnValue('getFileLocation', '/var/lib/tuleap/ftp/tuleap/project_1/p2952_r10819/test.dump');
    ...
    public function testComputeMd5sumUpdateDBFailure() {
        ...
        $file->setReturnValue('getFileLocation', '/var/lib/tuleap/ftp/tuleap/project_1/p1827_r6573/webkit-1.0.tar.gz');
