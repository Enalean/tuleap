...
if [ $? -eq 1 ]; then
   ...
   if [ "$yn" = "n" ]; then
    ...
    # use codexadm however it will be changed to codendiadm later in the migration
    echo "export JAVA_HOME=/usr/lib/jvm/java-1.6.0-openjdk-1.6.0.0/jre" >> /home/codexadm/.profile
fi
