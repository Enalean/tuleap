...
# Checkstyle
php -d memory_limit=256M /usr/bin/phpcs --standard=$WORKSPACE/trunk/codendi_tools/utils/phpcs/Codendi $WORKSPACE/trunk/src/common/ --report=checkstyle --ignore=*/phpwiki/* > $WORKSPACE/var/tmp/checkstyle.xml 
