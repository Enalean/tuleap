...
) ENGINE= DEFAULT CHARSET=utf8 MAX_ROWS=1000000 AVG_ROW_LENGTH=1000000;
SET character_set_client = @saved_cs_client;
...
) ENGINE= AUTO_INCREMENT=100 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE= AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `plugin_docman_metadata_love` (
  ...
  KEY `name` (`name`(10)),
  KEY `idx_fv_status` (`status`)
) ENGINE= AUTO_INCREMENT=101 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `reference` (
  ...
  KEY `scope_idx` (`scope`)
) ENGINE= AUTO_INCREMENT=23 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE= AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
) ENGINE= AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2012-01-19  8:55:45
