        ...
        <div class="ttm-definition-step">
            ...
            <div class="ttm-definition-step-description">
                    ...
                    <div class="ttm-definition-step-description-deleted">
                        ...
                        <section class="ttm-definition-step-expected">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="11" viewBox="0 0 16 11"
                                 class="ttm-definition-step-expected-arrow">
                ...
                <div v-show="! is_marked_as_deleted">
                    ...
                    <input type="hidden" v-bind:name="'artifact[' + fieldId + '][description_format][]'"
                           v-model="format">
                    <textarea
                        ref="description"
                    ...
                    <section class="ttm-definition-step-expected">
                        ...
                        <div class="ttm-definition-step-expected-edit">
                            ...
                            <input type="hidden" v-bind:name="'artifact[' + fieldId + '][expected_results_format][]'"
                                   v-model="format">
                            <textarea
...
export default {
    ...
    methods: {
        ...
        addStep() {
            this.$emit("addStep", this.dynamicRank);
        },
        loadRTE(field) {
