...
const assets_dir_path = path.resolve(__dirname, "../../../src/www/assets/baseline/scripts");
const assets_public_path = "/assets/baseline/scripts/";

const webpack_config = {
    entry: {
        baseline: "./baseline/index.js"
    },
