...
final class BrowserDeprecationMessageTest extends \Tuleap\Test\PHPUnit\TestCase
{
    ...
    {
        \ForgeConfig::set('disable_old_browsers_warning', '2025W15_I_understand_this_only_hides_the_message_for_non_siteadmin_users_and_that_issues_related_to_old_browsers_will_still_be_present');
    ...
    private function buildDetectedBrowserFromUserAgent(string $user_agent): DetectedBrowser
    {
        ...
        $request->method('getFromServer')->willReturn($user_agent);
