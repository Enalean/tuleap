...
final class ProjectRegistrationCheckerBlockErrorSetTest extends TestCase
{
    public function testItCollectsErrorAndStopsAtFirstCollectorThatHaveErrors(): void
    {
        ...
        $checker_block_error_set = new ProjectRegistrationCheckerBlockErrorSet(
            $checker_01,
            $checker_02,
            $checker_03,
        );
        ...
        self::assertCount(1, $collected_errors->getErrors());
    }
