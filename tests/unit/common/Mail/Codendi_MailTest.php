...
final class Codendi_MailTest extends \Tuleap\Test\PHPUnit\TestCase // phpcs:ignore Squiz.Classes.ValidClassName.NotPascalCase
{
    ...
    public function testTemplateLookAndFeel(): void
    {
        ...
        $tpl->expects($this->once())->method('set');
