...
final class SMTPAuthTypeValidatorTest extends TestCase
{
    ...
    {
        $this->validator = SMTPAuthTypeValidator::buildSelf();
    }

    public function testAcceptsValidValues(): void
    {
        $this->expectNotToPerformAssertions();
        $this->validator->checkIsValid('login');
        $this->validator->checkIsValid('plain');
    }

    public function testRejectsIncorrectAuthType(): void
    {
        $this->expectException(InvalidConfigKeyValueException::class);
        $this->validator->checkIsValid('tuleap');
    }
}
