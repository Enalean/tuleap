...
seed_data() {
    su -c "PHP='$PHP_CLI' /usr/share/tuleap/src/utils/php-launcher.sh /usr/share/tuleap/tools/utils/admin/activate_plugin.php docman" -l codendiadm
...
case "$PHP_FPM" in
    ...
    /usr/share/tuleap/src/tuleap-cfg/tuleap-cfg.php site-deploy --php-version=php73
    ;;
    '/opt/remi/php74/root/usr/sbin/php-fpm')
    echo "Deploy PHP FPM 7.4"
    /usr/share/tuleap/src/tuleap-cfg/tuleap-cfg.php site-deploy --php-version=php74
    ;;
esac
"$PHP_FPM" --daemonize
nginx
