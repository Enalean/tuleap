...
class MilestoneTest extends RestBase {
    ...
    public function testGETBacklog() {
        ...
        $this->assertEquals($first_backlog_item['artifact'], array('id' => 9, 'uri' => 'artifacts/9', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
        ...
        $this->assertEquals($second_backlog_item['artifact'], array('id' => 10, 'uri' => 'artifacts/10', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
        ...
        $this->assertEquals($third_backlog_item['artifact'], array('id' => 11, 'uri' => 'artifacts/11', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
    ...
    public function testPUTBacklogWithAllIds() {
        ...
        $this->assertCount(3, $backlog_items);
        $this->assertEquals($backlog_items[0]['artifact'], array('id' => 11, 'uri' => 'artifacts/11', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
        $this->assertEquals($backlog_items[1]['artifact'], array('id' => 9, 'uri' => 'artifacts/9', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
        $this->assertEquals($backlog_items[2]['artifact'], array('id' => 10, 'uri' => 'artifacts/10', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
    }
    ...
    public function testPUTBacklogWithSomeIds() {
        ...
        $this->assertCount(3, $backlog_items);
        $this->assertEquals($backlog_items[0]['artifact'], array('id' => 11, 'uri' => 'artifacts/11', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
        $this->assertEquals($backlog_items[1]['artifact'], array('id' => 10, 'uri' => 'artifacts/10', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
        $this->assertEquals($backlog_items[2]['artifact'], array('id' => 9, 'uri' => 'artifacts/9', 'tracker' => array('id' => 5, 'uri' => 'trackers/5')));
    }
    ...
    public function testGETContent() {
        ...
        $this->assertEquals($first_content_item['artifact'], array('id' => 3, 'uri' => 'artifacts/3', 'tracker' => array('id' => 1, 'uri' => 'trackers/1')));
        ...
        $this->assertEquals($second_content_item['artifact'], array('id' => 4, 'uri' => 'artifacts/4', 'tracker' => array('id' => 1, 'uri' => 'trackers/1')));
        ...
        $this->assertEquals($third_content_item['artifact'], array('id' => 5, 'uri' => 'artifacts/5', 'tracker' => array('id' => 1, 'uri' => 'trackers/1')));
        ...
        $this->assertEquals($fourth_content_item['artifact'], array('id' => 6, 'uri' => 'artifacts/6', 'tracker' => array('id' => 1, 'uri' => 'trackers/1')));
    ...
    public function testPUTContent() {
        ...
        $this->assertEquals($first_backlog_item['status'], "Open");
        $this->assertEquals($first_backlog_item['artifact'], array('id' => 3, 'uri' => 'artifacts/3', 'tracker' => array('id' => 1, 'uri' => 'trackers/1')));

        $second_backlog_item = $backlog_items[1];
        $this->assertArrayHasKey('id', $second_backlog_item);
        $this->assertEquals($second_backlog_item['label'], "Fourth epic");
        $this->assertEquals($second_backlog_item['status'], "Open");
        $this->assertEquals($second_backlog_item['artifact'], array('id' => 6, 'uri' => 'artifacts/6', 'tracker' => array('id' => 1, 'uri' => 'trackers/1')));
    }
    ...
    public function testPUTContentOnlyOneElement() {
        ...
        $this->assertEquals($first_backlog_item['status'], "Open");
        $this->assertEquals($first_backlog_item['artifact'], array('id' => 6, 'uri' => 'artifacts/6', 'tracker' => array('id' => 1, 'uri' => 'trackers/1')));
    ...
    public function testGETCardwall() {
        ...
        $this->assertEquals(5, $first_swimlane_card_artifact_tracker_reference['id']);
        $this->assertEquals("trackers/5", $first_swimlane_card_artifact_tracker_reference['uri']);
    }
