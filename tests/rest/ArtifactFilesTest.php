...
class ArtifactFilesTest extends RestBase {
    ...
    public function testOptionsArtifactFiles() {
        $response = $this->getResponse($this->client->options('artifact_files'));
    ...
    public function testPostArtifactFile() {
        ...
        $request  = $this->client->post('artifact_files', null, $post_resource);
     ...
     */
    public function testOptionsArtifactFilesId() {
        $test_post_return = func_get_args();
        $file_id          = $test_post_return[0];
     ...
     * @depends testPostArtifactFile
     */
    public function testOptionsArtifactId_isForbiddenForADifferentUser() {
        $test_post_return = func_get_args();
        $file_id          = $test_post_return[0];
     ...
     * @depends testPostArtifactFile
     */
    public function testPutArtifactFileId() {
        $test_post_return = func_get_args();
        $file_id          = $test_post_return[0];
        ...
        $request  = $this->client->put('artifact_files/'.$file_id, null, $put_resource);
        $response = $this->getResponse($request);
     ...
     * @depends testPostArtifactFile
     */
    public function testPutArtifactId_isForbiddenForADifferentUser() {
        $test_post_return = func_get_args();
        $file_id          = $test_post_return[0];
        $second_chunk     = 'with more data';
     ...
     * @depends testPostArtifactFile
     */
    public function testPutArtifactId_throwsErrorForAWrongOffset() {
        $test_post_return = func_get_args();
        $file_id          = $test_post_return[0];
        $second_chunk     = 'with more data';
