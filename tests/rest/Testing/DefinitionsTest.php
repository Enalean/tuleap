...
class DefinitionsTest extends BaseTest {
    ...
    public function testGetDefinition() {
        ...
        $definition_request = $this->client->get('testing_definitions/' . $first_definition['id']);
    ...
    private function getFirstCampaign() {
        $campaigns_request  = $this->client->get('projects/'.TestingDataBuilder::PROJECT_TEST_MGMT_ID.'/testing_campaigns');
    ...
    private function getFirstExecution($campaign_id) {
        $executions_request = $this->client->get('testing_campaigns/'.$campaign_id.'/testing_executions');
