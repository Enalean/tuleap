...
class DeletedArtifactLinksChecker
{
    ...
    public function checkArtifactHaveMirroredMilestonesInProvidedLinks(DeletedArtifactLinksEvent $deleted_artifact_links_event): void
    {
        if (
            $this->search_linked_artifacts->doesArtifactHaveMirroredMilestonesInProvidedLinks(
                ...
                $deleted_artifact_links_event->getDeletedArtifactLinksIds(),
            )
        ) {
