...
final class VerifyIsProjectUsedInPlanStub implements VerifyIsProjectUsedInPlan
{
    private function __construct(private bool $is_used_in_plan)
    {
    }

    public static function withProjectUsedInPlan(): self
    {
