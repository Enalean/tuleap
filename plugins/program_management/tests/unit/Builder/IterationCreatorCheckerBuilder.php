...
final class IterationCreatorCheckerBuilder
{
    public static function build(): IterationCreatorChecker
    {
        return new IterationCreatorChecker(
            RetrieveMirroredIterationTrackerStub::withValidTrackers(TrackerReferenceStub::withId(1)),
            VerifyIsIterationTrackerStub::buildValidIteration(),
            RetrieveVisibleIterationTrackerStub::withValidTracker(TrackerReferenceStub::withId(2)),
