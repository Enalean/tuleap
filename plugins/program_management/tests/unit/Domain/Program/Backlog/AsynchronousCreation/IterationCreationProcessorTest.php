...
{
    private const int FIRST_TEAM_ID                                            = 122;
    private const int SECOND_TEAM_ID                                           = 127;
    private const int ITERATION_ID                                             = 20;
    private const int FIRST_MIRRORED_ITERATION_ID                              = 21;
    private const int SECOND_MIRRORED_ITERATION_ID                             = 22;
    private const int USER_ID                                                  = 191;
    private const int FIRST_MIRRORED_ITERATION_TRACKER_ID                      = 55;
    private const int SECOND_MIRRORED_ITERATION_TRACKER_ID                     = 42;
    private const int SUBMISSION_DATE                                          = 1781713922;
    private const string TITLE_VALUE                                           = 'outstream';
    private const string DESCRIPTION_VALUE                                     = 'slump recompense';
    private const string DESCRIPTION_FORMAT                                    = 'commonmark';
    private const int FIRST_MAPPED_STATUS_BIND_VALUE_ID                        = 5621;
    private const int SECOND_MAPPED_STATUS_BIND_VALUE_ID                       = 9829;
    private const int START_DATE_VALUE                                         = 1607258528;
    private const int END_DATE_VALUE                                           = 1755478239;
    private const int FIRST_TITLE_FIELD_ID                                     = 958;
    private const int FIRST_DESCRIPTION_FIELD_ID                               = 686;
    private const int FIRST_STATUS_FIELD_ID                                    = 947;
    private const int FIRST_START_DATE_FIELD_ID                                = 627;
    private const int FIRST_END_DATE_FIELD_ID                                  = 844;
    private const int FIRST_ARTIFACT_LINK_FIELD_ID                             = 883;
    private const int SECOND_TITLE_FIELD_ID                                    = 799;
    private const int SECOND_DESCRIPTION_FIELD_ID                              = 130;
    private const int SECOND_STATUS_FIELD_ID                                   = 999;
    private const int SECOND_START_DATE_FIELD_ID                               = 679;
    private const int SECOND_END_DATE_FIELD_ID                                 = 847;
    private const int SECOND_ARTIFACT_LINK_FIELD_ID                            = 880;
    private const int FIRST_MIRRORED_PROGRAM_INCREMENT_ID                      = 17;
    private const int FIRST_MIRRORED_PROGRAM_INCREMENT_ARTIFACT_LINK_FIELD_ID  = 120;
    private const int SECOND_MIRRORED_PROGRAM_INCREMENT_ID                     = 40;
    private const int SECOND_MIRRORED_PROGRAM_INCREMENT_ARTIFACT_LINK_FIELD_ID = 768;
