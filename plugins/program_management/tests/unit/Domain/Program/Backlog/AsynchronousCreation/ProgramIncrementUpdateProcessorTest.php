...
{
    private const int PROGRAM_INCREMENT_ID               = 63;
    private const int USER_ID                            = 122;
    private const int PROGRAM_INCREMENT_TRACKER_ID       = 74;
    private const int FIRST_MIRRORED_ID                  = 137;
    private const int SECOND_MIRRORED_ID                 = 194;
    private const int SUBMISSION_DATE                    = 1408642745;
    private const string TITLE_VALUE                     = 'nocuously';
    private const string DESCRIPTION_VALUE               = 'unbowsome';
    private const string DESCRIPTION_FORMAT              = 'text';
    private const int FIRST_MAPPED_STATUS_BIND_VALUE_ID  = 8889;
    private const int SECOND_MAPPED_STATUS_BIND_VALUE_ID = 9771;
    private const int START_DATE_VALUE                   = 1442752621;
    private const int END_DATE_VALUE                     = 1465344427;
    private const int FIRST_TITLE_FIELD_ID               = 205;
    private const int FIRST_DESCRIPTION_FIELD_ID         = 430;
    private const int FIRST_STATUS_FIELD_ID              = 472;
    private const int FIRST_START_DATE_FIELD_ID          = 104;
    private const int FIRST_END_DATE_FIELD_ID            = 844;
    private const int FIRST_ARTIFACT_LINK_FIELD_ID       = 393;
    private const int SECOND_TITLE_FIELD_ID              = 751;
    private const int SECOND_DESCRIPTION_FIELD_ID        = 586;
    private const int SECOND_STATUS_FIELD_ID             = 537;
    private const int SECOND_START_DATE_FIELD_ID         = 629;
    private const int SECOND_END_DATE_FIELD_ID           = 104;
    private const int SECOND_ARTIFACT_LINK_FIELD_ID      = 762;
