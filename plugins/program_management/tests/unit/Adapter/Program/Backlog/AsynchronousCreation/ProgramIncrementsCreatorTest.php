...
{
    private const int PROGRAM_INCREMENT_ID                         = 112;
    private const int USER_ID                                      = 101;
    private const int FIRST_MIRRORED_PROGRAM_INCREMENT_TRACKER_ID  = 99;
    private const int SECOND_MIRRORED_PROGRAM_INCREMENT_TRACKER_ID = 2048;
    private const int SUBMISSION_DATE                              = 1234567890;
    ...
    private const int FIRST_MAPPED_STATUS_BIND_VALUE_ID            = 2271;
    private const int SECOND_MAPPED_STATUS_BIND_VALUE_ID           = 6281;
    private const int START_DATE_VALUE                             = 1601579528;
    private const int END_DATE_VALUE                               = 1602288660;
    private const int FIRST_TITLE_FIELD_ID                         = 604;
    private const int FIRST_DESCRIPTION_FIELD_ID                   = 335;
    private const int FIRST_STATUS_FIELD_ID                        = 772;
    private const int FIRST_START_DATE_FIELD_ID                    = 876;
    private const int FIRST_END_DATE_FIELD_ID                      = 790;
    private const int FIRST_ARTIFACT_LINK_FIELD_ID                 = 608;
    private const int SECOND_TITLE_FIELD_ID                        = 810;
    private const int SECOND_DESCRIPTION_FIELD_ID                  = 887;
    private const int SECOND_STATUS_FIELD_ID                       = 506;
    private const int SECOND_START_DATE_FIELD_ID                   = 873;
    private const int SECOND_END_DATE_FIELD_ID                     = 524;
    private const int SECOND_ARTIFACT_LINK_FIELD_ID                = 866;
