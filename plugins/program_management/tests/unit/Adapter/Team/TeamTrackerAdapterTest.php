...
use Tuleap\ProgramManagement\Adapter\Program\Hierarchy\TeamCanOnlyHaveOneBacklogTrackerException;
use Tuleap\ProgramManagement\Adapter\Program\Hierarchy\TeamTrackerMustBeInPlannableTopBacklogException;
use Tuleap\ProgramManagement\Adapter\Program\Hierarchy\TeamTrackerNotFoundException;
use Tuleap\ProgramManagement\Adapter\Program\Hierarchy\TrackerDoesNotBelongToTeamException;
...
final class TeamTrackerAdapterTest extends TestCase
{
    ...
    public function testItThrowsAnExceptionWhenMoreThanOneTeamTrackerIsProvided(): void
    {
        ...
        $planning         = new Planning(
            new ProgramTracker($planning_tracker),
            1,
            'Release Planning',
            [200, 300],
