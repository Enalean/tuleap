...
final class SearchUnlinkedUserStoriesOfMirroredProgramIncrementStub implements SearchUnlinkedUserStoriesOfMirroredProgramIncrement
{
    public static function withNoUserStories(): self
    {
        return new self();
    }
