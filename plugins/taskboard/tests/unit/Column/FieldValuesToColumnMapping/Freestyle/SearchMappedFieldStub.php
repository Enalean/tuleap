...
{
    private function __construct(private ?int $mapped_field_id)
    {
    }

    public static function withMappedField(int $mapped_field_id): self
    {
        return new self($mapped_field_id);
    }
    ...
    {
        return Option::fromNullable($this->mapped_field_id);
    }
}
