...
export function collapseColumn(state: State, column: ColumnDefinition): void {
    findColumn(state, column).is_collapsed = true;
}
export function expandColumn(state: State, column: ColumnDefinition): void {
    findColumn(state, column).is_collapsed = false;
}

function findColumn(state: State, column: ColumnDefinition): ColumnDefinition {
