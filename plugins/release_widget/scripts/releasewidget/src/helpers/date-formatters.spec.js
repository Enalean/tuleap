...
import { formatDateYearMonthDay } from "./date-formatters.js";
import { setUserLocale } from "./user-locale-helper.js";
...
describe("Date formatters", () => {
    describe("formatDateYearMonthDay", () => {
        it("Given date, When I call this function with an ISO date, then it should return date at good format", () => {
            setUserLocale("en-US");
            let date_iso = new Date("2017-01-22T13:42:08+02:00");
            expect(formatDateYearMonthDay(date_iso)).toEqual("Jan 22, 2017");
        });
