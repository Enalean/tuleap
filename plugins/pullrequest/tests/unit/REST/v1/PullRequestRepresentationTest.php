...
{
    private const int PULL_REQUEST_ID            = 358;
    private const string TITLE                   = 'padella Deuteronomy';
    private const string SOURCE_REPO_NAME        = 'hedgewood Feringi';
    private const string SOURCE_BRANCH_NAME      = 'chronomantic';
    private const string SOURCE_SHA1             = 'a9fda5f347fcb3fdf783f797064128ee360f55cf';
    private const string DESTINATION_REPO_NAME   = 'doggerelize gunate';
    private const string DESTINATION_BRANCH_NAME = 'main';
    private const string DESTINATION_SHA1        = '541b0bd1b9db61b63ed9e6eac6e13cae39d1b9fd';
    private const int CREATOR_USER_ID            = 149;
    private const string CREATOR_NAME            = 'Andre Chowdhury';
    private const int FIRST_REVIERWER_USER_ID    = 159;
    private const int SECOND_REVIEWER_USER_ID    = 134;
    private const string SOURCE_DESCRIPTION      = '_reboast gift_';
    private const string INTERPRETED_DESCRIPTION = '<em>reboast gift</em>';
    private const int GIT_REFERENCE_ID           = 11;
    private const int NUMBER_OF_CHANGED_FILES    = 6;
    private const string PULL_REQUEST_STATUS     = 'merge';
