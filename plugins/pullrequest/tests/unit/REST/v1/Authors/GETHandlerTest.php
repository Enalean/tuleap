...
use Tuleap\PullRequest\Tests\Stub\SearchPaginatedPullRequestsAuthorsStub;
...
final class GETHandlerTest extends TestCase
{
    ...
    public function testItReturnsOkWithRepositoryPullRequestAuthorsRepresentation(): void
    {
