...
final class PullRequestAbandonedNotificationToProcessBuilderTest extends \Tuleap\Test\PHPUnit\TestCase
{
    ...
    private function getNotificationsToProcess(PullRequestAbandonedEvent $event): array
    {
        $builder = new PullRequestAbandonedNotificationToProcessBuilder(
            $this->user_manager,
    ...
    {
        $pull_request = PullRequestTestBuilder::anAbandonedPullRequest()->withId(12)->withTitle('PR title')->build();
        ...
        self::assertInstanceOf(PullRequestAbandonedNotification::class, $notifications[0]);
    }

    public function testNoNotificationIsBuiltWhenThePullRequestCanNoBeFound(): void
    {
        $pull_request = PullRequestTestBuilder::anAbandonedPullRequest()->withId(404)->build();
    ...
    {
        $pull_request = PullRequestTestBuilder::anAbandonedPullRequest()->withId(13)->build();
        $change_user  = UserTestBuilder::buildWithId(102);
