...
final class PullRequestAbandonedNotificationTest extends TestCase
{
    ...
    public function testAbandonedNotificationCanBeBuiltFromTheOwnersOfThePullRequest(): void
    {
        ...
        $this->assertEquals('User A has closed the pull request #13: Broken contribution', $notification->asPlaintext());
        $this->assertEquals(
            '<a href="https://example.com/users/usera">User A</a> has closed the pull request <a href="https://example.com/pr-link">#13</a>: Broken contribution',
