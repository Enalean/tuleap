...
const default_pull_request: PullRequest = {
    ...
    repository: {
        ...
        clone_ssh_url: "ssh://gitolite@example.com/git-project/a-repository.git",
        clone_http_url: "https://example.com/plugins/git/git-project/a-repository.git",
    },
    user_id: 102,
    ...
    repository_dest: {
        ...
        clone_ssh_url: "ssh://gitolite@example.com/git-project/the-repository.git",
        clone_http_url: "https://example.com/plugins/git/git-project/the-repository.git",
    },
    creator: user,
    reviewers: [],
};
