...
import type { CreatePlaceholderWidget } from "../../src/app/file-diff/diff-modes/side-by-side-code-mirror-widget-creator";
import type { PlaceholderCreationParams } from "../../src/app/file-diff/diff-modes/types-codemirror-overriden";
