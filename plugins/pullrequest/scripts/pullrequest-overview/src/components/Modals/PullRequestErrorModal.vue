...
<template>
    <div
        ...
        role="dialog"
        aria-labelledby="pull-request-overview-error-modal"
    >
        <div class="tlp-modal-header">
            <h1 class="tlp-modal-title" id="pull-request-overview-error-modal">
                {{ $gettext("Oh snap!") }}
            </h1>
            <button
        ...
        <div class="tlp-modal-body">
            ...
            <p>
                <button
                    ...
                    data-test="pullrequest-error-modal-show-details"
                >
                    {{ $gettext("Show details") }}
                </button>
            </p>
            <div v-if="are_error_details_shown" data-test="pullrequest-error-modal-details">
                <h4>{{ $gettext("Error details") }}</h4>
                <pre data-test="pullrequest-error-modal-details-message">{{ props.fault }}</pre>
            </div>
        </div>
