...
/**
 * @template-implements NotificationToProcessBuilder<PullRequestAbandonedEvent>
 */
final class PullRequestAbandonedNotificationToProcessBuilder implements NotificationToProcessBuilder
{
    ...
    public function getNotificationsToProcess(EventSubjectToNotification $event): array
    {
            return $this->pull_request_retriever->getPullRequestById($event->getPullRequestID())->match(
                function (PullRequest $pull_request) use ($event) {
                    ...
                    return [
                        PullRequestAbandonedNotification::fromOwners(
                            $this->user_helper,
