 ...
 * @psalm-immutable
 */
final class PullRequestAbandonedEvent implements EventSubjectToNotification, \JsonSerializable
{
    /**
     * @var int
     */
    ...
    public static function fromPullRequestAndUserAbandoningThePullRequest(PullRequest $pull_request, PFUser $user): self
    {
