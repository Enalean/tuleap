...
{
    /**
     * @psalm-return array{id:int,pull_request_id:int,user_id:int,post_date:int,file_path:string,unidiff_offset:int,content:string,is_outdated:0|1, parent_id: int}|null
     */
    public function searchByID(int $inline_comment_id): ?array
    {
        return $this->getDB()->row(
            'SELECT id, pull_request_id, user_id, post_date, file_path, unidiff_offset, content, is_outdated, parent_id
