...
final class b202211171452_add_pullrequest_color_in_comment_table extends \Tuleap\ForgeUpgrade\Bucket
{
    ...
    {
        if ($this->api->columnNameExists('plugin_pullrequest_comments', 'color')) {
            return;
        }

        $sql = "ALTER TABLE plugin_pullrequest_comments ADD COLUMN color VARCHAR(50) default ''";
    ...
    {
        if ($this->api->columnNameExists('plugin_pullrequest_inline_comments', 'color')) {
            return;
        }

        $sql = "ALTER TABLE plugin_pullrequest_inline_comments ADD COLUMN color VARCHAR(50) default ''";
