...
namespace Tuleap\TeamforgeCompatMediawiki;
...
class ReferencesImporter
{
    ...
    const TEAMFORGE_XREF_WIKI  = 'wiki';
    ...
    public function importCompatRefXML(Project $project, SimpleXMLElement $xml, array $created_refs)
    {
        foreach ($xml->children() as $reference) {
            ...
            if ($reference_keyword === self::TEAMFORGE_XREF_WIKI) {
            ...
            $this->logger->info("Imported teamforge ref '$source' -> $object_type $target");
        }
    }
