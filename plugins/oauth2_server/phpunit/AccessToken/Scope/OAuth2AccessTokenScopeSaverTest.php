...
final class OAuth2AccessTokenScopeSaverTest extends TestCase
{
    ...
    {
        $this->dao = \Mockery::mock(OAuth2AccessTokenScopeDAO::class);

        $this->saver = new OAuth2AccessTokenScopeSaver($this->dao);
    }
    ...
    public function testScopesAreSaved(): void
    {
        ...
        $this->dao->shouldReceive('saveScopeKeysByOAuth2AccessTokenID')->with(12, 'foobar', 'barbaz')->once();

        $this->saver->saveAccessTokenScopes(12, [$scope_a, $scope_b]);
    }
}
