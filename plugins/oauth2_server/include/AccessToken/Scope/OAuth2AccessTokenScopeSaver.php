...
class OAuth2AccessTokenScopeSaver
{
    ...
    public function __construct(OAuth2AccessTokenScopeDAO $dao)
    {
        $this->dao = $dao;
    }
     ...
     */
    public function saveAccessTokenScopes(int $oauth2_access_token_id, array $scopes): void
    {
        ...
        $this->dao->saveScopeKeysByOAuth2AccessTokenID($oauth2_access_token_id, ...$scope_identifier_keys);
    }
}
