...
class OAuth2AuthorizationCodeScopeSaver
{
    /**
    ...
    public function __construct(OAuth2AuthorizationCodeScopeDAO $dao)
    {
        $this->dao = $dao;
    }
     ...
     */
    public function saveAuthorizationCodeScopes(int $oauth2_access_token_id, array $scopes): void
    {
        ...
        $this->dao->saveScopeKeysByOAuth2AuthCodeID($oauth2_access_token_id, ...$scope_identifier_keys);
    }
}
