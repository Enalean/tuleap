...
final class OAuth2OfflineAccessScope implements AuthenticationScope
{
    ...
    private function __construct(OAuth2ScopeIdentifier $identifier)
    {
        ...
        $this->definition = new /** @psalm-immutable */ class implements AuthenticationScopeDefinition
        {
            ...
            {
                return dgettext('tuleap-oauth2_server', 'Offline access');
            }
            ...
            public function getDescription(): string
            {
                return dgettext(
                    ...
                    'Allow the app to access resources on your behalf for an extended period of time even while you are disconnected'
                );
            }
        };
    }
