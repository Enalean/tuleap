...
{
    /**
     * @param string[] $prompt_parameters
     */
    public function __construct(array $prompt_parameters)
    {
        parent::__construct(
            sprintf('"none" cannot be used with other prompt parameter values, got %s', implode(', ', $prompt_parameters))
        );
    }
}
