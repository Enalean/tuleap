...
final class RejectAnonymousMiddlewareTest extends TestCase
{
    public function testCurrentUserIsLoggedIn(): void
    {
        ...
        $middleware = new RejectAnonymousMiddleware(
    ...
    public function testCurrentUserIsAnonymous(): void
    {
