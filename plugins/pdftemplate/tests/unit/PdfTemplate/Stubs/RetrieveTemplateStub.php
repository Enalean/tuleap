...
final readonly class RetrieveTemplateStub implements RetrieveTemplate
{
    private function __construct(private ?PdfTemplate $template)
    {
    }

    public static function withMatchingTemplate(PdfTemplate $template): self
    {
        return new self($template);
    }

    public static function withoutMatchingTemplate(): self
    {
