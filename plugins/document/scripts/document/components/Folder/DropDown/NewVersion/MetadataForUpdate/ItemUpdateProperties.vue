...
<!-- eslint-disable vue/no-mutating-props -->
<script>
import VersionTitleProperty from "../../MetadataForCreateOrUpdate/VersionTitleProperty.vue";
import ChangelogProperty from "../../MetadataForCreateOrUpdate/ChangelogProperty.vue";
