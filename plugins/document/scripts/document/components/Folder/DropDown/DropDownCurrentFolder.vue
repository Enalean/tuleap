...
<template>
    <drop-down-menu v-bind:is-in-folder-empty-state="isInFolderEmptyState" v-bind:item="current_folder">
        <drop-down-item-title slot="display-item-title" v-bind:item="current_folder" data-test="document-folder-title"/>
