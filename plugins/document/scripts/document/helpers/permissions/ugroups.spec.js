...
describe("User groups", () => {
    ...
    it("filters special service user groups from the list", async () => {
        const getProjectUserGroupsSpy = jasmine.createSpy("getProjectUserGroups");
        rewire$getProjectUserGroups(getProjectUserGroupsSpy);
        ...
        getProjectUserGroupsSpy.and.returnValue([
