...
class ShouldDisplaySourceColumnForFileVersions implements \Tuleap\Event\Dispatchable
{
    ...
    public function enableDisplayOfSourceColumn(): void
    {
        $this->should_display_source_column = true;
    }

    public function shouldDisplaySourceColumn(): bool
    {
        return $this->should_display_source_column;
    }
}
