...
interface Git_Driver_Gerrit_removeUserFromGroupTest {
    public function itExecutesTheDeletionCommand();
    public function itRemovesAllMembers();
}

class Git_Driver_GerritLegacy_removeUserFromGroupTest extends Git_Driver_GerritLegacy_baseTest implements Git_Driver_Gerrit_removeUserFromGroupTest {
...
class Git_Driver_GerritREST_removeUserFromGroupTest extends Git_Driver_GerritREST_baseTest implements Git_Driver_Gerrit_removeUserFromGroupTest {
    public function itExecutesTheDeletionCommand() {}
    public function itRemovesAllMembers() {}
}