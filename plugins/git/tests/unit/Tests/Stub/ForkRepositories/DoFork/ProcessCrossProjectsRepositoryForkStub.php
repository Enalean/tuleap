...
use Tuleap\Git\ForkRepositories\DoFork\ProcessCrossProjectsRepositoryFork;
use Tuleap\NeverThrow\Err;
use Tuleap\NeverThrow\Fault;
use Tuleap\NeverThrow\Ok;
use Tuleap\NeverThrow\Result;

final readonly class ProcessCrossProjectsRepositoryForkStub implements ProcessCrossProjectsRepositoryFork
{
    ...
    {
        return new self(Result::err('Unexpected ProcessCrossProjectsRepositoryForkStub::processCrossProjectsFork call.'));
    }
