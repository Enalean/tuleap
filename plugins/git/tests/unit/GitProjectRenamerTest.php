...
final class GitProjectRenamerTest extends TestCase
{
    ...
    {
        $this->git_backend->method('renameProject')->willReturn(true);
        $this->git_dao->expects($this->once())->method('renameProject')->with($this->project, 'aname');
    ...
    {
        $this->git_backend->method('renameProject')->willReturn(false);
