...
class Git_PermissionsDao extends DataAccessObject {
    ...
    public function updateAllAnonymousRepositoriesToRegistered() {
        return $this->updateRepositoriesPermissions(ProjectUGroup::ANONYMOUS, ProjectUGroup::REGISTERED);
    }

    public function updateAllAuthenticatedRepositoriesToRegistered() {
        return $this->updateRepositoriesPermissions(ProjectUGroup::AUTHENTICATED, ProjectUGroup::REGISTERED);
    }
