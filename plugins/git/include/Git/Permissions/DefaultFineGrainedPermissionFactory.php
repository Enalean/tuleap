...
class DefaultFineGrainedPermissionFactory
{
    ...
    public function getUpdatedPermissionsFromRequest(\Tuleap\HTTPRequest $request, Project $project)
    {
        $updated_permissions = [];
    ...
    private function updateWriters(\Tuleap\HTTPRequest $request, Project $project, array &$updated_permissions)
    {
    ...
    private function updateRewinders(\Tuleap\HTTPRequest $request, Project $project, array &$updated_permissions)
    {
    ...
    public function getBranchesFineGrainedPermissionsFromRequest(\Tuleap\HTTPRequest $request, Project $project)
    {
        return $this->buildRepresentationFromRequest($request, $project, self::ADD_BRANCH_PREFIX);
    }

    public function getTagsFineGrainedPermissionsFromRequest(\Tuleap\HTTPRequest $request, Project $project)
    {
        return $this->buildRepresentationFromRequest($request, $project, self::ADD_TAG_PREFIX);
    }

    private function buildRepresentationFromRequest(\Tuleap\HTTPRequest $request, Project $project, $prefix)
    {
        $permissions              = [];
