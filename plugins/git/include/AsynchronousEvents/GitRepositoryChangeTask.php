...
final readonly class GitRepositoryChangeTask implements QueueTask
{
    public const string TOPIC = 'tuleap.git.repository-change';
    ...
    {
        return 'Updating repository #' . $this->repository_id;
    }
}
