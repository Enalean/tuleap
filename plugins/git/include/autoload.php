...
function autoload847bb01f6da7dcbcec09d1b3fe78d0d7($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'git' => '/Git.class.php',
            ...
            'systemevent_git_rename_mirror' => '/events/SystemEvent_GIT_RENAME_MIRROR.php',
...
spl_autoload_register('autoload847bb01f6da7dcbcec09d1b3fe78d0d7');
