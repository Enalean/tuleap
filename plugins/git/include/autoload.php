...
function autoload37c96a4b43c7e0a6e1badac4f2c8795b($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'git' => '/Git.class.php',
            ...
            'git_driver_gerritrestbodybuilder' => '/Git/Driver/GerritRESTBodyBuilder.class.php',
...
spl_autoload_register('autoload37c96a4b43c7e0a6e1badac4f2c8795b');
