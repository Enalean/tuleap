...
function autoload9f239fe4738a5fbbdbb2d23336ca8505($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'gitmarkdownfilecontentinform' => '/Markdown/GitMarkdownFileContentInForm.php',
...
spl_autoload_register('autoload9f239fe4738a5fbbdbb2d23336ca8505');
