...
function autoload51614beda8d7a74d9753e5fbb348e3fc($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'git' => '/Git.class.php',
            ...
            'systemevent_git_grokmirror_manifest' => '/events/SystemEvent_GIT_GROKMIRROR_MANIFEST.class.php',
...
spl_autoload_register('autoload51614beda8d7a74d9753e5fbb348e3fc');
