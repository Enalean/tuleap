...
function autoloadbaa759d07487b0ef1fc7da8b0ebad4d8($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\git\\permissions\\defaultfinegrainedpermissionrepresentation' => '/Git/Permissions/DefaultFineGrainedPermissionRepresentation.php',
            ...
            'tuleap\\git\\permissions\\finegrainedpermissionrepresentation' => '/Git/Permissions/FineGrainedPermissionRepresentation.php',
...
spl_autoload_register('autoloadbaa759d07487b0ef1fc7da8b0ebad4d8');
