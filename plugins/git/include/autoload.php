...
function autoloadc57cc8d79f2065e4296f6a75517119f5($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'git' => '/Git.class.php',
            ...
            'git_projectnotinhierarchyexception' => '/exceptions/ProjectNotInHierarchyException.class.php',
...
spl_autoload_register('autoloadc57cc8d79f2065e4296f6a75517119f5');
