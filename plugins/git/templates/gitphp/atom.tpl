...
<feed xmlns="http://www.w3.org/2005/Atom" xml:lang="en">
  ...
  <link href="{scripturl}?p={$project->GetProject()|urlencode}&amp;a=summary&amp;noheader=1"/>
  <link rel="self" href="{scripturl}?p={$project->GetProject()|urlencode}&amp;a=atom&amp;noheader=1"/>
...
{foreach from=$log item=logitem}
  <entry>
    <id>{scripturl}?p={$project->GetProject()|urlencode}&amp;a=commit&amp;h={$logitem->GetHash()|urlencode}</id>
    ...
    <link rel="alternate" href="{scripturl}?p={$project->GetProject()|urlencode}&amp;a=commit&amp;h={$logitem->GetHash()|escape}&amp;noheader=1"/>
