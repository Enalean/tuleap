...
EOT;
    ...
    public function up()
    {
        ...
        if ($res === false) {
            throw new \Tuleap\ForgeUpgrade\Bucket\BucketUpgradeNotCompleteException('An error occured while updating service short name: ' . implode(', ', $this->db->dbh->errorInfo()));
        }
    }
}
