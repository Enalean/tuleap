...
class Statistics_ScmSvn extends Statistics_Scm {
    ...
    function calculateTotalAccess() {
        ...
        $this->totalRead[]    = $GLOBALS['Language']->getText('plugin_statistics', 'scm_svn_total_read');
        $this->totalCommits[] = $GLOBALS['Language']->getText('plugin_statistics', 'scm_svn_total_commit');
    ...
    function calculateAccessByProject() {
        $this->readProjectsNumber[]   = $GLOBALS['Language']->getText('plugin_statistics', 'scm_svn_read_project');
        $this->commitProjectsNumber[] = $GLOBALS['Language']->getText('plugin_statistics', 'scm_svn_commit_project');
        $rank = 1;
        while ($rank <= 10) {
    ...
    function calculateAccessByUser() {
        $this->readUsersNumber[]   = $GLOBALS['Language']->getText('plugin_statistics', 'scm_svn_read_user');
        $this->commitUsersNumber[] = $GLOBALS['Language']->getText('plugin_statistics', 'scm_svn_commit_user');
        $rank = 1;
        while ($rank <= 10) {
