...
let
  ...
  mediawiki135 = buildMediawikiTarball {
    version = "1.35.13";
    tuleapUsage = "1.35";
    srcHash = "sha256-KpcAzhk9sZMtt74+G/3fE11iLUOZumvW0FcORR22O2E=";
  };
  ...
  buildMediawikiTuleapConfigSuspended =
    mediawiki:
    pkgs.stdenvNoCC.mkDerivation {
  ...
  buildMediawikiTuleapFlavorTarball =
    mediawiki: patches:
    pkgs.stdenvNoCC.mkDerivation {
      ...
      src = pkgs.buildEnv {
        ...
        paths = [
          mediawiki
          (buildMediawikiSkinsAndExtensions mediawiki)
          mediawikiTuleapConfig
          (buildMediawikiTuleapConfigSuspended mediawiki)
        ];
      };
  ...
  buildMediawikiTuleapFlavorRPM =
    ...
    pkgs.stdenvNoCC.mkDerivation {
      ...
      srcs = [
        (buildMediawikiTuleapFlavorTarball mediawiki patches)
        ./mediawiki-tuleap-flavor.spec
      ];
