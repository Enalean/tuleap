...
function autoloade9ac6da82b863f75003031566189b1c8($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'elasticsearch_searchresultemptycollection' => '/ElasticSearch/SearchResultEmptyCollection.class.php',
...
spl_autoload_register('autoloade9ac6da82b863f75003031566189b1c8');
