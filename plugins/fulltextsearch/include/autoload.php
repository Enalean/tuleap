...
function autoload347d99829b13128f3ea20719104f561e($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'elasticsearch_1_2_requestdatafactory' => '/ElasticSearch/RequestDataFactory.class.php',
...
spl_autoload_register('autoload347d99829b13128f3ea20719104f561e');
