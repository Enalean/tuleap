...
function autoload702740dbd6fd2fcbe64cf1ceb799bdd7($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'fulltextsearch_presenter_errornoclient' => '/FullTextSearch/Presenter/ErrorNoClient.class.php',
...
spl_autoload_register('autoload702740dbd6fd2fcbe64cf1ceb799bdd7');
