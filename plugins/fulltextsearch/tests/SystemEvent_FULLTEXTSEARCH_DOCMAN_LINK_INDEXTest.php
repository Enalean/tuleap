...
class SystemEvent_FULLTEXTSEARCH_DOCMAN_LINK_INDEXTest extends SystemEvent_FULLTEXTSEARCH_DOCMANTest {

    protected $klass = 'SystemEvent_FULLTEXTSEARCH_DOCMAN_LINK_INDEX';
    ...
    public function itDelegatesIndexingToFullTextSearchActions() {
        $event = $this->aSystemEventWithParameter('101::103');
        stub($this->actions)->indexNewLinkDocument($this->item)->once();
        $this->assertTrue($event->process());
