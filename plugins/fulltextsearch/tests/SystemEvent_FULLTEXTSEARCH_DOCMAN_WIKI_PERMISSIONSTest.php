...
class SystemEvent_FULLTEXTSEARCH_WIKI_UPDATE_PERMISSIONSTest extends SystemEvent_FULLTEXTSEARCH_WIKITest {

    protected $klass = 'SystemEvent_FULLTEXTSEARCH_WIKI_UPDATE_PERMISSIONS';
    ...
    public function itDelegatesIndexingToFullTextSearchActions() {
        ...
        stub($this->actions)->updatePermissions($this->wiki_page)->once();
