...
class SystemEvent_FULLTEXTSEARCH_DOCMAN_COPYTest extends SystemEvent_FULLTEXTSEARCH_DOCMANTest {

    protected $klass = 'SystemEvent_FULLTEXTSEARCH_DOCMAN_COPY';
    ...
    public function itDelegatesIndexingToFullTextSearchActions() {
        $event = $this->aSystemEventWithParameter('101::103');
        stub($this->actions)->indexCopiedItem($this->item)->once();
        $this->assertTrue($event->process());
