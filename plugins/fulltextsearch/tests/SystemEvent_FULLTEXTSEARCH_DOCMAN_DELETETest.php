...
require_once dirname(__FILE__) .'/../include/SystemEvent_FULLTEXTSEARCH_DOCMAN_DELETE.class.php';
require_once 'SystemEvent_FULLTEXTSEARCH_DOCMANTest.class.php';

class SystemEvent_FULLTEXTSEARCH_DOCMAN_DELETETest extends SystemEvent_FULLTEXTSEARCH_DOCMANTest {

    protected $klass = 'SystemEvent_FULLTEXTSEARCH_DOCMAN_DELETE';

    public function itDelegatesIndexingToFullTextSearchActions() {
        $event = $this->aSystemEventWithParameter('101::103');
        stub($this->actions)->delete($this->item)->once();
