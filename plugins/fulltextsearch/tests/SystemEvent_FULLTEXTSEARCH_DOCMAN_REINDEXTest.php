...
class SystemEvent_FULLTEXTSEARCH_DOCMAN_REINDEXTest extends TuleapTestCase {
    ...
    public function aSystemEventWithParameter($parameters) {
        ...
        $event = new SystemEvent_FULLTEXTSEARCH_DOCMAN_REINDEX_PROJECT(
            $id,
            $type,
            $owner,
            $parameters,
        ...
        $event->injectDependencies($this->actions, mock('FullTextSearch_DocmanSystemEventManager'), mock('TruncateLevelLogger'));
        return $event;
    }
