...
class SystemEvent_FULLTEXTSEARCH_DOCMAN_EMPTY_INDEXTest extends SystemEvent_FULLTEXTSEARCH_DOCMANTest {

    protected $klass = 'SystemEvent_FULLTEXTSEARCH_DOCMAN_EMPTY_INDEX';
    ...
    public function itDelegatesIndexingToFullTextSearchActions() {
        $event = $this->aSystemEventWithParameter('101::103');
        stub($this->actions)->indexNewEmptyDocument($this->item)->once();
        $this->assertTrue($event->process());
