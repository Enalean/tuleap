...
class BuildParams
{
    public const string BUILD_PARAMETER_PROJECT    = 'Project';
    public const string BUILD_PARAMETER_USER       = 'User';
    public const string BUILD_PARAMETER_REPOSITORY = 'Repository';
    public const string BUILD_PARAMETER_PATH       = 'Path';
