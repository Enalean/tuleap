...
describe("ReleaseHeaderRemainingDays", () => {
    ...
    ): VueWrapper<InstanceType<typeof ReleaseHeaderRemainingDays>> {
    ...
    describe("Display remaining days", () => {
        ...
        it("When there number of start days but null, Then 0 is displayed and a message in tooltip", () => {
            const release_data = {
                id: 2,
        ...
        it("When the progress is at least 80%, Then remaining days is displayed in red and percent in tooltip", () => {
            const release_data = {
                id: 2,
        ...
        it("When the progress is between 80% and 100%, Then remaining days is displayed in red and percent in tooltip", () => {
            const release_data = {
                id: 2,
