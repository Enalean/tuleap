...
final class SearchResource extends AuthenticatedResource
{
    ...
    public function getSearchItems(SearchQueryRepresentation $search_query, int $limit = self::MAX_LIMIT, int $offset = 0): array
    {
        ...
        $searcher = (\EventManager::instance())->dispatch(new FindIndexSearcher())->searcher;
        if ($searcher === null) {
            throw new \LogicException('FullTextSearch index searcher implementation should have been found');
        }
