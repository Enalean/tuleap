...
function autoloade9194c054c91d63db7627e5be48e2ba4($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'cardwalleventparamsnotfoundexception' => '/exceptions/CardwallEventParamsNotFoundException.class.php',
            'cardwalleventparamswithoutgoodtypesexception' => '/exceptions/CardwallEventParamsWithoutGoodTypesException.class.php',
            'cardwallfromxmlimportcannotbeenabledexception' => '/CardwallFromXmlImportCannotBeEnabledException.class.php.php',
...
spl_autoload_register('autoloade9194c054c91d63db7627e5be48e2ba4');
