...
function autoload7ca93b93b54db8b5dbea072128c64928($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'cardwall_cardincellpresenternodefactory' => '/CardInCellPresenterNodeFactory.class.php',
            ...
            'cardwall_panebuilder' => '/PaneBuilder.class.php',
...
spl_autoload_register('autoload7ca93b93b54db8b5dbea072128c64928');
