...
function autoload7a60743341c8f9381ab95a60911e6e8c($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'cardwall_agiledashboard_controller' => '/AgileDashboard/Controller.class.php',
            'cardwall_agiledashboard_presenter' => '/AgileDashboard/Presenter.class.php',
            ...
            'cardwall_paneinfo' => '/Pane.class.php',
...
spl_autoload_register('autoload7a60743341c8f9381ab95a60911e6e8c');
