...
function autoloadf76f10063b1ab3a65f81d369b71813f3($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'cardwall_displaypreferences' => '/Cardwall_DisplayPreferences.class.php',
            'cardwall_displaypreferencesinagiledashboardcontroller' => '/DisplayPreferencesInAgileDashboardController.class.php',
...
spl_autoload_register('autoloadf76f10063b1ab3a65f81d369b71813f3');
