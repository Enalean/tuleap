...
function autoloadef32886cf55bb8886e3f18cd82331fb8($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\cardwall\\semantic\\cardfieldstrackerpresenterbuilder' => '/Semantic/CardFieldsTrackerPresenterBuilder.php'
        );
    }
    $cn = strtolower($class);
    if (isset($classes[$cn])) {
...
spl_autoload_register('autoloadef32886cf55bb8886e3f18cd82331fb8');
