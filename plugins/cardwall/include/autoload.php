...
function autoloadd06f67ce963b5f3a15a13b89a975292d($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'cardwall_displaypreferencescontroller' => '/DisplayPreferencesController.class.php',
...
spl_autoload_register('autoloadd06f67ce963b5f3a15a13b89a975292d');
