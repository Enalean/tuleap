...
/**
 * Update a value mapping for a cardwall on top of a tracker
 */
class Cardwall_OnTop_Config_Command_UpdateMappingFieldValues extends Cardwall_OnTop_Config_Command {
    ...
    public function __construct(Tracker $tracker, Cardwall_OnTop_ColumnMappingFieldValueDao $dao, TrackerFactory $tracker_factory, Tracker_FormElementFactory $form_element_factory, ) {
