...
class Cardwall_BoardFactory {
    ...
    public function getBoard(Cardwall_FieldProviders_IProvideFieldGivenAnArtifact $field_retriever, 
        ...
        $mapping_collection = $config->_getCardwallMappings($status_fields, $config->getCardwallColumns($field));
    ...
    public function getMultiTrackerBoard($field_retriever, $forests_of_artifacts, $config) {
        ...
        $mapping_collection = $config->_getCardwallMappings($status_fields, $config->getColumns());
