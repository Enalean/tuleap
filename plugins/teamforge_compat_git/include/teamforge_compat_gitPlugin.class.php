...
use Tuleap\TeamforgeCompatGit\TeamforgeCompatDao;
use Tuleap\TeamforgeCompatGit\ReferencesImporter;
use Tuleap\TeamforgeCompatGit\TeamforgeReferencesBuilder;

class teamforge_compat_gitPlugin extends Plugin
{
    ...
    /**
     * @return Tuleap\TeamforgeCompatGit\Plugin\PluginInfo
     */
    public function getPluginInfo()
    {
        if (! $this->pluginInfo) {
            $this->pluginInfo = new Tuleap\TeamforgeCompatGit\Plugin\PluginInfo($this);
        }
    ...
    public function import_compat_ref_xml($params)
    {
        if ($params['service_name'] === GitXmlImporter::SERVICE_NAME) {
            ...
            $logger     = new WrapperLogger($params['logger'], 'TeamforgeReferencesGitImporter');
