...
function autoload3996ed882eaa107844a443dd1af4a0b4($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\svn\\pergroup\\permissionpergrouppanebuilder' => '/Svn/PerGroup/PermissionPerGroupPaneBuilder.php',
...
spl_autoload_register('autoload3996ed882eaa107844a443dd1af4a0b4');
