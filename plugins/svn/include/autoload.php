...
function autoload0a2e8aed897082db51d6a403ff363f9e($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\rest\\v1\\repositoryresourceupdater' => '/REST/v1/RepositoryResourceUpdater.php',
...
spl_autoload_register('autoload0a2e8aed897082db51d6a403ff363f9e');
