...
final class DefaultPermissionsStub implements DefaultPermissions
{
    private array $store = [];
    ...
    public function isEnabledForRepository(Repository $repository): bool
    {
        return isset($this->store[$repository->getId()]);
    }
}
