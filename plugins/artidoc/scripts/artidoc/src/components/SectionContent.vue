...
const { is_edit_mode, editable_description, editor_actions, inputCurrentDescription } =
    useSectionEditor(props.section.description.value, props.section.artifact.id);
