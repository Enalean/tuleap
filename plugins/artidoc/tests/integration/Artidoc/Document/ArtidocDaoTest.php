...
final class ArtidocDaoTest extends TestIntegrationTestCase
{
    public function testSearchPaginatedRawSectionsById(): void
    {
        ...
        self::assertSame(4, $dao->searchPaginatedRawSectionsById(101, 50, 0)->total);
        self::assertSame(
            [1001, 1002, 1003, 1004],
            array_column($dao->searchPaginatedRawSectionsById(101, 50, 0)->rows, 'artifact_id'),
        );

        self::assertSame(4, $dao->searchPaginatedRawSectionsById(101, 2, 1)->total);
        self::assertSame(
            [1002, 1003],
            array_column($dao->searchPaginatedRawSectionsById(101, 2, 1)->rows, 'artifact_id'),
        );
    ...
    public function testSave(): void
    {
        ...
        self::assertSame(3, $dao->searchPaginatedRawSectionsById(101, 50, 0)->total);
        self::assertSame(
            [1001, 1002, 1003],
            array_column($dao->searchPaginatedRawSectionsById(101, 50, 0)->rows, 'artifact_id'),
        );
        ...
        self::assertSame(0, $dao->searchPaginatedRawSectionsById(101, 50, 0)->total);
        self::assertSame(
            [],
            array_column($dao->searchPaginatedRawSectionsById(101, 50, 0)->rows, 'artifact_id'),
        );
