...
use Tuleap\Artidoc\Document\Field\List\BuildStaticListFieldWithValue;
use Tuleap\Artidoc\Domain\Document\Section\Field\FieldWithValue\StaticListFieldWithValue;

final class BuildStaticListFieldWithValueStub implements BuildStaticListFieldWithValue
{
    /** @psalm-var callable(ConfiguredField): StaticListFieldWithValue */
    private $callback;
