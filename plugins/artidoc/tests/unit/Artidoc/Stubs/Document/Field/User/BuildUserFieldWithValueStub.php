...
namespace Tuleap\Artidoc\Stubs\Document\Field\User;
...
final class BuildUserFieldWithValueStub implements BuildUserFieldWithValue
{
    /** @psalm-var callable(ConfiguredField): UserFieldWithValue */
    private $callback;
