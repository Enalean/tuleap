 ...
 * @psalm-immutable
 */
final readonly class SectionUserListFieldRepresentation
{
    public string $type;
    public string $label;
    public string $display_type;
    /**
     * @var list<UserListValueRepresentation> $value
     */
    public array $value;

    public function __construct(UserListFieldWithValue $field)
    {
        $this->type         = FieldType::USER_LIST->value;
