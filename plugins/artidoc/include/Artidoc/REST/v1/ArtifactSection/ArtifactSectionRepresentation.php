...
final readonly class ArtifactSectionRepresentation implements SectionRepresentation
{
    ...
    /**
     * @param list<SectionStringFieldRepresentation | SectionUserGroupsListFieldRepresentation | SectionStaticListFieldRepresentation | SectionUserListFieldRepresentation | SectionArtifactLinkFieldRepresentation> $fields
     */
