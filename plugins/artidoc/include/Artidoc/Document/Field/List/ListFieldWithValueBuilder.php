...
final readonly class ListFieldWithValueBuilder implements BuildListFieldWithValue
{
    public function __construct(
        private BuildUserListFieldWithValue $build_user_list_field_with_value,
        private BuildStaticListFieldWithValue $build_static_list_field_with_value,
        private BuildUserGroupListWithValue $build_user_group_list_with_value,
    ) {
    }
    ...
    public function buildListFieldWithValue(ConfiguredField $configured_field, ?\Tracker_Artifact_ChangesetValue_List $changeset_value): UserGroupsListFieldWithValue|StaticListFieldWithValue|UserListFieldWithValue
    {
        ...
        return match ($configured_field->field->getBind()?->getType()) {
            \Tracker_FormElement_Field_List_Bind_Ugroups::TYPE => $this->build_user_group_list_with_value->buildUserGroupsListFieldWithValue($configured_field, $changeset_value),
            \Tracker_FormElement_Field_List_Bind_Static::TYPE  => $this->build_static_list_field_with_value->buildStaticListFieldWithValue($configured_field, $changeset_value),
            \Tracker_FormElement_Field_List_Bind_Users::TYPE   => $this->build_user_list_field_with_value->buildUserListFieldWithValue($configured_field, $changeset_value),
