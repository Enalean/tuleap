...
final class WASMResponseExecutorStub implements WASMResponseExecutor
{
    /**
    ...
    public static function buildOk(): self
    {
        return new self(Result::ok(null));
    }

    public static function buildErr(string $message): self
    {
        return new self(Result::err(Fault::fromMessage($message)));
    }

    public function prepareExecution(): self
    {
        return $this;
    }
