...
final class CallWASMFunctionTest extends TestCase
{
    ...
    {
        $caller = $this->buildWASMFunctionCaller(WASMCallerStub::wasmCallUnavailable());
    ...
    private function buildWASMFunctionCaller(WASMCaller $wasm_caller): CallWASMFunction
    {
        return new CallWASMFunction($wasm_caller, $this->response_processor, new NullLogger());
    }
}
