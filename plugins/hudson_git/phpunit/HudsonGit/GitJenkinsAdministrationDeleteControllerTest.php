...
class GitJenkinsAdministrationDeleteControllerTest extends TestCase
{
    use MockeryPHPUnitIntegration;

    /**
     * @var GitJenkinsAdministrationDeleteController
     */
    private $controller;
    ...
    /**
     * @var Mockery\LegacyMockInterface|Mockery\MockInterface|GitJenkinsAdministrationServerFactory
     */
    ...
    /**
     * @var Mockery\LegacyMockInterface|Mockery\MockInterface|GitJenkinsAdministrationServerDeleter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->git_jenkins_administration_server_factory = Mockery::mock(GitJenkinsAdministrationServerFactory::class);
        $this->git_jenkins_administration_server_deleter = Mockery::mock(GitJenkinsAdministrationServerDeleter::class);
        $this->csrf_token                                = Mockery::mock(CSRFSynchronizerToken::class);

        $this->controller = new GitJenkinsAdministrationDeleteController(
