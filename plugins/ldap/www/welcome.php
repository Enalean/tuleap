...
if($_POST['action'] == 'update_reg') {   
    if ($_POST['timezone'] == 'None') {
        exit_error($Language->getText('plugin_ldap', 'welcome_error_up'),
    ...
    print '<div style="border: 1px solid black; padding: 4px;">';
...
<p><input type="checkbox" name="form_mail_va" value="1" />'.$Language->getText('plugin_ldap', 'welcome_communitymail').'</p>';
    ...
    print '<p>'.$Language->getText('plugin_ldap', 'welcome_your_data', array($GLOBALS['sys_org_name'])).'</p>';
