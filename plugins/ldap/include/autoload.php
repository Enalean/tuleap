...
function autoloadda70ee28decfa7293741f6469c499600($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'ldap' => '/LDAP.class.php',
            ...
            'ldap_usernotcreatedexception' => '/LDAP_UserNotCreatedException.class.php',
...
spl_autoload_register('autoloadda70ee28decfa7293741f6469c499600');
