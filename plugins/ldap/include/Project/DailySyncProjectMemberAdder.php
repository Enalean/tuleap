...
class DailySyncProjectMemberAdder implements AddProjectMembers
{
    public function __construct(
        private readonly ProvideAnonymousUser $user_manager,
        private readonly ProjectMemberAdderWithStatusCheckAndNotifications $project_member_adder,
    ) {
    }
