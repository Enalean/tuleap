...
/**
 * An interface responsible for providing the ability to notify of users being added/removed by sync
 * */
interface GroupSyncNotificationsManager
{
    /**
     * @param $project   Project subject to the sync
     * @param $to_add    an array of user IDs to be added
     * @param $to_remove an array of user IDs to be removed
     * @return Void
     * */
