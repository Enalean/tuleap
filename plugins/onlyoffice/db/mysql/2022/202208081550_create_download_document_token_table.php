...
final class b202208081550_create_download_document_token_table extends \Tuleap\ForgeUpgrade\Bucket
{
    public function description(): string
    {
        return 'Create table plugin_onlyoffice_download_document_token';
    }
