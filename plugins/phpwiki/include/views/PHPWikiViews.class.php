...
function exit_wiki_empty() {
	...
	$HTML->header(array('title'=>$GLOBALS['Language']->getText('plugin_phpwiki_views_wikiserviceviews', 'title_error')));
    
	print $GLOBALS['Language']->getText('plugin_phpwiki_views_wikiserviceviews', 'not_activate', array($uname));
 ...
 */
class PHPWikiViews extends Views {
