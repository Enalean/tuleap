...
final class DocmanValidateRepresentationForCopyTest extends TestCase
{
    public function testValidCopyRepresentation() : void
    {
        ...
        $validator = new DocmanValidateRepresentationForCopy();

        $this->assertTrue($validator->isValidAsACopyRepresentation($representation));
    ...
    public function testValidNonCopyRepresentation() : void
    {
        ...
        $this->assertTrue($validator->isValidAsANonCopyRepresentation($representation));
