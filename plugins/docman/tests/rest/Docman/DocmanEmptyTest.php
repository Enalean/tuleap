...
class DocmanEmptyTest extends DocmanTestExecutionHelper
{
    ...
    {
        $response = $this->getResponse($this->request_factory->createRequest('OPTIONS', 'docman_empty_documents/' . $id), BaseTestDataBuilder::ADMIN_USER_NAME);
    ...
    {
        $response = $this->getResponse($this->request_factory->createRequest('OPTIONS', 'docman_empty_documents/' . $id . '/lock'), BaseTestDataBuilder::ADMIN_USER_NAME);
