...
final class FileVersionBuilder
{
    private int $id           = 12398;
    ...
    public static function aFileVersion(): self
    {
        return new self();
    }
    ...
    public function build(): \Docman_Version
    {
        return new \Docman_Version([
            'id' => $this->id,
