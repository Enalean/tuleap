...
final class DocmanFileTestBuilder
{
    private int $item_id        = 1;
    private string $title       = 'A file';
    private string $description = 'A file description';
    ...
    public static function aFile(): self
    {
        return new self();
    }
    ...
    public function build(): \Docman_File
    {
        return new \Docman_File([
