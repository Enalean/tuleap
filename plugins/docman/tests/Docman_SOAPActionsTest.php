...
class Docman_SOAPActionsTest extends UnitTestCase {
    ...
    public function testCreateItem() {
        ...
        $action->event_manager->expectAt(3, 'processEvent', array('plugin_docman_event_new_wikipage', '*'));
        $action->event_manager->expectAt(4, 'processEvent', array('send_notifications', '*'));
    ...
    public function testCreateItemNoDates() {
        ...
        $action->event_manager->expectAt(0, 'processEvent', array('plugin_docman_event_add', '*'));
        $action->event_manager->expectAt(1, 'processEvent', array('plugin_docman_event_new_wikipage', '*'));
