...
class DocumentFilesUploadLimitsSaver
{
    ...
    public function saveNbMaxFiles(\Tuleap\HTTPRequest $request, BaseLayout $layout): void
    {
    ...
    public function saveMaxFileSize(\Tuleap\HTTPRequest $request, BaseLayout $layout): void
    {
