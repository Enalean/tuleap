...
function autoloade4053a9da0636c06d9c24fc8e6d083cb($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'docman_approvaltabledao' => '/ApprovalTable/Dao.class.php',
...
spl_autoload_register('autoloade4053a9da0636c06d9c24fc8e6d083cb');
