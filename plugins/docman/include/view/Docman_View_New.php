...
abstract class Docman_View_New extends Docman_View_Display /* implements Visitor */ //phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace,Squiz.Classes.ValidClassName.NotPascalCase
{
    public $newItem;
