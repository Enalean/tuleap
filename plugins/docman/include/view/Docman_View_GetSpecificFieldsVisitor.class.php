...
class Docman_MetadataHtmlWiki extends Docman_MetadataHtml {
    ...
    function getField() {
        ...
        return '<input type="text" size="50" name="item[wiki_page]" value="'. $hp->purify($this->pagename) .'" /> ';
    }
...
class Docman_MetadataHtmlLink extends Docman_MetadataHtml {
    ...
    function getField() {
        $hp =& Codendi_HTMLPurifier::instance();
        return '<input type="text" size="100" name="item[link_url]" value="'. $hp->purify($this->link_url) .'" />';
    }
