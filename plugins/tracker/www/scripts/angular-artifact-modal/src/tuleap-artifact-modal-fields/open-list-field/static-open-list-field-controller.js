...
StaticOpenListFieldController.$inject = [
    '$element'
];

function StaticOpenListFieldController(
    $element
) {
    var self = this;
    ...
    function init() {
        ...
        var open_list_element = $element[0].querySelector('.tuleap-artifact-modal-open-list-static');
