        ...
        describe("Given a tracker object", function() {
            ...
            beforeEach(function() {
                tracker = {
                    fields: [
                        ...
                        { field_id: 14, type: 'computed', permissions: ["read", "update", "create"]},
            ...
            it("and given the modal was opened in creation mode, when I transform the tracker, then the awkward fields for creation mode (e.g. burndown, subby, subon) will be omitted from the transformed tracker's fields", function() {
                ...
                expect(transformed_tracker.fields).toEqual([
                    ...
                    { field_id: 5, type: 'column', permissions: ["read"] },
                    { field_id: 6, type: 'int', permissions: ["read", "update", "create"]},
                    { field_id: 14, type: 'computed', permissions: ["read", "update", "create"], value: null},
                    { field_id: 17, type: 'perm', permissions: ["read", "update", "create"] }
                ]);
            });
            ...
            describe("containing list fields", function() {
                ...
                it("bound to user groups, when I transform the tracker, then the values labels will be internationalized", function() {
                    ...
                    expect(transformed_tracker.fields[0].values[2]).toEqual(jasmine.objectContaining(
                        {
                            id: "101_4",
                            label: "MSB Other Group Name"
                        }
                    ));
                    expect(transformed_tracker.fields[1].values[0]).toEqual({ id: 100, label: "None" });
                    expect(transformed_tracker.fields[1].values[1]).toEqual(jasmine.objectContaining(
                        {
                            id: "103_4",
                            label: "SB Group Name"
                        }
                    ));
                    expect(transformed_tracker.fields[2].values[0]).toEqual(jasmine.objectContaining(
                        {
                            id: "108_3",
                            label: "CB Group Name"
                        }
                    ));
                    expect(transformed_tracker.fields[3].values[0]).toEqual(jasmine.objectContaining(
                        {
                            id: "107_4",
                            label: "RB Group Name"
                        }
