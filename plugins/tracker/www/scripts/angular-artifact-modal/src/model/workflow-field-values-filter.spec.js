...
describe("workflow-field-values-filter", () => {
    describe("enforceWorkflowTransitions() -", () => {
        it(`Given a selected value, a selectbox field
            ...
            expect(field.values).toContain({ id: 448 });
            expect(field.values).toContain({ id: 6 });
            expect(field.values).toContain({ id: 23 });
            expect(field.values).not.toContain({ id: 908 });
            expect(field.values).not.toContain({ id: 71 });
