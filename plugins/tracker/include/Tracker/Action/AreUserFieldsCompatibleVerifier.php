...
final class AreUserFieldsCompatibleVerifier implements VerifyUserFieldsAreCompatible
{
    public function areUserFieldsCompatible(
        ...
        return (isset($list_field_value[0]) && $list_field_value[0] instanceof \Tracker_FormElement_Field_List_Bind_UsersValue);
    }
}
