...
final class MovableStaticListFieldsChecker implements CheckStaticListFieldsValueIsMovable
{
    ...
    public function checkStaticFieldCanBeMoved(
        ...
        if (! isset($list_field_value[0]) || ! $list_field_value[0] instanceof Tracker_FormElement_Field_List_Bind_StaticValue) {
            return false;
        }

        return $this->retrieve_matching_bind_value_by_duck_typing->getMatchingBindValueByDuckTyping(
            $list_field_value[0],
            $target_field
        ) !== null;
    }
