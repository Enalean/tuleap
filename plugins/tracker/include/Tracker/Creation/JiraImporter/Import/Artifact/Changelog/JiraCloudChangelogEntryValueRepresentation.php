 ...
 * @psalm-immutable
 */
final class JiraCloudChangelogEntryValueRepresentation implements ChangelogEntryValueRepresentation
{
    /**
    ...
    public static function buildFromAPIResponse(array $changelog_response): self
    {
        ...
        foreach ($changelog_response['items'] as $changelog_reponse_item) {
            $items[] = JiraCloudChangelogEntryItemsRepresentation::buildFromAPIResponse($changelog_reponse_item);
        }
