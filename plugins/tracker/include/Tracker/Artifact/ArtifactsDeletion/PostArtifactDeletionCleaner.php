...
class PostArtifactDeletionCleaner
{
    ...
    public function cleanReferencesAfterSimpleArtifactDeletion(Artifact $artifact): void
    {
        $delete_artifact_visitor = new ArtifactFilesDeletorVisitor($artifact);
        ...
        foreach ($tracker->getFormElementFields() as $form_element) {
            $form_element->accept($delete_artifact_visitor);
        }
