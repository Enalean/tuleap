...
class Tracker_XMLExporter_ChangesetValue_ChangesetValueFileXMLExporter extends Tracker_XMLExporter_ChangesetValue_ChangesetValueXMLExporter {
    ...
    public function __construct(Tracker_XMLExporter_FilePathXMLExporter $path_exporter) {
