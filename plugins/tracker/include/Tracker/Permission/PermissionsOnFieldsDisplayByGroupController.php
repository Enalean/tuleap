...
EOS;
        ...
        if ((count($ugroups_permissions) < 1)) {
            ...
            $html .= '<div>';
            $html .= '<input type="hidden" name="origin" value="fields-by-group" />';
            ...
            $html .= $GLOBALS['Language']->getText('plugin_tracker_admin_permissions', 'fields_tracker_toggle_field', PermissionsOnFieldsDisplayByFieldController::getUrl($tracker));
            ...
            foreach ($related_parts as $ugroup_permissions) {
                ...
                $name = '<a href="'. PermissionsOnFieldsDisplayByFieldController::getUrl($tracker) .'?selected_id='. (int)$second_part['id'] .'">';
