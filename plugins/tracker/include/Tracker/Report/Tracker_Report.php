...
class Tracker_Report implements Tracker_Dispatchable_Interface // phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace,Squiz.Classes.ValidClassName.NotCamelCaps
{
    ...
    {
        $html  = '<button id="tracker-report-expert-query-button" data-test="expert-mode" type="button" class="btn btn-mini tracker-report-query-button">';
    ...
    private function fieldAllowsCustomColumnForTableReport(Tracker_FormElement_Field $field, $dropdown_type)
    {
        return $this->getArtifactLinksUsageUpdater()->isProjectAllowedToUseArtifactLinkTypes($this->getTracker()->getProject()) &&
            $dropdown_type === self::TYPE_TABLE &&
               $this->getFormElementFactory()->getType($field) === ArtifactLinkField::TYPE;
    }
    ...
    protected function _fetchAddCriteria($used) // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
        $html = '';
