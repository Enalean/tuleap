 ...
 */
final class FloatToEmptyStringTermException extends InvalidFieldException implements TermVisitor
{
    ...
    {
        throw new RuntimeException("The float field '%s' is not supposed to be used with WITH PARENT operator.");
    }
