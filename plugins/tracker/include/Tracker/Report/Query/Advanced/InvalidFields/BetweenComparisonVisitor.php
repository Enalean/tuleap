...
final class BetweenComparisonVisitor implements Tracker_FormElement_FieldVisitor, IProvideTheInvalidFieldCheckerForAComparison
{
    private static $OPERATOR = 'between()';
