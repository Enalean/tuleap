...
class BetweenDateValuesExtractor implements ValueWrapperVisitor
{
    /**
     * @var string
     */
    ...
    public function extractBetweenValues(BetweenValueWrapper $value_wrapper, Tracker_FormElement_Field $field)
    {
