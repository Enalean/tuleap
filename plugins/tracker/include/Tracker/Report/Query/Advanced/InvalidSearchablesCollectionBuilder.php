...
class InvalidSearchablesCollectionBuilder
{
    /**
    ...
    public function __construct(ICollectErrorsForInvalidComparisons $invalid_comparison_collector)
    {
     ...
     */
    public function buildCollectionOfInvalidSearchables($parsed_expert_query)
    {
