...
class AndExpression implements Logical
{
    public function __construct(private readonly Comparison $expression, private readonly ?AndOperand $tail = null)
    {
    }
    ...
    public function getExpression(): Comparison
    {
