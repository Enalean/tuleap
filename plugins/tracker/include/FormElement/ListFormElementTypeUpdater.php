...
class ListFormElementTypeUpdater
{
     ...
     */
    public function updateFormElementType(Field\List\ListField $form_element, string $type): void
    {
        $this->db_transaction_executor->execute(
            function () use ($form_element, $type) {
                ...
                foreach ($target_fields as $target_field) {
                    assert($target_field instanceof Field\List\ListField);
    ...
    private function changeFormElementType(Field\List\ListField $form_element, string $type): bool
    {
        ...
        if (! $new_form_element instanceof Field\List\ListField) {
            return false;
        }
    ...
    private function clearDefaultValuesIfNeeded(Field\List\ListField $old_form_element, Field\List\ListField $new_form_element): void
    {
