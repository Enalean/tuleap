...
class Tracker_FormElement_Field_SubmittedOn extends Tracker_FormElement_Field_Date implements Tracker_FormElement_Field_ReadOnly {
    ...
    public static function getFactoryLabel() {
        return $GLOBALS['Language']->getText('tracker_formelement_admin', 'submittedon_label');
    }
    ...
    public static function getFactoryDescription() {
        return $GLOBALS['Language']->getText('tracker_formelement_admin', 'submittedon_description');
    }
