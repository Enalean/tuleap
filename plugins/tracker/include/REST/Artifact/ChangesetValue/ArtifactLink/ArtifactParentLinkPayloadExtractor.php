...
final class ArtifactParentLinkPayloadExtractor
{
     ...
     */
    public function extractParentLinkFromPayload(array $payload): ?RESTForwardLinkProxy
    {
        return $this->hasPayloadAParentKey($payload) ? RESTForwardLinkProxy::fromPayload($payload[self::FIELDS_DATA_PARENT_KEY]) : null;
    }
