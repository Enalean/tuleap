...
class TrackersResource extends AuthenticatedResource
{
     ...
     * <ol>
     *  <li>You can use: AND, OR, WITH|WITHOUT PARENT, BETWEEN(), NOW(), IN(), NOT IN(), MYSELF() parenthesis.
     ...
     * @param string $expert_query   Query with AND, OR, WITH|WITHOUT PARENT, BETWEEN(), NOW(), IN(), NOT IN(), MYSELF(), parenthesis
