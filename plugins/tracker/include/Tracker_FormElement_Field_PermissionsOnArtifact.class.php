...
require_once('Tracker_Artifact_ChangesetValue_PermissionsOnArtifact.class.php');
require_once('dao/Tracker_Report_Criteria_PermissionsOnArtifact_ValueDao.class.php');
