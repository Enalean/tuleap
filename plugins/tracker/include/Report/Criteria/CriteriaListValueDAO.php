...
final class CriteriaListValueDAO extends DataAccessObject implements DeleteReportCriteriaValue
{
    public function deleteCriteriaFieldValue(\Tracker_Report_Criteria $criteria): void
    {
        $this->getDB()->run(
            'DELETE tracker_report_criteria_list_value.*
             FROM tracker_report_criteria_list_value
