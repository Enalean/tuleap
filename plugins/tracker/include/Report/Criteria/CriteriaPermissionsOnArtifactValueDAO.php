...
final class CriteriaPermissionsOnArtifactValueDAO extends DataAccessObject implements DeleteReportCriteriaValue
{
    #[\Override]
    public function deleteCriteriaFieldValue(\Tracker_Report_Criteria $criteria): void
    {
        $this->getDB()->run(
            'DELETE tracker_report_criteria_permissionsonartifact_value.*
             FROM tracker_report_criteria_permissionsonartifact_value
