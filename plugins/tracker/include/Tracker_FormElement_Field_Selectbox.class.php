...
require_once('common/tracker/dao/Tracker_FormElement_Field_List_Bind_Static_ValueDao.class.php');
require_once('common/tracker/dao/Tracker_FormElement_Field_List_Bind_StaticDao.class.php');
...
class Tracker_FormElement_Field_Selectbox extends Tracker_FormElement_Field_List {
    ...
    public static function getFactoryLabel() {
        return $GLOBALS['Language']->getText('tracker_formelement_admin','selectbox');
    }
    ...
    public static function getFactoryDescription() {
        return $GLOBALS['Language']->getText('tracker_formelement_admin','selectbox_description');
    }
    ...
    protected function fetchChangeType() {
        $html = ' (<a href="/tracker/?'. http_build_query(array(
               ...
               .$GLOBALS['Language']->getText('tracker_formelement_admin','switch_msb').'</a>)';
