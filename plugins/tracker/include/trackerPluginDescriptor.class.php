...
class trackerPluginDescriptor extends PluginDescriptor {
    ...
    function trackerPluginDescriptor() {
        $this->PluginDescriptor($GLOBALS['Language']->getText('plugin_tracker', 'descriptor_name'), '0.1', $GLOBALS['Language']->getText('plugin_tracker', 'descriptor_description'));
    }
}
?>