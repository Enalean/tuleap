...
function autoloadff14cabeee097776cf75acac9fbb9f8c($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tracker_xmlexporter_childrencollector' => '/Tracker/XMLExporter/ChildrenCollector.class.php',
...
spl_autoload_register('autoloadff14cabeee097776cf75acac9fbb9f8c');
