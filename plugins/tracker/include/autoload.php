...
function autoloadc5b90992826884d6ec356f5b66ff6270($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tracker_artifact_xmlimport_exception_filenotfound' => '/Tracker/Artifact/XMLImport/Exception/FileNotFound.class.php',
...
spl_autoload_register('autoloadc5b90992826884d6ec356f5b66ff6270');
