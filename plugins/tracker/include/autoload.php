...
function autoload15db876db351bf31791c94635cb0f36b($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tracker_artifact_burndown_paneinfo' => '/Tracker/Artifact/Burndown/Pane.class.php',
...
spl_autoload_register('autoload15db876db351bf31791c94635cb0f36b');
