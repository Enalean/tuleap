...
function autoload64dad0e034997c7c552852bd8d6dce68($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tracker_xmlexporter_artifactxmlexporter' => '/Tracker/XMLExporter/ArtifactXMLExporter.class.php',
...
spl_autoload_register('autoload64dad0e034997c7c552852bd8d6dce68');
