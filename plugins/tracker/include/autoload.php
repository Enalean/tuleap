...
function autoload9b51042239cefac7e9ce8bdb2cbc0650($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tracker_formelement_notimplementedforrestexception' => '/Tracker/FormElement/Tracker_FormElement_NotImplementedForRESTException.php',
...
spl_autoload_register('autoload9b51042239cefac7e9ce8bdb2cbc0650');
