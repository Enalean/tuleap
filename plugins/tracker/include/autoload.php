...
function autoloadc9d06dbd20c338bae586b04fab181acc($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tracker_ugrouppermissionsgoldenretriever' => '/Tracker/UgroupPermissionsRetriever.class.php',
...
spl_autoload_register('autoloadc9d06dbd20c338bae586b04fab181acc');
