...
class Tracker_FormElement_StaticField_Separator extends Tracker_FormElement_StaticField {
    ...
    public function fetchLabel() {
        ...
        $html .= '<span class="tracker-admin-form-element-help">';
        $html .= $GLOBALS['Language']->getText('tracker_formelement_admin', 'separator_label_help');
        $html .= '</span>';
        return $html;
    }
    ...
    function getLabel() {
        ...
        if ( ! $label) {
            return $GLOBALS['Language']->getText('tracker_formelement_admin', 'separator_label');
        } else {
        	return $label;
        }
    }
    ...
    public static function getFactoryDescription() {
        return $GLOBALS['Language']->getText('tracker_formelement_admin', 'separator_description');
    }
