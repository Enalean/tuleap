...
final class AdminPresenterBuilder
{
    ...
    public function build(\Tuleap\Tracker\Semantic\Title\TrackerSemanticTitle $semantic_title, \Tuleap\Tracker\Tracker $tracker, CSRFSynchronizerToken $csrf_token): AdminPresenter
    {
