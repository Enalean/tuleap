...
require_once('common/tracker/Tracker_Semantic_Status.class.php');
Mock::generate('Tracker_Semantic_Status');

require_once('common/tracker/Tracker_Semantic_Title.class.php');
Mock::generate('Tracker_Semantic_Title');

require_once('common/tracker/Tracker_Tooltip.class.php');
Mock::generate('Tracker_Tooltip');

require_once('common/tracker/Tracker_Semantic_Contributor.class.php');
Mock::generate('Tracker_Semantic_Contributor');

require_once('common/tracker/Tracker_Semantic_StatusFactory.class.php');
Mock::generate('Tracker_Semantic_StatusFactory');

require_once('common/tracker/Tracker_Semantic_TitleFactory.class.php');
Mock::generate('Tracker_Semantic_TitleFactory');

require_once('common/tracker/Tracker_TooltipFactory.class.php');
Mock::generate('Tracker_TooltipFactory');

require_once('common/tracker/Tracker_Semantic_ContributorFactory.class.php');
