...
function aBindUsersValue()
{
    return new \Tracker_FormElement_Field_List_Bind_UsersValue_Builder(
        'Tracker_FormElement_Field_List_Bind_UsersValue'
    );
}

class Tracker_FormElement_Field_List_Bind_UsersValue_Builder
{
    private $id;
    private $user_name;
    ...
    public function withUserName($user_name)
    {
        $this->user_name = $user_name;
        return $this;
    }

    public function withDisplayName($display_name)
    {
    ...
    {
        $klass = $this->name;
        $object = new $klass($this->id, $this->user_name, $this->display_name);
        return $object;
    }
}
