...
Mock::generate('Tracker_RulesManagerTest_Tracker_FieldFactory','MockTracker_FieldFactory');
...
Mock::generate('Tracker_RulesManagerTest_ArtifactField','MockArtifactField');
*/
...
class Tracker_RulesManagerTest extends UnitTestCase {
     ...
     */
    function Tracker_RulesManagerTest($name = 'Tracker_RulesManager test') {
...
/* OBSOLETE 
    ...
    function testValidate() {
        ...
        $arf->setReturnValue('getAllRulesByArtifactTrackerWithOrder', array(&$r1, &$r2, &$r3, &$r4, &$r5, &$r6, &$r7));
