...
class Tracker_Semantic_StatusTest extends UnitTestCase {
    ...
    public function testExport() {
        ...
        $GLOBALS['Language']->setReturnValue('getText','Status', array('tracker_admin_semantic','status_label'));
        $GLOBALS['Language']->setReturnValue('getText','Define the status of an artifact', array('tracker_admin_semantic','status_description'));
