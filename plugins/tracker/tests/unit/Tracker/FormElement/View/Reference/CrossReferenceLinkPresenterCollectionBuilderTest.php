...
class CrossReferenceLinkPresenterCollectionBuilderTest extends TestCase
{
    ...
    {
        $array_presenter = $this->builder->build([], 'source');
    ...
    public function testItReturnsOneTargetCrossRefAndDontDisplayComma(): void
    {
        ...
        $array_presenter = $this->builder->build([$this->cross_ref_target_1], 'target');
    ...
    public function testItReturnsTwoTargetsCrossRefs(): void
    {
        ...
        $array_presenter = $this->builder->build([$this->cross_ref_target_1, $this->cross_ref_target_2], 'target');
    ...
    public function testItReturnsOneSourceCrossRefAndDontDisplayComma(): void
    {
        ...
        $array_presenter = $this->builder->build([$this->cross_ref_target_1], 'source');
