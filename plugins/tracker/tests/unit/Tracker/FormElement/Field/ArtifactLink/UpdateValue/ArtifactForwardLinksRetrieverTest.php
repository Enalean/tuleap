...
final class ArtifactForwardLinksRetrieverTest extends \Tuleap\Test\PHPUnit\TestCase
{
    ...
    private function retrieve(?Artifact $artifact): CollectionOfArtifactLinks
    {
    ...
    public function testItReturnsDirectlyCachedLinksInfoWhenThereAreAvailable(): void
    {
        ...
        $this->cache->cacheLinksInfoForChangeset(
            ...
            new CollectionOfArtifactLinks([
                LinkStub::withType(self::FIRST_ARTIFACT_ID, '_is_child'),
                LinkStub::withType(self::SECOND_ARTIFACT_ID, '_is_child'),
            ])
        );
