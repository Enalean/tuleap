...
final class MegaMoverArtifactByDuckTypingTest extends TestCase
{
    ...
    private MoveChangesetXMLUpdater|\PHPUnit\Framework\MockObject\Stub $xml_updater;
    ...
    protected function setUp(): void
    {
        ...
        $this->xml_updater                = $this->createStub(MoveChangesetXMLUpdater::class);
    ...
    public function testItThrowsWhenMoveCanNotBeProcessed(): void
    {
        ...
        $this->xml_updater->expects(self::once())->method('updateFromDuckTypingCollection');
