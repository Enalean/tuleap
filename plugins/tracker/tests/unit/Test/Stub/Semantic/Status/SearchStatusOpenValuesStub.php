...
use Tuleap\Tracker\Semantic\Status\SearchStatusOpenValues;

final class SearchStatusOpenValuesStub implements SearchStatusOpenValues
{
    /** @psalm-var callable(int): list<int> */
    private $callback;
