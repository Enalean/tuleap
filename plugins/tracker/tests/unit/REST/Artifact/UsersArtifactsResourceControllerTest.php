...
class UsersArtifactsResourceControllerTest extends TestCase
{
    ...
    public function testFetchArtifactsSubmittedByUserWithData(): void
    {
        ...
        $artifact1 = M::mock(\Tuleap\Tracker\Artifact\Artifact::class, ['getId' => 455, 'getTitle' => '', 'getUri' => '', 'getXRef' => '', 'getTracker' => $tracker, 'userCanView' => true]);
        $artifact2 = M::mock(\Tuleap\Tracker\Artifact\Artifact::class, ['getId' => 456, 'getTitle' => 'bar', 'getUri' => '', 'getXRef' => '', 'getTracker' => $tracker, 'userCanView' => true]);
