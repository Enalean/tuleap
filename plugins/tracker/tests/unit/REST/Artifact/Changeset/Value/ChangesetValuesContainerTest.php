...
use Tuleap\Tracker\FormElement\Field\ArtifactLink\UpdateValue\ArtifactLinksFieldUpdateValue;
...
final class ChangesetValuesContainerTest extends \Tuleap\Test\PHPUnit\TestCase
{
    ...
    public function testItBuildsWithArtifactLinkValue(): void
    {
        ...
        $submitted_links     = new CollectionOfArtifactLinks([
            ...
            LinkStub::withNoType(42),
        ]);
        $already_linked      = new CollectionOfArtifactLinks([
            LinkStub::withType(53, '_is_child'),
            LinkStub::withNoType(34),
        ]);
