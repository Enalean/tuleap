...
final class RESTLinkProxyTest extends \Tuleap\Test\PHPUnit\TestCase
{
    public function testFromPayload()
    {
        $link = RESTLinkProxy::fromPayload(['id' => 101, 'type' => '_is_child']);
    ...
    public function testItThrowsWhenThereIsNoArtifactIdInPayload(): void
    {
        ...
        RESTLinkProxy::fromPayload(['type' => '_is_child']);
    }

    public function testItDefaultsToNullWhenNoType(): void
    {
        $link = RESTLinkProxy::fromPayload(['id' => 75]);
