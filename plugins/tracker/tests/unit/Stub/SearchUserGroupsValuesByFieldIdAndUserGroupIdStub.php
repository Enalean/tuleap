...
final class SearchUserGroupsValuesByFieldIdAndUserGroupIdStub implements SearchUserGroupsValuesByFieldIdAndUserGroupId
{
    /**
    ...
    public function searchByFieldIdAndGroupId(int $field_id, int $ugroup_id): ?array
    {
        foreach ($this->values as $value) {
            if ($value['field_id'] === $field_id && $value['ugroup_id'] === $ugroup_id) {
                return $value;
            }
        }
