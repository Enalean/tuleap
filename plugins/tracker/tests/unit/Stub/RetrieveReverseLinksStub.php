...
final class RetrieveReverseLinksStub implements RetrieveReverseLinks
{
    private function __construct(private CollectionOfReverseLinks $links)
    {
    }

    public static function withLinks(CollectionOfReverseLinks $links): self
    {
