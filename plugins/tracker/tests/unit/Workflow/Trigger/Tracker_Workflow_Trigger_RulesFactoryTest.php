...
final class Tracker_Workflow_Trigger_RulesFactoryTest extends \Tuleap\Test\PHPUnit\TestCase // phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace,Squiz.Classes.ValidClassName.NotPascalCase
{
    ...
    {
        $target_field = $this->createMock(SelectboxField::class);
    ...
    public function testItHasATrigger(): void
    {
        ...
        $trigger_field = $this->createMock(SelectboxField::class);
    ...
    public function testItHasTwoTriggers(): void
    {
        ...
        $trigger_field_1 = $this->createMock(SelectboxField::class);
        ...
        $trigger_field_2 = $this->createMock(SelectboxField::class);
