...
final class Tracker_Chart_Data_BurndownTest extends \Tuleap\Test\PHPUnit\TestCase //phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace, Squiz.Classes.ValidClassName.NotPascalCase
{
    private $start_date;
    private $date_period;
    ...
    protected function setUp(): void
    {
        ...
        $this->date_period = DatePeriodWithOpenDays::buildFromDuration($this->start_date, 5);
    }
