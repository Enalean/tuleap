...
final class TrackerXMLFieldMappingFromExistingTrackerTest extends TestCase
{
    ...
    private ListFieldStaticBindValue $bind_value_1;
    private ListFieldStaticBindValue $bind_value_2;
    private ListFieldStaticBindValue $bind_value_3;
    private ListFieldStaticBindValue $bind_value_4;
    private ListFieldStaticBindValue $bind_value_5;
    private ListFieldStaticBindValue $bind_value_6;
