...
final class TimeframeWithEndDateTest extends \Tuleap\Test\PHPUnit\TestCase
{
    ...
    public function testItReturnsItsConfigDescription(): void
    {
        ...
        $this->end_date_field->method('getLabel')->willReturn('End date');
    ...
    public function testItDoesNotExportToRESTWhenUserCanReadFields(bool $can_read_start_date, bool $can_read_end_date): void
    {
        ...
        $this->end_date_field->method('userCanRead')->willReturn($can_read_end_date);
    ...
    public function testItExportsToREST(): void
    {
        ...
        $this->end_date_field->method('userCanRead')->willReturn(true);
    ...
    public function testItSaves(): void
    {
        ...
        $dao->expects($this->once())->method('save')->with(113, 1001, null, 1003, null)->willReturn(true);
    ...
    public function testItBuildsADatePeriodWithNoEndDateWhenNoEndDateValueExist(): void
    {
        ...
        $this->end_date_field->expects($this->once())->method('userCanRead')->willReturn(true);
    ...
    public function testItBuildsADatePeriodForRESTFromEndDateWithNullIfEndDateIsNotReadable(): void
    {
        ...
        $this->start_date_field->expects($this->once())->method('userCanRead')->willReturn(true);
        $this->end_date_field->expects($this->once())->method('userCanRead')->willReturn(false);
    ...
    public function testIsTimeDisplayedIsCorrelatedToStartAndEndField(bool $display_start, bool $display_end): void
    {
        ...
        $display_start && $this->end_date_field->expects($this->once())->method('isTimeDisplayed')->willReturn($display_end);
