...
final class Tracker_XML_Updater_FieldChange_FieldChangeDateXMLUpdaterTest extends \Tuleap\Test\PHPUnit\TestCase // phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace,Squiz.Classes.ValidClassName.NotPascalCase
{
    ...
    public function testItUpdatesTheNodeValueWithSubmittedValue(): void
    {
        ...
        $this->assertEquals('2014-04-28T00:00:00+02:00', $this->field_change_xml->value);
    }
}
