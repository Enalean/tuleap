...
{
    public const string MOVE_PROJECT_NAME                           = 'move-artifact';
    public const string MOVE_FORBIDDEN_PROJECT_NAME                 = 'tracker-move-forbidden';
    public const string DELETE_PROJECT_NAME                         = 'test-delete-artifacts';
    public const string TRACKER_FIELDS_PROJECT_NAME                 = 'test-tracker-fields';
    public const string TRACKER_ADMINISTRATOR_PROJECT_NAME          = 'test-tracker-project-filter';
    public const string TRACKER_WORKFLOWS_PROJECT_NAME              = 'test-tracker-workflows';
    public const string TRACKER_SEMANTICS_PROJECT_NAME              = 'test-tracker-semantics';
    public const string TRACKER_ARTIFACTS_PROJECT_NAME              = 'test-tracker-artifacts';
    private const string TRACKER_FILE_URL_PROJECT_NAME              = 'test-tracker-file-url';
    private const string REST_XML_API_PROJECT_NAME                  = 'rest-xml-api';
    private const string COMPUTED_VALUE_PROJECT_NAME                = 'computed-fields-default-value';
    public const string PRIVATE_COMMENT_PROJECT_NAME                = 'tracker-private-comment';
    private const string TRACKER_ALL_FIELDS_PROJECT_NAME            = 'tracker-all-fields';
    private const string FILE_FIELD_ARTIFACT_CHANGESET_PROJECT_NAME = 'file-field-artifact-changeset';
    private const string TRACKER_REPORTS_PROJECT_NAME               = 'tracker-reports';
    private const string OPEN_LIST_PROJECT_NAME                     = 'openlistxml';

    public const string MOVE_TRACKER_SHORTNAME                           = 'tracker_destination';
    public const string MOVE_TRACKER_FORBIDDEN_SHORTNAME                 = 'move_tracker_forbidden';
    public const string MOVE_DESTINATION_TRACKER_SHORTNAME               = 'destination_tracker';
    public const string BASE_TRACKER_SHORTNAME                           = 'tracker_source';
    public const string DELETE_TRACKER_SHORTNAME                         = 'diasabled_delete_artifacts_testing_2';
    public const string TRACKER_FIELDS_TRACKER_SHORTNAME                 = 'tracker_fields_tracker';
    public const string SIMPLE_01_TRACKER_SHORTNAME                      = 'simple_tracker_01';
    public const string SIMPLE_02_TRACKER_SHORTNAME                      = 'simple_tracker_02';
    public const string TRACKER_WITH_WORKFLOWS_SHORTNAME                 = 'workflows_tracker';
    public const string TRACKER_WORKFLOW_WITH_TRANSITIONS_SHORTNAME      = 'workflows_tracker_transitions';
    public const string TRACKER_WORKFLOW_SIMPLE_MODE_SHORTNAME           = 'workflow_simple_mode';
    public const string TRACKER_WORKFLOW_SIMPLE_MODE_TO_SWITCH_SHORTNAME = 'simple_workflow_to_switch';
    public const string TRACKER_WORKFLOW_SIMPLE_MODE_FROM_XML_SHORTNAME  = 'workflow_simple_mode_from_xml';
    public const string TRACKER_WITH_TIMEFRAME_SEMANTIC_SHORTNAME        = 'tracker_semantic_timeframe';
    public const string TRACKER_ARTIFACTS_TRACKER_SHORTNAME              = 'tracker_artifacts_test';
    private const string TRACKER_FILE_URL_SHORTNAME                      = 'image';
    private const string REST_XML_API_TRACKER_SHORTNAME                  = 'epic';
    private const string COMPUTED_VALUE_TRACKER_SHORTNAME                = 'ComputedFieldsDefaultValues';
    private const string PRIVATE_COMMENT_TRACKER_SHORTNAME               = 'bug';
    private const string TRACKER_ALL_FIELDS_TRACKER_SHORTNAME            = 'all_fields';
    private const string TRACKER_FILE_AND_TITLE_FIELDS_TRACKER_SHORTNAME = 'file_and_title_fields';
    private const string TRACKER_REPORTS_TRACKER_SHORTNAME               = 'report_renderers';
    private const string OPEN_LIST_TRACKER_SHORTNAME                     = 'openlisttracker';
