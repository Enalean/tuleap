...
Mock::generatePartial('Tracker_FormElement_Field_WebLink', 'Tracker_FormElement_Field_WebLinkTestVersion', array('getRuleString', 'getRuleNoCr', 'getProperty'));
...
class Tracker_FormElement_Field_WebLinkTest extends UnitTestCase {
    ...
    function testIsValid() {
        ...
        $string = new Tracker_FormElement_Field_WebLinkTestVersion();
