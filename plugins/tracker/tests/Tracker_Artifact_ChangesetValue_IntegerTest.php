...
require_once(dirname(__FILE__).'/../include/Tracker_Artifact_ChangesetValue_Integer.class.php');
require_once(dirname(__FILE__).'/../include/Tracker_FormElement_Field_Integer.class.php');
