...
require_once('common/tracker/dao/Tracker_FormElement_Field_Value_OpenListDao.class.php');
...
require_once('common/tracker/dao/Tracker_FormElement_Field_List_OpenValueDao.class.php');
