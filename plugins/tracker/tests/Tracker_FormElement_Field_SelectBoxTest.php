...
class Tracker_FormElement_Field_List_getFieldDataFromSoapValue extends TuleapTestCase {
    private $field;
    private $bind;
    ...
    public function itFallsBackToValueStringProcessing() {
        ...
        expect($this->bind)->getFieldData('1586', false)->once();

        $this->field->getFieldDataFromSoapValue($soap_value);
    }
    ...
    public function itPrefersBindValueOnStringValue() {
        ...
        expect($this->bind)->getFieldData(2331, false)->once();
        $this->field->getFieldDataFromSoapValue($soap_value);
    }
}
?>
