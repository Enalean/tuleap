...
class Tracker_XMLExporter_ChildrenXMLExporterTest extends TuleapTestCase {
    ...
    public function setUp() {
        ...
        $this->artifact_xml_exporter = new Tracker_XMLExporter_ChildrenXMLExporterTest_ArtifactXMLExporter();
        ...
        $this->exporter         = new Tracker_XMLExporter_ChildrenXMLExporter(
    ...
    public function itDoesNothingIfCollectorIsEmpty() {
        ...
        $this->exporter->exportChildren($this->artifact_xml, $this->collector);
    }
...
Mock::generate('Tracker_XMLExporter_ArtifactXMLExporter');
class Tracker_XMLExporter_ChildrenXMLExporterTest_ArtifactXMLExporter extends MockTracker_XMLExporter_ArtifactXMLExporter {
