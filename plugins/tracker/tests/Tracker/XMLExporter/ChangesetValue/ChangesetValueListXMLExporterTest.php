...
class Tracker_XMLExporter_ChangesetValue_ChangesetValueListXMLExporterTest extends TuleapTestCase {
    ...
    public function setUp() {
        parent::setUp();
        $this->exporter      = new Tracker_XMLExporter_ChangesetValue_ChangesetValueListXMLExporter();
