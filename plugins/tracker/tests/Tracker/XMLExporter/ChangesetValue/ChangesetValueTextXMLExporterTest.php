...
class Tracker_XMLExporter_ChangesetValue_ChangesetValueTextXMLExporterTest extends TuleapTestCase {
    ...
    public function setUp() {
        ...
        $this->exporter      = new Tracker_XMLExporter_ChangesetValue_ChangesetValueTextXMLExporter();
