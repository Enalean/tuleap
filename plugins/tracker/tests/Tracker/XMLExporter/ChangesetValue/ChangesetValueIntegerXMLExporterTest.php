...
class Tracker_XMLExporter_ChangesetValue_ChangesetValueIntegerXMLExporterTest extends TuleapTestCase {
    ...
    public function setUp() {
        ...
        $this->exporter      = new Tracker_XMLExporter_ChangesetValue_ChangesetValueIntegerXMLExporter();
