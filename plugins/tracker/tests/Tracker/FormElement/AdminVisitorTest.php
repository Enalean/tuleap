...
require_once(dirname(__FILE__).'/../../../include/Tracker/FormElement/admin/Visitor.class.php');
...
class AdminVisitorTest extends TuleapTestCase {
    ...
    public function testVisitAStringShouldFallbackOnField() {
        $visitor = new Tracker_FormElement_Admin_Visitor(array());
        ...
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field');
    }
    ...
    public function testVisitAColumnShouldFallbackOnContainer() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Container');
    }
    ...
    public function testVisitAnOpenListShouldFallbackOnList() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_List');
    }
    ...
    public function testVisitARichTextShouldFallbackStaticField() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_StaticField');
    }
    ...
    public function testVisitSelectbox() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_Selectbox');
    }
    ...
    public function testVisitArtifactId() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_ArtifactId');
    }
    ...
    public function testVisitCrossReferences() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_CrossReferences');
    }
    ...
    public function testVisitLastUpdateDate() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_LastUpdateDate');
    }
    ...
    public function testVisitMultiSelectbox() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_MultiSelectbox');
    }
    ...
    public function testVisitPermissionsOnArtifact() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_PermissionsOnArtifact');
    }
    ...
    public function testVisitSubmittedBy() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_SubmittedBy');
    }
    ...
    public function testVisitSubmittedOn() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_Field_SubmittedOn');
    }
    ...
    public function testVisitLineBreak() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_StaticField_LineBreak');
    }
    ...
    public function testVisitSeparator() {
        ...
        $formElement->accept($visitor);
        $this->assertIsA($visitor->getAdmin(), 'Tracker_FormElement_Admin_StaticField_Separator');
    }
}
