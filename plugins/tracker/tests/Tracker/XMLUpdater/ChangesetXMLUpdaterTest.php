...
class Tracker_XMLUpdater_ChangesetXMLUpdaterTest extends TuleapTestCase {
    ...
    public function setUp() {
        ...
        $this->artifact_xml        = new SimpleXMLElement('<?xml version="1.0" encoding="UTF-8"?>'
                ...
                . '  </changeset>'
                . '</artifact>');
        $this->visitor             = mock('Tracker_XMLUpdater_FieldChangeXMLUpdaterVisitor');
        $this->formelement_factory = mock('Tracker_FormElementFactory');
        $this->updater             = new Tracker_XMLUpdater_ChangesetXMLUpdater($this->visitor, $this->formelement_factory);
