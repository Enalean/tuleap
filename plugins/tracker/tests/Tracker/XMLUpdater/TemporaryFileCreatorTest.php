...
class Tracker_XMLUpdater_TemporaryFileCreatorTest extends TuleapTestCase {

    /** @var Tracker_XMLUpdater_TemporaryFileCreator */
    private $creator;
    ...
    public function setUp() {
        ...
        $this->creator = new Tracker_XMLUpdater_TemporaryFileCreator();
    ...
    public function itCreatesFileInATemporaryDirectoryThatIsDifferentFromOtherCreators() {
        $another_creator = new Tracker_XMLUpdater_TemporaryFileCreator();
        $this->assertNotEqual(
