...
class Tracker_XMLUpdater_FieldChange_FieldChangePermissionsOnArtifactXMLUpdaterTest extends TuleapTestCase {
    ...
    public function setUp() {
        parent::setUp();
        $this->updater          = new Tracker_XMLUpdater_FieldChange_FieldChangePermissionsOnArtifactXMLUpdater();
