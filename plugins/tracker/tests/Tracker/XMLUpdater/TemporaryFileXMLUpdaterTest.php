...
class Tracker_XMLUpdater_TemporaryFileXMLUpdaterTest extends TuleapTestCase {
    ...
    public function setUp() {
        ...
        $temporary_file_creator = mock('Tracker_XMLUpdater_TemporaryFileCreator');
        ...
        $this->updater = new Tracker_XMLUpdater_TemporaryFileXMLUpdater($temporary_file_creator);
    }
