<?php
/**
 * Copyright (c) Jtekt, 2012. All Rights Reserved.
 *
...
require_once(dirname(__FILE__).'/../include/Tracker/FormElement/Tracker_FormElement_Field_WebLink.class.php');
Mock::generatePartial(
    'Tracker_FormElement_Field_WebLink', 
    'Tracker_FormElement_Field_WebLinkTestVersion', 
...
require_once(dirname(__FILE__).'/../include/Tracker/FormElement/dao/Tracker_FormElement_Field_StringDao.class.php');
Mock::generate('Tracker_FormElement_Field_StringDao');
...
class Tracker_FormElement_Field_WeblinkTestVersion_Expose_ProtectedMethod extends Tracker_FormElement_Field_WeblinkTestVersion {
    public function buildMatchExpression($a, $b) { return parent::buildMatchExpression($a, $b); }
    public function quote($a) { return "'$a'"; }
}

class Tracker_FormElement_Field_WebLinkTest extends TuleapTestCase {
    
    function testNoDefaultValue() {
        $str_field = new Tracker_FormElement_Field_WebLinkTestVersion();
    ...
    function testGetChangesetValue() {
        $value_dao = new MockTracker_FormElement_Field_StringDao();
        ...
        $text_field = new Tracker_FormElement_Field_WebLinkTestVersion();
    ...
    function testIsValid() {
        ...
        $text = new Tracker_FormElement_Field_WebLinkTestVersion();
    ...
    function testIsValidRequiredField() {
        ...
        $f = new Tracker_FormElement_Field_WebLinkTestVersion();
    ...
    function test_buildMatchExpression() {
        $f = new Tracker_FormElement_Field_WebLinkTestVersion_Expose_ProtectedMethod();
