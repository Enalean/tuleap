...
require_once('common/tracker/Tracker_FormElement_Field_List_BindFactory.class.php');
...
require_once('common/tracker/Tracker_FormElement_Field_List_BindDecorator.class.php');
