...
require_once('common/tracker/Tracker_SemanticManager.class.php');
Mock::generate('Tracker_SemanticManager');

require_once('common/tracker/Tracker_NotificationsManager.class.php');
Mock::generate('Tracker_NotificationsManager');

require_once('common/tracker/Tracker_CannedResponseManager.class.php');
...
require_once('common/tracker/Tracker_FormElement_Field_String.class.php');
...
require_once('common/tracker/Tracker_FormElement_Interface.class.php');
