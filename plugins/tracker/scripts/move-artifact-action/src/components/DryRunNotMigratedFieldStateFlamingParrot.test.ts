...
import DryRunNotMigratedFieldStateFlamingParrot from "./DryRunNotMigratedFieldStateFlamingParrot.vue";
import FieldsListDisplayerFlamingParrot from "./FieldsListDisplayerFlamingParrot.vue";

const getWrapper = (): VueWrapper =>
    shallowMount(DryRunNotMigratedFieldStateFlamingParrot, {
        global: {
...
describe("DryRunNotMigratedFieldState", () => {
    ...
    it('should display the "move action not possible" error', async () => {
        ...
        expect(wrapper.findComponent(FieldsListDisplayerFlamingParrot).exists()).toBe(false);
    });
});
