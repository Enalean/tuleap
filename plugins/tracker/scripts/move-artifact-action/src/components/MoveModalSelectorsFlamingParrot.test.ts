...
import MoveModalSelectorsFlamingParrot from "./MoveModalSelectorsFlamingParrot.vue";
import ProjectSelectorFlamingParrot from "./ProjectSelectorFlamingParrot.vue";
import TrackerSelectorFlamingParrot from "./TrackerSelectorFlamingParrot.vue";

const getWrapper = (): VueWrapper =>
    shallowMount(MoveModalSelectorsFlamingParrot, {
        global: {
...
describe("MoveModalSelectors", () => {
    it.each([
        ...
        async (what, are_projects_loading, expected) => {
            ...
            expect(wrapper.findComponent(ProjectSelectorFlamingParrot).exists()).toBe(expected);
            expect(wrapper.findComponent(TrackerSelectorFlamingParrot).exists()).toBe(expected);
        },
    );
