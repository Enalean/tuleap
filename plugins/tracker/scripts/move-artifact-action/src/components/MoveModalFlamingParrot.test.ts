...
import MoveModalFlamingParrot from "./MoveModalFlamingParrot.vue";
...
describe("MoveModal", () => {
    const getWrapper = (): VueWrapper => {
        return shallowMount(MoveModalFlamingParrot, {
            global: {
    ...
    describe("display", () => {
        ...
        describe("Selectors", () => {
            it("should be visible when the move is not being processed", async () => {
                ...
                expect(wrapper.findComponent(MoveModalSelectorsFlamingParrot).isVisible()).toBe(
                    true,
                );
            });
