 ...
 */
export type ParentTrackerIdentifier = Identifier<"ParentTrackerIdentifier">;

export const ParentTrackerIdentifier = {
    fromId: (id: number): ParentTrackerIdentifier => ({ id, _type: "ParentTrackerIdentifier" }),
};
