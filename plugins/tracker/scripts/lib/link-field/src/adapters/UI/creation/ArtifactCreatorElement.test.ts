...
import { CreateLinkableArtifactStub } from "../../../../tests/stubs/links/CreateLinkableArtifactStub";
...
describe(`ArtifactCreatorElement`, () => {
    ...
    describe(`render`, () => {
        ...
        it.each([[true, false]])(
            `will set the form element class when error is %s`,
            (has_error) => {
                const host = { has_tracker_selection_error: has_error } as HostElement;
