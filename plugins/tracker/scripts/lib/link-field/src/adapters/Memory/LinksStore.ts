...
import type { AddLinkedArtifactCollection } from "../../domain/links/AddLinkedArtifactCollection";
import type { RetrieveLinkedArtifactsSync } from "../../domain/links/RetrieveLinkedArtifactsSync";
import { LinkedArtifact } from "../../domain/links/LinkedArtifact";
import type { ChangeLinkType } from "../../domain/links/ChangeLinkType";

export type LinksStore = AddLinkedArtifactCollection & RetrieveLinkedArtifactsSync & ChangeLinkType;

export const LinksStore = (): LinksStore => {
