...
import type { AddLinkMarkedForRemoval } from "../../domain/links/AddLinkMarkedForRemoval";
import type { DeleteLinkMarkedForRemoval } from "../../domain/links/DeleteLinkMarkedForRemoval";
...
export type LinksMarkedForRemovalStore = AddLinkMarkedForRemoval &
    VerifyLinkIsMarkedForRemoval &
    DeleteLinkMarkedForRemoval;

export const LinksMarkedForRemovalStore = (): LinksMarkedForRemovalStore => {
