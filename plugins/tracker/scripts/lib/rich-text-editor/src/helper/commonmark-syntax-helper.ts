...
export function getCommonMarkSyntaxPopoverHelperContent(gettext_provider: GettextProvider): string {
    return `
        <section>
            <div class="tlp-popover-header">
                <h1 class="tlp-popover-title helper-popover-title">${gettext_provider.gettext(
