...
import type { BurningParrotDocumentAdapter } from "../BurningParrotDocumentAdapter";
import type { EditorAreaRenderer } from "./EditorAreaRenderer";
import { EditorAreaState } from "./EditorAreaState";

export class BurningParrotEditorAreaBuilder implements FormatSelectorInterface {
    constructor(
        private readonly doc: BurningParrotDocumentAdapter,
