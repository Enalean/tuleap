...
export type DidChangeAllowedValues = DomainEvent<"DidChangeAllowedValues"> & {
    readonly field_id: number;
    readonly allowed_bind_value_ids: ReadonlyArray<BindValueId>;
};
...
export const DidChangeAllowedValues = (
    ...
    field_id,
    allowed_bind_value_ids: allowed_values,
});
