...
describe("StaticOpenListFieldPresenter", () => {
    ...
    const getField = (): UserGroupOpenListFieldType =>
        ({
            field_id: 1001,
            label: "CC",
            name: "cc",
    ...
    it("Given an open list field bound to user groups and the list of selected groups, then it should build a presenter", () => {
