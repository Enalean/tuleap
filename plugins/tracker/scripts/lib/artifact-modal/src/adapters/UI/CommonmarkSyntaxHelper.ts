...
export const renderCommonmarkSyntaxHelper = (
    host: CommonmarkSyntaxHelper,
): UpdateFunction<CommonmarkSyntaxHelper> => html`
    <button
        type="button"
...
export const CommonmarkSyntaxHelper = define<CommonmarkSyntaxHelper>({
    ...
    button: (host: CommonmarkSyntaxHelper): HTMLButtonElement | null => {
        const button = host.render().querySelector("[data-popover-button]");
        if (!(button instanceof HTMLButtonElement)) {
            return null;
        }
        return button;
    },
    section: (host: CommonmarkSyntaxHelper): HTMLElement | null => {
        const section = host.render().querySelector("[data-popover-content]");
    ...
    render: renderCommonmarkSyntaxHelper,
});
