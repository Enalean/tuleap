...
let entry_points = {
    ...
    print: "./default/css/print.scss",
    "burndown-chart": "./burndown-chart.scss",
    colorpicker: "./FlamingParrot/css/colorpicker.scss"
};

const colors_burning_parrot = ["orange", "blue", "green", "red", "grey", "purple"];
for (const color of colors_burning_parrot) {
    entry_points[`tracker-bp-${color}`] = `./BurningParrot/css/style-${color}.scss`;
    entry_points[
        `tracker-bp-${color}-condensed`
    ] = `./BurningParrot/css/style-${color}-condensed.scss`;
    entry_points[`workflow-${color}`] = `./BurningParrot/css/workflow-${color}.scss`;
    entry_points[
...
module.exports = [
    {
        ...
        output: webpack_configurator.configureOutput(
            path.resolve(__dirname, "../../../src/www/assets/tracker/themes")
        ),
        module: {
