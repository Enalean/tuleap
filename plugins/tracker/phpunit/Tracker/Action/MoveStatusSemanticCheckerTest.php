...
class MoveStatusSemanticCheckerTest extends TestCase
{
    ...
    public function testItReturnsTrueIfBothSemanticsFieldsHaveTheSameType()
    {
        ...
        $this->assertTrue($this->checker->doesBothTrackerStatusFieldHaveTheSameType($this->source_tracker, $this->target_tracker));
    }
    ...
    public function testItReturnsFalseIfBothSemanticsFieldsDoesNotHaveTheSameType()
    {
        ...
        $this->assertFalse($this->checker->doesBothTrackerStatusFieldHaveTheSameType($this->source_tracker, $this->target_tracker));
    }
}
