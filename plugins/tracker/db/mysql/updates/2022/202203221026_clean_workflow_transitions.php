...
final class b202203221026_clean_workflow_transitions extends \Tuleap\ForgeUpgrade\Bucket
{
    public function description(): string
    {
        return 'Clean Workflow transitions when from or to are bound to unknown values';
    }
