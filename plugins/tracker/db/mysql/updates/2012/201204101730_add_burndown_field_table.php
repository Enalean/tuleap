 ...
 *
 */
class b201204101730_add_burndown_field_table extends ForgeUpgrade_Bucket {

    public function description() {
        return <<<EOT
Add table for burndown field .
EOT;
    }
    ...
    public function up() {
        $sql = "CREATE TABLE tracker_field_burndown(
               ...
               ";
        $msg = "adding table tracker_field_burndown";
