...
use Tuleap\CrossTracker\Query\Advanced\QueryBuilder\Field\FieldFromWhereBuilder;
use Tuleap\CrossTracker\Query\Advanced\QueryBuilder\FromWhereSearchableVisitor;
use Tuleap\CrossTracker\Query\Advanced\QueryBuilder\FromWhereSearchableVisitorParameters;
use Tuleap\CrossTracker\Query\Advanced\QueryBuilder\Metadata\MetadataFromWhereBuilder;
...
final readonly class QueryBuilderVisitor implements LogicalVisitor, TermVisitor
{
    public function __construct(
        ...
        private FieldFromWhereBuilder $field_from_where_builder,
        private MetadataFromWhereBuilder $metadata_from_where_builder,
    ) {
    }
