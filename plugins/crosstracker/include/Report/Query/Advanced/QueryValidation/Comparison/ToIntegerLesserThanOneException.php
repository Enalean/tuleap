...
final class ToIntegerLesserThanOneException extends InvalidQueryException
{
    public function __construct(Metadata $metadata)
    {
        $message = sprintf(
            dgettext('tuleap-crosstracker', '%s cannot be compared to an integer lesser than one.'),
            $metadata->getName(),
        );
