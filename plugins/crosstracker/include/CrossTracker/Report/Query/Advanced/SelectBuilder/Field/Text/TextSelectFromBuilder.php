...
namespace Tuleap\CrossTracker\Report\Query\Advanced\SelectBuilder\Field\Text;
...
final class TextSelectFromBuilder
{
    public function getSelectFrom(DuckTypedFieldSelect $field): IProvideParametrizedSelectAndFromSQLFragments
    {
        ...
        $select              = "$changeset_value_text_alias.value AS $suffix";
        $from                = <<<EOSQL
