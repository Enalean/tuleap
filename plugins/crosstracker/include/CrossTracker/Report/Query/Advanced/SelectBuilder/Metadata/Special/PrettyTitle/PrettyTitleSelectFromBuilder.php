...
namespace Tuleap\CrossTracker\Report\Query\Advanced\SelectBuilder\Metadata\Special\PrettyTitle;
...
final class PrettyTitleSelectFromBuilder
{
    ...
    {
        $select = "tracker.name AS '@pretty_title.tracker', tracker.color AS '@pretty_title.color', pretty_title.value AS '@pretty_title', pretty_title.body_format AS '@pretty_title.format'";
        $from   = <<<EOSQL
