...
final class TextDuckTypedFieldTest extends TestIntegrationTestCase
{
    ...
    public function testNotEqualValue(): void
    {
        ...
        self::assertCount(4, $artifacts);
        self::assertEqualsCanonicalizing(
            [$this->release_artifact_empty_id, $this->release_artifact_with_string_id_2, $this->release_artifact_with_string_like_id, $this->sprint_artifact_empty_id],
            $artifacts
        );
    }
