...
final class LastUpdateBySelectBuilderTest extends CrossTrackerFieldTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->expected_results = [
            $release_artifact_id => (int) $alice->getId(),
            $sprint_artifact_id  => (int) $bob->getId(),
        ];
    ...
    {
        $fragments = $this->builder->buildSelectFrom([new Metadata('last_update_by')], $this->trackers, $this->user);
        ...
        foreach ($results as $result) {
            ...
            self::assertArrayHasKey('@last_update_by', $result);
            $values[$result['id']] = $result['@last_update_by'];
        }
