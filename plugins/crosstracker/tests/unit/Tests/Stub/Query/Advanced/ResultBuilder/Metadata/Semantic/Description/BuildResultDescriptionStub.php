...
namespace Tuleap\CrossTracker\Tests\Stub\Query\Advanced\ResultBuilder\Metadata\Semantic\Description;
...
final class BuildResultDescriptionStub implements BuildResultDescription
{
    ...
    public static function withDefaultValues(): self
    {
        return new self(new SelectedValuesCollection(
            ...
            [
                21 => new SelectedValue('@description', new TextResultRepresentation('My description')),
            ]
        ));
    }
