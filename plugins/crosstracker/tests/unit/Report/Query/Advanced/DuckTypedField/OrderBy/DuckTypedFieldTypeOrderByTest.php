...
final class DuckTypedFieldTypeOrderByTest extends TestCase
{
    public function testIntBecomesNumeric(): void
    {
        $result = DuckTypedFieldTypeOrderBy::fromString(Tracker_FormElementFactory::FIELD_INTEGER_TYPE);
        self::assertSame(DuckTypedFieldTypeOrderBy::NUMERIC, $result->unwrapOr(null));
    }

    public function testFloatBecomesNumeric(): void
    {
        $result = DuckTypedFieldTypeOrderBy::fromString(Tracker_FormElementFactory::FIELD_FLOAT_TYPE);
        self::assertSame(DuckTypedFieldTypeOrderBy::NUMERIC, $result->unwrapOr(null));
    }

    public function testStringBecomesText(): void
    {
        $result = DuckTypedFieldTypeOrderBy::fromString(Tracker_FormElementFactory::FIELD_STRING_TYPE);
        self::assertSame(DuckTypedFieldTypeOrderBy::TEXT, $result->unwrapOr(null));
    }

    public function testTextBecomesText(): void
    {
        $result = DuckTypedFieldTypeOrderBy::fromString(Tracker_FormElementFactory::FIELD_TEXT_TYPE);
        self::assertSame(DuckTypedFieldTypeOrderBy::TEXT, $result->unwrapOr(null));
    }

    public function testDateBecomesDate(): void
    {
        $result = DuckTypedFieldTypeOrderBy::fromString(Tracker_FormElementFactory::FIELD_DATE_TYPE);
        self::assertSame(DuckTypedFieldTypeOrderBy::DATE, $result->unwrapOr(null));
    }

    public function testDatetimeBecomesDatetime(): void
    {
        $result = DuckTypedFieldTypeOrderBy::fromString(FieldTypeRetrieverWrapper::FIELD_DATETIME_TYPE);
        self::assertSame(DuckTypedFieldTypeOrderBy::DATETIME, $result->unwrapOr(null));
    }

    public function testStaticListBecomesStaticList(): void
    {
        $result = DuckTypedFieldTypeOrderBy::fromString(FieldTypeRetrieverWrapper::FIELD_STATIC_LIST_TYPE);
        self::assertSame(DuckTypedFieldTypeOrderBy::STATIC_LIST, $result->unwrapOr(null));
    }

    public function testUGroupListBecomesUGroupList(): void
    {
        $result = DuckTypedFieldTypeOrderBy::fromString(FieldTypeRetrieverWrapper::FIELD_UGROUP_LIST_TYPE);
    ...
    {
        $result = DuckTypedFieldTypeOrderBy::fromString($type_name);
