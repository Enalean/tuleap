...
{
    public function testItReturnsEmptyHasNothingHasBeenImplemented(): void
    {
        $builder = new InvalidFromCollectionBuilder();
        $result  = $builder->buildCollectionOfInvalidFrom(new From(new FromProject('@project', new FromProjectEqual('self')), null));
