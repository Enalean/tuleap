 ...
 * 
 *
 * SvnToDimensionsPluginInfo
 */
require_once('common/plugin/PluginInfo.class.php');
require_once('common/include/PropertyDescriptor.class.php');
require_once('SvnToDimensionsPluginDescriptor.class.php');

class SvnToDimensionsPluginInfo extends PluginInfo {
    
    function SvnToDimensionsPluginInfo(&$plugin) {
        $this->PluginInfo($plugin);
        $this->setPluginDescriptor(new SvnToDimensionsPluginDescriptor());
        $this->_conf_path = $plugin->getPluginEtcRoot() .'/svntodmensions.inc';
        $this->loadProperties();
    }
