...
function autoload64f6cd5a1c40acd19a21864401d00276($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'testing_requirement_requirementversion' => '/Requirement/RequirementVersion.class.php',
            'testing_requirement_requirementversioninfopresenter' => '/Requirement/RequirementInfoPresenter.class.php',
            'testing_requirement_requirementversionpresenter' => '/Requirement/RequirementPresenter.class.php',
            'testing_requirement_testcaseassociationdao' => '/Requirement/TestCaseAssociationDao.class.php',
            'testing_requirement_testcaseversionpresenter' => '/Requirement/TestCaseVersionPresenter.class.php',
...
spl_autoload_register('autoload64f6cd5a1c40acd19a21864401d00276');
