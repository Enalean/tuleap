...
class Testing_Requirement_RequirementVersionInfoPresenter {

    public function __construct(Project $project, Testing_Requirement_RequirementVersion $requirement_version) {
