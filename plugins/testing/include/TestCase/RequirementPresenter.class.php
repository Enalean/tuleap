...
class Testing_TestCase_RequirementPresenter {
    ...
    public function __construct(
        ...
        $this->unlink_uri = '/plugins/testing/?group_id='. $project->getId() .'&resource=testcase&action=unlink-requirement&id='. $testcase->getId() .'&requirement_id='. $this->id;
    }
}
