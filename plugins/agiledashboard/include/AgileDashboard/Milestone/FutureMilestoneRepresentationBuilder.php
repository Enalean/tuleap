...
class FutureMilestoneRepresentationBuilder implements MilestoneRepresentationBuilderInterface
{
    ...
    public function getPaginatedTopMilestonesRepresentations(
        ...
        foreach ($sub_milestones->getMilestones() as $milestone) {
            $milestones_representations[] = $this->representationBuilder->getMilestoneRepresentation($milestone, $user, $representation_type);
        }
