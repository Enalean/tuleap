 ...
 */
class AgileDashboard_Milestone_Pane_TopContent_Pane extends AgileDashboard_Pane {
    ...
    public function __construct(AgileDashboard_Milestone_Pane_TopContent_PaneInfo $info,  $presenter) {
        $this->info      = $info;
