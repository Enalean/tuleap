 ...
 *
 */
class AgileDashboard_Milestone_Pane_TopPlanning_Pane extends AgileDashboard_Pane {

    /** @var AgileDashboard_Milestone_Pane_TopPlanning_PaneInfo */
    private $info;

    /** @var AgileDashboard_Milestone_Pane_TopPlanning_Presenter */
    private $presenter;

    public function __construct(AgileDashboard_Milestone_Pane_TopPlanning_PaneInfo $info, AgileDashboard_Milestone_Pane_TopPlanning_Presenter $presenter) {
        $this->info      = $info;
    ...
    private function getPaneContent() {
        ...
        return $renderer->renderToString('pane-topplanning', $this->presenter);
    }
}
