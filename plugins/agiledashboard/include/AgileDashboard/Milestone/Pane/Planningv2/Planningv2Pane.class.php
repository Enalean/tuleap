 ...
 *
 */
class AgileDashboard_Milestone_Pane_Planningv2_Planningv2Pane extends AgileDashboard_Pane {
    ...
    public function __construct(
        AgileDashboard_Milestone_Pane_Planningv2_Planningv2PaneInfo $info,
        AgileDashboard_Milestone_Pane_Planningv2_Planningv2Presenter $presenter
    ) {
        $this->info      = $info;
    ...
    private function getPaneContent() {
        ...
        return $renderer->renderToString('pane-planningv2', $this->presenter);
    }
}
