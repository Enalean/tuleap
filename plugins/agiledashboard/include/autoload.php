...
function autoload3ce500e40714649f971081fe8f529e8a($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'milestonecontentupdater' => '/AgileDashboard/REST/MilestoneContentUpdater.class.php',
...
spl_autoload_register('autoload3ce500e40714649f971081fe8f529e8a');
