...
function autoload7e19fe1385b59f847e809fa5f0534318($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\agiledashboard\\widget\\widgetaddtodashboarddropdownbuilder' => '/AgileDashboard/Widget/WidgetAddToDashboardDropdownBuilder.php',
            'tuleap\\agiledashboard\\widget\\widgetaddtodashboarddropdownpresenter' => '/AgileDashboard/Widget/WidgetAddToDashboardDropdownPresenter.php'
        );
    }
    $cn = strtolower($class);
    if (isset($classes[$cn])) {
...
spl_autoload_register('autoload7e19fe1385b59f847e809fa5f0534318');
