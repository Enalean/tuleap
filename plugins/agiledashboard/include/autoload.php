...
function autoload6d97c3e122ab84779832b5aa4470a1e9($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'agiledashboard_milestoneplanningpane' => '/AgileDashboard/MilestonePlanningPane.class.php',
            'agiledashboard_milestoneplanningpaneinfo' => '/AgileDashboard/MilestonePlanningPane.class.php',
            'agiledashboard_milestoneplanningpresenter' => '/Planning/MilestonePresenter.class.php',
            'agiledashboard_milestonepresenter' => '/Planning/MilestonePresenter.class.php',
            'agiledashboard_pane' => '/AgileDashboard/Pane.class.php',
            'agiledashboard_paneinfo' => '/AgileDashboard/Pane.class.php',
...
spl_autoload_register('autoload6d97c3e122ab84779832b5aa4470a1e9');
