...
function autoload71812aa1678cb12e33b00d1cb2443be3($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'kanban_semanticstatus_not_defined' => '/AgileDashboard/KanbanSemanticStatusNotDefined.php',
...
spl_autoload_register('autoload71812aa1678cb12e33b00d1cb2443be3');
