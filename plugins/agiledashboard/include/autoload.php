...
function autoload89329661909cf53f69a56d8a87e61ef3($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\agiledashboard\\rest\\v1\\kanban\\trackerreport\\trackerreportdao' => '/AgileDashboard/REST/v1/Kanban/TrackerReport/TrackerReportDao.php',
            'tuleap\\agiledashboard\\rest\\v1\\kanban\\trackerreport\\trackerreportupdater' => '/AgileDashboard/REST/v1/Kanban/TrackerReport/TrackerReportUpdater.php',
...
spl_autoload_register('autoload89329661909cf53f69a56d8a87e61ef3');
