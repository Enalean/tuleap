...
function autoload4e516f76f833dc551ae56cc749ec1f13($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'agiledashboard_milestone_pane_topcontent_pane' => '/AgileDashboard/Milestone/Pane/TopContent/Pane.class.php',
            'agiledashboard_milestone_pane_topcontent_paneinfo' => '/AgileDashboard/Milestone/Pane/TopContent/PaneInfo.class.php',
            'agiledashboard_milestone_pane_topcontent_presenter' => '/AgileDashboard/Milestone/Pane/TopContent/Presenter.class.php',
            'agiledashboard_milestone_pane_topcontent_presenterbuilder' => '/AgileDashboard/Milestone/Pane/TopContent/PresenterBuilder.class.php',
            'agiledashboard_milestone_pane_topplanning_pane' => '/AgileDashboard/Milestone/Pane/TopPlanning/Pane.class.php',
            'agiledashboard_milestone_pane_topplanning_paneinfo' => '/AgileDashboard/Milestone/Pane/TopPlanning/PaneInfo.class.php',
            'agiledashboard_milestone_pane_topplanning_presenter' => '/AgileDashboard/Milestone/Pane/TopPlanning/Presenter.class.php',
            'agiledashboard_milestone_pane_topplanning_presenterbuilder' => '/AgileDashboard/Milestone/Pane/TopPlanning/PresenterBuilder.class.php',
            'agiledashboard_milestone_pane_topplanning_submilestonefinder' => '/AgileDashboard/Milestone/Pane/TopPlanning/SubmilestoneFinder.class.php',
            'agiledashboard_milestone_pane_topplanning_submilestonepresenter' => '/AgileDashboard/Milestone/Pane/TopPlanning/SubMilestonePresenter.class.php',
            'agiledashboard_milestone_pane_topplanning_submilestonepresentercollection' => '/AgileDashboard/Milestone/Pane/TopPlanning/SubMilestonePresenterCollection.class.php',
            ...
            'planning_topmilestone' => '/Planning/TopMilestone.class.php',
            'planning_trackerpresenter' => '/Planning/TrackerPresenter.class.php',
            'planning_viewbuilder' => '/Planning/ViewBuilder.class.php',
            'planning_viewbuilderfactory' => '/Planning/ViewBuilderFactory.class.php',
...
spl_autoload_register('autoload4e516f76f833dc551ae56cc749ec1f13');
