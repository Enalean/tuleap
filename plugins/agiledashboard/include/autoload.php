...
function autoloadcb813bcce522213c02b85a15d2cce7f6($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            'agiledashboard_backlogitem' => '/AgileDashboard/BacklogItemFactory.class.php',
            'agiledashboard_backlogitemdao' => '/AgileDashboard/BacklogItemDao.class.php',
            'agiledashboard_backlogitemfactory' => '/AgileDashboard/BacklogItemFactory.class.php',
...
spl_autoload_register('autoloadcb813bcce522213c02b85a15d2cce7f6');
