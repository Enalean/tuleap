...
function autoloadedb7af9c4e5af95250c98e14fc157ac2($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'planning_milestonedao' => '/Planning/MilestoneDao.class.php',
...
spl_autoload_register('autoloadedb7af9c4e5af95250c98e14fc157ac2');
