...
function autoload0da07db28d290c0e109fb98ed77fb9b2($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'agiledashboard_milestone_pane_planning_pane' => '/AgileDashboard/Milestone/Pane/Planning/Pane.class.php',
            'agiledashboard_milestone_pane_planning_paneinfo' => '/AgileDashboard/Milestone/Pane/Planning/PaneInfo.class.php',
            'agiledashboard_milestone_pane_planning_presenter' => '/AgileDashboard/Milestone/Pane/Planning/Presenter.class.php',
            'agiledashboard_milestone_pane_planning_submilestonepresenter' => '/AgileDashboard/Milestone/Pane/Planning/SubMilestonePresenter.class.php',
            'agiledashboard_milestone_pane_planning_submilestonepresentercollection' => '/AgileDashboard/Milestone/Pane/Planning/SubMilestonePresenterCollection.class.php',
...
spl_autoload_register('autoload0da07db28d290c0e109fb98ed77fb9b2');
