...
function autoloadafc700fbd749e7e4e519b6b0cacc37d8($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'agiledashboard_xmlencoder' => '/AgileDashboard/XMLEncoder.class.php',
...
spl_autoload_register('autoloadafc700fbd749e7e4e519b6b0cacc37d8');
