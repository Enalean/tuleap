...
class AgileDashboard_PaneRedirectionExtractor //phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace, Squiz.Classes.ValidClassName.NotPascalCase
{
     ...
     * @return array || null
     */
    public function getRedirectToParameters(\Tuleap\HTTPRequest $request, Project $project)
    {
     ...
     */
    public function extractParametersFromRequest(\Tuleap\HTTPRequest $request)
    {
