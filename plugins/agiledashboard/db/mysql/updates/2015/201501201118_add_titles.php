...
EOT;
    ...
    public function up()
    {
        ...
        if ($res === false) {
            throw new \Tuleap\ForgeUpgrade\Bucket\BucketUpgradeNotCompleteException('An error occured while adding titles in table plugin_agiledashboard_configuration: ' . implode(', ', $this->db->dbh->errorInfo()));
        }
    }
}
