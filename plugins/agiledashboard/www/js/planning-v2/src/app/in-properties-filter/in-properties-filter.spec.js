            ...
            var items = [
                {
                    ...
                    label: null,
                    card_fields: [
                        { type: 'string', value: 'Histoire de Toto' }
                    ]
                }
            ];
            ...
            var items = [
                {
                    ...
                    label: null,
                    card_fields: [
                        { type: 'cross', value: [{ ref: 'release #46' }]}
                    ]
                }
            ];
                ...
                var items = [
                    {
                        ...
                        label: null,
                        card_fields: [
                            { type: 'shared', values: [{ label: 'Reopen' }]}
                        ]
                    }
                ];
