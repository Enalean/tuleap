describe("BacklogController - ", function() {
    ...
    describe("displayBacklogItems() -", function() {
        ...
        beforeEach(function() {
            ...
            spyOn(BacklogController, "fetchBacklogItems").and.returnValue(fetch_backlog_items_request.promise);
    ...
    describe("moveToTop() -", function() {
        ...
        it("move one item to the top of the backlog", function() {
            ...
            expect(BacklogController.reorderBacklogItems).toHaveBeenCalledWith([moved_backlog_item], {direction: "before", item_id: 50});
        });
        ...
        it("move multiple items to the top of the backlog", function() {
            ...
            expect(BacklogItemSelectedService.areThereMultipleSelectedBaklogItems).toHaveBeenCalled();
            expect(DroppedService.defineComparedToBeFirstItem).toHaveBeenCalled();
            expect(BacklogController.reorderBacklogItems).toHaveBeenCalledWith(selected_backlog_items, {direction: "before", item_id: 61});
        });
    ...
    describe("moveToBottom() -", function() {
        ...
        it("move one item to the bottom of the fully loaded backlog", function() {
            ...
            expect(BacklogController.reorderBacklogItems).toHaveBeenCalledWith([moved_backlog_item], {direction: "after", item_id: 88});
        });
        ...
        it("move multiple items to the bottom of the fully loaded backlog, even if the backlog is filtered", function() {
            ...
            expect(BacklogItemSelectedService.areThereMultipleSelectedBaklogItems).toHaveBeenCalled();
            expect(DroppedService.defineComparedToBeLastItem).toHaveBeenCalled();
            expect(BacklogController.reorderBacklogItems).toHaveBeenCalledWith(selected_backlog_items, {direction: "after", item_id: 88});
        });
