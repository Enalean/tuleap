describe("ModalValidateFactory validateArtifactFieldsValues() -", function() {
    ...
    describe("Given the modal was opened in creation mode", function() {
        ...
        it("and given an array containing date, int and fload fields with null values, when I validate the fields data, then an object containing all the fields' values as empty strings will be returned", function() {
            var input = [
                {
                    field_id: 54,
                    type: "int",
