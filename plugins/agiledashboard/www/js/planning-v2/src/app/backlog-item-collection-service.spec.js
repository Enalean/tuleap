describe("BacklogItemCollectionService -", function() {
    ...
    describe("refreshBacklogItem() -", function() {
        ...
        it("Given a backlog item's id and given that this item existed in the item collection, when I refresh it, then a promise will be resolved and the item will be fetched from the server and updated in the item collection", function() {
            var initial_item = {
                id: 7088,
                card_fields: [],
                has_children  : false,
