    ...
    return {
        ...
        link: function (scope, element) {
            ...
            function getSizesElement() {
                return {
                    width : angular.element('.chart')[0].clientWidth - CUMULATIVE_CHART_LEGEND_MARGIN_WIDTH - margin.left - margin.right,
                    height: angular.element('.chart')[0].clientHeight - CUMULATIVE_CHART_LEGEND_MARGIN_HEIGHT - margin.top - margin.bottom
                };
            }
        }
    };
