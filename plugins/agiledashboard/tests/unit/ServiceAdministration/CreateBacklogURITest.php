...
final class CreateBacklogURITest extends TestCase
{
    private const PROJECT_ID = 198;
    ...
    public function testItBuildsURIWithFlagToIndicateRedirectionToProjectBacklog(): void
    {
        self::assertStringContainsString(
            ...
            (string) CreateBacklogURI::withRedirectionToProjectBacklog($this->project, $this->csrf_token)
        );
    }
}
