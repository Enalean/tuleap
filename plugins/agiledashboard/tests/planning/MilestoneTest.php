...
class MilestoneTest extends TuleapTestCase {
    ...
    public function itMayHaveAssignedArtifacts() {
        $this->assertEqual($this->milestone->getAssignedArtifacts(), null);
        ...
        $this->assertEqual($this->milestone->getAssignedArtifacts(), $assigned_artifacts);
    }
