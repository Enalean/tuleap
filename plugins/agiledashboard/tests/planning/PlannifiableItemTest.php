...
class Planning_PlannifiableItemTest extends TuleapTestCase {
    ...
    public function setUp() {
        ...
        $artifact = aMockArtifact()->withUri($this->edit_uri)
                                   ->withXRef($this->xref)
                                   ->withTitle($this->title)
                                   ->withId($this->id)
                                   ->build();
        
        $this->item = new Planning_PlannifiableItem($artifact);
    }
