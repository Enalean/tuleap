    ...
    public function searchContent(PlannedProgramIncrement $program_increment): array
    {
        $sql = '
                ...
                FROM
                    ...
                    INNER JOIN plugin_scaled_agile_plan      AS plan              ON feature_artifact.tracker_id = plan.plannable_tracker_id
                    ...
                    LEFT JOIN plugin_scaled_agile_explicit_top_backlog
                              ON (plugin_scaled_agile_explicit_top_backlog.artifact_id = program_increment.id)
                WHERE program_increment.id =  ?
                  AND plugin_scaled_agile_explicit_top_backlog.artifact_id IS NULL';
