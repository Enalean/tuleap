        ...
        $sql = '
                SELECT tracker.item_name AS tracker_name, artifact.id AS artifact_id, title_value.value AS artifact_title, title.field_id AS field_title_id
                    FROM `groups` AS project
                        ...
                        INNER JOIN plugin_scaled_agile_plan AS plan
                        ...
                        INNER JOIN plugin_scaled_agile_explicit_top_backlog ON (plugin_scaled_agile_explicit_top_backlog.artifact_id = artifact.id)
