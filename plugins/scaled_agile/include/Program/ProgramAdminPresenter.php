...
use ForgeConfig;
use Project;
use Tuleap\ScaledAgile\Program\PlannableItems\Presenter\PlannableItemsPerTeamPresenterCollection;
...
class ProgramAdminPresenter
{
    ...
    /**
     * @var PlannableItems\Presenter\PlannableItemsPerTeamPresenter[]
     */
