...
final class MirrorMilestoneFieldsData
{
    ...
    private function __construct(
        ...
        $this->program_milestone_id   = $program_milestone_id;
    ...
    {
        return [
            'new_values' => (string) $this->program_milestone_id,
            'natures'    => [(string) $this->program_milestone_id => MirroredMilestoneArtifactLinkType::ART_LINK_SHORT_NAME]
        ];
    }
