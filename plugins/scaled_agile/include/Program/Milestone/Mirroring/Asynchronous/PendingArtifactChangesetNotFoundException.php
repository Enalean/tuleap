...
final class PendingArtifactChangesetNotFoundException extends \RuntimeException implements MilestoneMirroringException
{
    public function __construct(int $artifact_id, int $changeset_id)
    {
        parent::__construct("Could not find changeset #$changeset_id of artifact #$artifact_id ");
    }
}
