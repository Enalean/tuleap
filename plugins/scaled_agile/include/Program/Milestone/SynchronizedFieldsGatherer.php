...
class SynchronizedFieldsGatherer
{
     ...
     */
    public function gather(\Tracker $team_milestone_tracker): SynchronizedFields
    {
        return new SynchronizedFields(
            $this->getArtifactLinkField($team_milestone_tracker),
            $this->getTitleField($team_milestone_tracker),
            $this->getDescriptionField($team_milestone_tracker),
            $this->getStatusField($team_milestone_tracker),
            $this->getTimeFrameFields($team_milestone_tracker)
        );
    }
