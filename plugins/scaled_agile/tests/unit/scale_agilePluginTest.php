...
final class scale_agilePluginTest extends TestCase
{
    public function testProvidesArtLinkTypes(): void
    {
        ...
        self::assertEquals([new MirroredMilestoneArtifactLinkType()], $natures);
    }
    ...
    public function testProvidesNaturePresenterWhenTheTypeIsExposedByThePlugin(): void
    {
        $plugin    = new scaled_agilePlugin(1);
        $presenter = null;
        $params    = ['shortname' => MirroredMilestoneArtifactLinkType::ART_LINK_SHORT_NAME, 'presenter' => &$presenter];
        $plugin->getNaturePresenter($params);

        self::assertEquals(new MirroredMilestoneArtifactLinkType(), $presenter);
    }
    ...
    public function testExposesSystemArtifactLinkType(): void
    {
        ...
        self::assertEquals([MirroredMilestoneArtifactLinkType::ART_LINK_SHORT_NAME], $natures);
    }
}
