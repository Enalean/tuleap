...
use Tuleap\ScaledAgile\Program\Milestone\Mirroring\Status\StatusValueMapper;
...
final class MirrorMilestonesCreatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testItCreatesMirrorMilestones(): void
    {
        ...
        $trackers                   = new TeamMilestoneTrackerCollection([$first_tracker, $second_tracker]);
    ...
    public function testItThrowsWhenThereIsAnErrorDuringCreation(): void
    {
        ...
        $trackers              = new TeamMilestoneTrackerCollection([$tracker]);
        $current_user          = UserTestBuilder::aUser()->build();
    ...
    private function buildCopiedValues(): CopiedValues
    {
        ...
        $title_changeset_value = new \Tracker_Artifact_ChangesetValue_String(10000, M::mock(\Tracker_Artifact_Changeset::class), $title_field, true, 'Program Release', 'text');
