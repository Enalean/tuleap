...
namespace Tuleap\ScaledAgile\Program\MirroredArtifactLink;
...
final class MirroredMilestoneArtifactLinkTypeTest extends TestCase
{
    ...
    {
        $art_link_type = new MirroredMilestoneArtifactLinkType();

        self::assertEquals(MirroredMilestoneArtifactLinkType::ART_LINK_SHORT_NAME, $art_link_type->shortname);
