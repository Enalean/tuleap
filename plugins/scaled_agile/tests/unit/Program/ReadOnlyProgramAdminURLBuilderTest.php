...
class ReadOnlyProgramAdminURLBuilderTest extends TestCase
{
    ...
    {
        $this->program_dao->shouldReceive('isProjectAnProgramProject')->once()->with(102)->andReturnTrue();
    ...
    {
        $this->program_dao->shouldReceive('isProjectAnProgramProject')->once()->with(102)->andReturnFalse();
