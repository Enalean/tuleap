...
final class ProjectIncrementsTrackerCollectionTest extends TestCase
{
    ...
    {
        $collection = new ProjectIncrementsTrackerCollection([]);
    ...
    {
        $collection = new ProjectIncrementsTrackerCollection([]);
        $this->assertEmpty($collection->getProjectIncrementTrackers());
    }
