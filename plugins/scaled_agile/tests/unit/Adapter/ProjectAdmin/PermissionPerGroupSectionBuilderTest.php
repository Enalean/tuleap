...
namespace Tuleap\ScaledAgile\Adapter\ProjectAdmin;

use Mockery\Adapter\Phpunit\MockeryPHPUnitIntegration;
use PHPUnit\Framework\TestCase;
use Tuleap\Project\Admin\PermissionsPerGroup\PermissionPerGroupPaneCollector;
use Tuleap\Project\Admin\PermissionsPerGroup\PermissionPerGroupUGroupFormatter;
use Tuleap\ScaledAgile\Adapter\Program\Plan\CanPrioritizeFeaturesDAO;
use Tuleap\ScaledAgile\ScaledAgileService;
use UGroupManager;

final class PermissionPerGroupSectionBuilderTest extends TestCase
{
    ...
    public function testDisplayPermissionsWhenNoUGroupIsSelected(): void
    {
        ...
        $project->shouldReceive('getService')->andReturn(new ScaledAgileService($project, ['rank' => 100]));
