...
use Tuleap\Timetracking\REST\v1\ProjectTimetrackingRepresentationsBuilder;
use Tuleap\Tracker\REST\CompleteTrackerRepresentation;
use Tuleap\Tracker\Tracker;

#[\PHPUnit\Framework\Attributes\DisableReturnValueGenerationForTestDoubles]
final class ProjectTimetrackingRepresentationsBuilderTest extends \Tuleap\Test\PHPUnit\TestCase
{
    /**
    ...
    private ProjectTimetrackingRepresentationsBuilder $project_timetracking_representations_builder;
    /**
    ...
    public function setUp(): void
    {
        ...
        $this->project_timetracking_representations_builder = new ProjectTimetrackingRepresentationsBuilder(
            $this->admin_dao,
    ...
    public function testGetTrackersMinimalRepresentationWithTimetracking(): void
    {
        ...
        $result = $this->project_timetracking_representations_builder->getTrackersMinimalRepresentationsWithTimetracking(
            $this->user,
            $this->project,
            10,
            0
    ...
    public function testGetTrackersFullRepresentationWithTimetracking(): void
    {
        ...
        $this->tracker->method('userCanView')->with($this->user)->willReturn(true);
        $result = $this->project_timetracking_representations_builder->getTrackersFullRepresentationsWithTimetracking(
            $this->user,
            $this->project,
            10,
            0
