...
final class ManagerCanSeeTimesInTrackerVerifierTest extends VerifierChainTestBase
{
    public function testTrueIfTrackerAdmin(): void
    {
        ...
        $verifier = new ManagerCanSeeTimesInTrackerVerifier(VerifyUserCanSeeAllTimesInTrackerStub::withAllowed());
    ...
    public function testDelegatesToNextInChainIfNotTrackerAdmin(): void
    {
        $artifact = ArtifactTestBuilder::anArtifact(101)->build();
        ...
        $this->assertNextInChainDelegation(
            static fn () => new ManagerCanSeeTimesInTrackerVerifier(VerifyUserCanSeeAllTimesInTrackerStub::withoutAllowed()),
            $manager,
            $time,
        );
    }
