...
final class PeopleTimetrackingTest extends TimetrackingBase
{
    public function testOptionsUsers(): void
    {
        $response = $this->getResponseByName(
            TimetrackingDataBuilder::USER_TESTER_NAME,
            $this->request_factory->createRequest('OPTIONS', 'timetracking_people_users')
        );
    ...
    public function testGetUsers(): void
    {
        $response = $this->getResponseByName(
            TimetrackingDataBuilder::USER_TESTER_NAME,
            $this->request_factory->createRequest('GET', 'timetracking_people_users?query=supercalifra')
        );
        $this->assertSame(200, $response->getStatusCode());
        ...
        $response = $this->getResponseByName(
            TimetrackingDataBuilder::USER_TESTER_NAME,
            $this->request_factory->createRequest('GET', 'timetracking_people_users?query=rest')
        );
        $this->assertSame(200, $response->getStatusCode());
        $json = json_decode($response->getBody()->getContents(), true, 512, JSON_THROW_ON_ERROR);
    ...
    public function testGetManagementWidgetId(): int
    {
        ...
        $response = $this->getResponseByName(
            TimetrackingDataBuilder::USER_TESTER_NAME,
            $this->request_factory->createRequest('POST', 'timetracking_people_widget')->withBody($this->stream_factory->createStream($query))
        );
        $this->assertSame(200, $response->getStatusCode());
        $json = json_decode($response->getBody()->getContents(), true, 512, JSON_THROW_ON_ERROR);
    ...
    public function testPutConfiguration(int $id): int
    {
        ...
        $response = $this->getResponseByName(
            TimetrackingDataBuilder::USER_TESTER_NAME,
            $this->request_factory->createRequest('PUT', "timetracking_people_widget/$id")->withBody($this->stream_factory->createStream($query))
        );
        $this->assertSame(200, $response->getStatusCode());
        $json = json_decode($response->getBody()->getContents(), true, 512, JSON_THROW_ON_ERROR);
    ...
    public function testGetTimes(int $id): void
    {
        $response = $this->getResponseByName(
            TimetrackingDataBuilder::USER_TESTER_NAME,
            $this->request_factory->createRequest('GET', "timetracking_people_widget/$id/times")
        );
        $this->assertSame(200, $response->getStatusCode());
        $json = json_decode($response->getBody()->getContents(), true, 512, JSON_THROW_ON_ERROR);
