...
final class ManagerCanSeeTimetrackingOfUserVerifierDaoTest extends TestIntegrationTestCase
{
    private \PFUser $alice;
    private \PFUser $bob;
    private \PFUser $charlie;
    private \PFUser $dylan;
    private \PFUser $eleonor;
    private \PFUser $frank;
    private \PFUser $gaston;
    private \PFUser $hector;
    private \PFUser $igor;
    private \PFUser $june;
    private \PFUser $kevin;
    ...
    private function disableTimetrackingForTrackers(): void
    {
    ...
    private function enableTimetrackingForTrackers(): void
    {
        $admin_dao = new AdminDao();
        foreach ($this->trackers as $tracker) {
    ...
    public function testWhenTimetrackingIsDisabled(): void
    {
        ...
        self::assertFalse($dao->isManagerAllowedToSeeTimetrackingOfUser($this->bob, $this->alice));
        self::assertFalse($dao->isManagerAllowedToSeeTimetrackingOfUser($this->charlie, $this->alice));
        self::assertFalse($dao->isManagerAllowedToSeeTimetrackingOfUser($this->dylan, $this->alice));
        ...
        self::assertFalse($dao->isManagerAllowedToSeeTimetrackingOfUser($this->hector, $this->alice));
        self::assertFalse($dao->isManagerAllowedToSeeTimetrackingOfUser($this->igor, $this->alice));
        self::assertFalse($dao->isManagerAllowedToSeeTimetrackingOfUser($this->june, $this->alice));
        self::assertFalse($dao->isManagerAllowedToSeeTimetrackingOfUser($this->kevin, $this->alice));
    }
