...
PKG_NAME=tuleap-plugin-timetracking
...
docker-run:
	...
	su --login --command "make -C /build/src/plugins/timetracking all TULEAP_VERSION=$(shell LANG=C cat /tuleap/VERSION) RELEASE=$(RELEASE)" build
