...
export function getTrackersFromReport(
    report_id: number,
): ResultAsync<ProjectTimetrackingReport, Fault> {
...
export function getTrackersWithTimetracking(
    project_id: number,
): ResultAsync<ProjectReportTracker[], Fault> {
...
export function setDisplayPreference(
    ...
    return patchResponse(
        ...
        {},
        {
            key: "project_timetracking_display_trackers_without_time_" + report_id,
