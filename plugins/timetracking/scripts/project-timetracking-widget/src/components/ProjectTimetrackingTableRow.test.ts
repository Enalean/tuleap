...
describe("Given a project timetracking widget", () => {
    ...
    const getWrapper = (): VueWrapper => {
        ...
        return shallowMount(ProjectTimetrackingTableRow, {
    ...
    it("When tracker total sum not equal zero, then table row is displayed", () => {
        ...
        expect(wrapper.find("[data-test=project-timetracking-table-row]").exists()).toBe(true);
    });
    ...
    it("When tracker total sum equal zero and void trackers not displayed, then table row is not displayed", () => {
        ...
        expect(wrapper.find("[data-test=project-timetracking-table-row]").exists()).toBe(false);
    });
});
