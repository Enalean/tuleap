...
describe("Given a project timetracking widget on writing mode", () => {
    ...
    const getWrapper = (): VueWrapper => {
        ...
        return shallowMount(ProjectTimetrackingWritingTrackers, {
    ...
    it("When trackers and projects are available, then click on add button", () => {
        ...
        wrapper
            .findComponent(ProjectTimetrackingTrackersOptions)
