...
import PeopleTimetrackingWidget from "./PeopleTimetrackingWidget.vue";
...
describe("Given a People Timetracking Widget", () => {
    function getPeopleTimetrackingWidgetInstance(
        users_list: User[],
    ): VueWrapper<InstanceType<typeof PeopleTimetrackingWidget>> {
        return shallowMount(PeopleTimetrackingWidget, {
            props: {
    ...
    it("When the query displayer is clicked, then the query editor should be displayed but not query displayer", async () => {
        const wrapper = getPeopleTimetrackingWidgetInstance([]);
    ...
    it("Should sort users", () => {
        ...
        const wrapper = getPeopleTimetrackingWidgetInstance(users);
    ...
    describe("When the saving fails", () => {
        let wrapper: VueWrapper<InstanceType<typeof PeopleTimetrackingWidget>>;

        beforeEach(async () => {
            wrapper = getPeopleTimetrackingWidgetInstance([]);
