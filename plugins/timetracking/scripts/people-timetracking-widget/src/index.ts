...
import PeopleTimetrackingWidget from "./components/PeopleTimetrackingWidget.vue";
...
document.addEventListener("DOMContentLoaded", async () => {
    const mount_point = document.getElementById("people-timetracking-widget");
    ...
    createApp(PeopleTimetrackingWidget, {
        initial_query,
        widget_id: query.id,
    })
        .use(
