...
class PeopleTimetrackingWidget extends Widget
{
    public const string NAME = 'people-timetracking-widget';
    ...
    {
        return dgettext('tuleap-timetracking', 'People timetracking');
    }
    ...
    {
        $widget_config = PeopleTimetrackingWidgetConfig::fromId(
            $this->content_id,
            $this->dao,
            $this->dao,
        ...
        return $renderer->renderToString('people-timetracking', [
        ...
        return [
            new JavascriptViteAsset(
                new IncludeViteAssets(
                    __DIR__ . '/../../../scripts/people-timetracking-widget/frontend-assets',
                    '/assets/timetracking/people-timetracking-widget'
                ),
                'src/index.ts'
            ),
        ];
