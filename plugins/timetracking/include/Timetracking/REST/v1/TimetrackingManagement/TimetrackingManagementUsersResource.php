...
use Tuleap\Timetracking\Widget\Management\ViewableUsersForManagerProviderDao;
...
final class TimetrackingManagementUsersResource extends AuthenticatedResource
{
    public const NAME = 'timetracking_management_users';
