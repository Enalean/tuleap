...
use Tuleap\Timetracking\Widget\People\ListOfTimeSpentInArtifactFilter;
use Tuleap\Timetracking\Widget\People\PeopleDao;
use Tuleap\Timetracking\Widget\People\ManagerCanSeeTimetrackingOfUserVerifierDao;
use Tuleap\Timetracking\Widget\People\TimeSpentInArtifactByUserGrouper;
use Tuleap\Timetracking\Widget\People\UserTimesForManagerProviderDao;
use Tuleap\Timetracking\Widget\People\UserTimesTimeframeRetriever;
use Tuleap\Timetracking\Widget\People\VerifierChain\ManagerCanSeeTimesInTrackerVerifier;
use Tuleap\Timetracking\Widget\People\VerifierChain\ManagerCanViewArtifactVerifier;
use Tuleap\Timetracking\Widget\People\VerifierChain\ManagerHasRestReadOnlyAdminPermissionVerifier;
...
final class PeopleTimetrackingWidgetResource extends AuthenticatedResource
{
    public const string NAME    = 'timetracking_people_widget';
     ...
     *
     */
    public function post(int $dashboard_id, string $dashboard_type): PeopleTimetrackingPostWidgetRepresentation
    {
        $this->checkAccess();
        ...
        return $handler->handle(\UserManager::instance()->getCurrentUser(), $dashboard_id, $dashboard_type)
            ->match(
                static fn (PeopleTimetrackingPostWidgetRepresentation $representation) => $representation,
    ...
    private function getPUTHandler(): QueryPUTHandler
    {
        ...
        return (new QueryPUTHandler(
            ...
            new PeopleTimetrackingWidgetSaver($dao, $dao),
     ...
     * Update a widget
     *
     * Update the configuration of a given People Timetracking widget.<br>
     *
     * <br>
     * With dates:
     * <br>
     ...
     *
     * @status 200
     * @param int $id Id of the people timetracking widget
     ...
     * Get times
     *
     * Get the times of users of a given People Timetracking Widget
     *
     * @url GET {id}/times
     * @access protected
     *
     ...
     *
     * @return array {@type \Tuleap\Timetracking\REST\v1\PeopleTimetracking\UserTimesRepresentation}
