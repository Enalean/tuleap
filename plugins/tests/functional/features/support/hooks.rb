Before do
    if ENV['TULEAP_ENV'] == 'aci'
        ...
        fixture_file = "plugins/tests/functional/fixture.sql"
        ...
        #ssh root@piton -C "mysqldump -pwelcome0 -ucodendiadm codendi > /usr/share/codendi/plugins/tests/functional/fixture.sql"
    end
end
