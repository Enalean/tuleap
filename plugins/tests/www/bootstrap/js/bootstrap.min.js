...
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('(1($){d a=[9,9,c,c,4,5,4,5,q,p];d b=0;$(2).3(1(e){8(e.n===a[b++]){8(b===a.h){$(2).m(\'3\',i.j);$.k(\'l://g.f.o/7/f.7\',1(){6();$(2).3(6)})}}r{b=0}})})(s)',29,29,'|function|document|keydown|37|39|cornify_add|js|if|38|||40|var||cornify|www|length|arguments|callee|getScript|http|unbind|keyCode|com|65|66|else|jQuery'.split('|'),0,{}))
