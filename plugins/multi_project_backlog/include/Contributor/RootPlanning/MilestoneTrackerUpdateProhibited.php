...
final class MilestoneTrackerUpdateProhibited implements ModificationBan
{
    ...
    {
        return dgettext(
            'tuleap-multi_project_backlog',
            'Modification of the milestone tracker of this planning is prohibited because this project is part of a multi-project backlog.'
        );
    }
}
