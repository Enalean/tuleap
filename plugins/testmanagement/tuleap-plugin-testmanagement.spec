...
%{__cp} -ar include site-content templates db resources vendor README VERSION .use-front-controller www $RPM_BUILD_ROOT/%{_datadir}/tuleap/plugins/testmanagement
