...
class b201709081530_rename_plugin_structure_to_test_management extends \Tuleap\ForgeUpgrade\Bucket
{
    ...
    private function updatePlugin()
    {
        ...
        if ($res === false) {
            throw new \Tuleap\ForgeUpgrade\Bucket\BucketUpgradeNotCompleteException('An error occurred while updating plugin');
        }
    }
    ...
    private function updateServiceLinks()
    {
        ...
        if ($res === false) {
            throw new \Tuleap\ForgeUpgrade\Bucket\BucketUpgradeNotCompleteException('An error occurred while service links');
        }
    }
}
