...
import arrow_style from "./step-definition-arrow.scss?inline";

export const TAG = "tuleap-step-definition-arrow";

type StepDefinitionArrow = Readonly<{
    render(): HTMLElement;
}>;

const renderStepDefinitionArrow = (): UpdateFunction<StepDefinitionArrow> =>
    html`
        <svg
