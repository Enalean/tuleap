...
describe("TTM shortcuts", () => {
    ...
    it(`In test campaign page`, () => {
        ...
        cy.log("allows user to navigate in tests list using its keyboard");
        ...
        cy.log("filters remaining tests with `r` key shortcut");
        ...
        cy.log("opens `Select tests` modal");
        cy.get("@body").type("e");
