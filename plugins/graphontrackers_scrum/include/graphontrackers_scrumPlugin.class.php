 ...
 */
class GraphOnTrackers_ScrumPlugin extends Plugin {
    ...
    function getPluginInfo() {
        if (!is_a($this->pluginInfo, 'GraphOnTrackers_ScrumPluginInfo')) {
            require_once('graphontrackers_scrumPluginInfo.class.php');
            $this->pluginInfo = new GraphOnTrackers_ScrumPluginInfo($this);
        }
