...
function autoload6df1d25876e61b5ed0587f4414eef3be($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\mediawiki\\pergroup\\permissionpergrouppresenter' => '/PerGroup/PermissionPerGroupPresenter.php'
        );
    }
    $cn = strtolower($class);
    if (isset($classes[$cn])) {
...
spl_autoload_register('autoload6df1d25876e61b5ed0587f4414eef3be');
