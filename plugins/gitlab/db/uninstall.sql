...
DROP TABLE IF EXISTS plugin_gitlab_repository_integration_create_branch_prefix;
DROP TABLE IF EXISTS plugin_gitlab_group;
DROP TABLE IF EXISTS plugin_gitlab_group_token;
DROP TABLE IF EXISTS plugin_gitlab_group_repository_integration;
