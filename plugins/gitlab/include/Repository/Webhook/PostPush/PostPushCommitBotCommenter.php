...
class PostPushCommitBotCommenter
{
    ...
    public function addTuleapArtifactComment(
        Artifact $artifact,
        PFUser $tracker_workflow_user,
        PostPushCommitWebhookData $commit
    ): void {
        try {
            $committer           = $this->getTuleapUserFromGitlabCommitter($commit);
    ...
    private function getTuleapUserFromGitlabCommitter(PostPushCommitWebhookData $commit): string
    {
