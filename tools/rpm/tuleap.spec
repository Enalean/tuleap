...
%{__install} plugins/git/etc/sudoers.d/git-delete-repo $RPM_BUILD_ROOT/etc/sudoers.d/tuleap_git_delete_repo
...
%attr(00440,root,root) %{_sysconfdir}/sudoers.d/tuleap_git_delete_repo
