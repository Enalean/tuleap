...
if ($argc < 4) {
    die("Usage: ".$argv[0] . "project_id desc_field_id desc_field_value");
}
...
$project_id       = $argv[1];
$desc_field_id    = $argv[2];
$desc_field_value = $argv[3];

var_dump($soapProject->setProjectDescriptionFieldValue($requesterSessionHash, $project_id, $desc_field_id, $desc_field_value));
