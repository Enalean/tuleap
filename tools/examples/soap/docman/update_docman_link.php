...
if ($argc != 3) {
    die("Usage: ".$argv[0]." project_id link_id\n");
}

$serverURL = getenv('TULEAP_SERVER')   ? getenv('TULEAP_SERVER')   : 'http://tuleap.example.net';
...
$response = $soapLogin->updateDocmanLink($requesterSessionHash, $project_id, $document_id, 'Test link update from SOAP',
        'description', '', '',
        'http://tuleap.com', '','', 'admin', '', '');
