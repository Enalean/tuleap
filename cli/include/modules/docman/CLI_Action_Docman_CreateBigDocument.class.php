...
class CLI_Action_Docman_CreateBigDocument extends CLI_Action {
	
	private $chunk_size = 6000000; //6 Mo
	private $current_chunk_offset = 0;
	private $filename;
    
    function CLI_Action_Docman_CreateBigDocument() {
        $this->CLI_Action('createBigDocument', 'Create a "big" document');
        $this->addParam(array(
            'name'           => 'parent_id',
