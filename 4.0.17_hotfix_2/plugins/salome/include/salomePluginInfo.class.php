...
require_once('salomePluginDescriptor.class.php');

class salomePluginInfo extends PluginInfo {
    
    function salomePluginInfo(&$plugin) {
        $this->PluginInfo($plugin);
        $this->setPluginDescriptor(new salomePluginDescriptor());
        $this->_conf_path = $plugin->getPluginEtcRoot() .'/salome.inc';
        $this->loadProperties();
    }
