...
if [ -z "$PHP_PARAMS" ]; then
    PHP_PARAMS="-q -d include_path=/usr/share/pear:/usr/share/tuleap/src/www/include:/usr/share/tuleap/src:. -d memory_limit=256M -d allow_call_time_pass_reference=On "
fi
