...
if [ -z "$PHP_PARAMS" ]; then
    PHP_PARAMS="-q -d include_path=/usr/share/php:/usr/share/tuleap/src/www/include:/usr/share/tuleap/src:/usr/share/codendi/src/www/include:/usr/share/codendi/src:. -d memory_limit=256M"
fi
