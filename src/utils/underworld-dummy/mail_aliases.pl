...
push @alias_array, "#   - The codendi wide aliases (specific to codendi) resides in this file\n";
push @alias_array, "#   - All system wide aliases remains in /etc/aliases\n\n";
push @alias_array, "# Codendi wide aliases\n\n";
push @alias_array, "codendi-contact:         codendi-admin\n\n";
push @alias_array, "sourceforge:           codendi-admin\n"; # deprecated user name
push @alias_array, "$sys_http_user:               codendi-admin\n";
...
push @alias_array, "webmaster:             codendi-admin\n\n";
