...
final class SetupTuleapCommand extends Command
{
     ...
     */
    public function __construct(private ProcessFactory $process_factory, private readonly KeyFactory $key_factory, private \Closure $forge_upgrade_provider, ?string $base_directory = null)
    {
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->key_factory->restoreOwnership($logger);
