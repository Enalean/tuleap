...
export default [
    {
        entry: {
            ...
            "site-admin-pending-users-styles": "./styles/pending-users.scss",
            ...
            "site-admin-project-history-styles": "./styles/project-history.scss",
            ...
            "site-admin-userlist-styles": "./styles/site-admin-user-list.scss",
        },
        context: __dirname,
