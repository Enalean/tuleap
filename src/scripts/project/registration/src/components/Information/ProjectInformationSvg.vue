...
<template functional>
    <div class="register-new-project-boxes">
        ...
        >
            ...
            />
            <rect x="112.5" y="149.25" width="90" height="46.5" rx="3.62264" fill="#F3F4FA" />
            <rect
                x="112.5"
                y="149.25"
                width="90"
            ...
            <defs>
                ...
                >
                    <stop offset="0" stop-color="var(--tlp-illustration-grey)" stop-opacity="0.5" />
                    <stop offset="1" stop-color="var(--tlp-illustration-grey)" stop-opacity="0" />
                </linearGradient>
            </defs>
        </svg>
    </div>
