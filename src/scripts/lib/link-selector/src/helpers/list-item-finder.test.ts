...
describe("list-item-finder", () => {
    ...
    function generateList(): {
        ...
        group_1.setAttribute("class", "link-selector-item-group");
        group_1.appendChild(group_1_items);
        const group_2 = document.createElement("li");
        const group_2_items = document.createElement("ul");
        group_2.setAttribute("class", "link-selector-item-group");
        group_2.appendChild(group_2_items);
        list.appendChild(group_1);
        list.appendChild(group_2);

        const item_1 = document.createElement("li");
        item_1.setAttribute("class", "link-selector-dropdown-option-value");
        const item_2 = document.createElement("li");
        item_2.setAttribute("class", "link-selector-dropdown-option-value-disabled");
        const item_3 = document.createElement("li");
        item_3.setAttribute("class", "link-selector-dropdown-option-value");
        const item_4 = document.createElement("li");
        item_4.setAttribute("class", "link-selector-dropdown-option-value-disabled");
        const item_5 = document.createElement("li");
        item_5.setAttribute("class", "link-selector-dropdown-option-value");
