...
export class ScrollingManager {
    ...
    constructor(private readonly wrapper_element: HTMLElement) {
        this.first_scrollable_parent = this.findLinkSelectorFirstScrollableParent(
    ...
    public lockScrolling(): void {
        if (isLinkSelectorInAModal(this.wrapper_element)) {
    ...
    public findLinkSelectorFirstScrollableParent(wrapper_element: HTMLElement): HTMLElement | null {
