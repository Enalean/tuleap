...
export function appendSimpleOptionsToSourceSelectBox(select: HTMLSelectElement): void {
    ...
    option_none.setAttribute("data-item-id", "link-selector-item-value-100");
    ...
    for (i = 0; i < 3; i++) {
        ...
        option.setAttribute("data-item-id", "link-selector-item-value_" + i);
    ...
    option_with_label.setAttribute("data-item-id", "link-selector-item-value_" + i);
...
export function appendGroupedOptionsToSourceSelectBox(select: HTMLSelectElement): void {
    ...
    ["Group 1", "Group 2"].forEach((group_name: string) => {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            option.setAttribute("data-item-id", "link-selector-item-value" + option_index);
