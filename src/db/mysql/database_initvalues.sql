...
-- Bugs tracker
INSERT INTO artifact_field VALUES (7,1,1,'submitted_by',5,'SB','','Submitted by','User who originally submitted the artifact','',0,1,0,1,'artifact_submitters','',NULL);
INSERT INTO artifact_field VALUES (6,1,1,'open_date',4,'DF','','Submitted on','Date and time for the initial artifact submission','',0,0,0,1,'','',NULL);
INSERT INTO artifact_field VALUES (5,1,1,'summary',1,'TF','60/150','Summary','One line description of the artifact','',0,0,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (1,1,1,'artifact_id',2,'TF','6/10','Artifact ID','Unique artifact identifier','',0,0,0,1,NULL,'',NULL);
INSERT INTO artifact_field VALUES (4,1,2,'assigned_to',5,'SB','','Assigned to','Who is in charge of solving the artifact','',0,1,1,0,'group_members','100',NULL);
INSERT INTO artifact_field VALUES (31,1,1,'last_update_date',4,'DF','','Last Modified On','Date and time of the latest modification in an artifact','',0,0,0,1,'','',NULL);
INSERT INTO artifact_field VALUES (3,1,1,'category_id',2,'SB','','Category','Generally correspond to high level modules or functionalities of your software (e.g. User interface, Configuration Manager, Scheduler, Memory Manager...)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (2,1,2,'status_id',2,'SB','','Status','Artifact Status','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (30,1,2,'stage',2,'SB','','Stage','Stage in the life cycle of the artifact','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (8,1,1,'severity',2,'SB','','Severity','Impact of the artifact on the system (Critical, Major,...)','',0,0,1,0,NULL,'5',NULL);
INSERT INTO artifact_field VALUES (10,1,1,'comment_type_id',2,'SB','','Comment Type','Specify the nature of the  follow up comment attached to this artifact (Workaround, Test Case, Impacted Files,...)','',0,1,0,1,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (9,1,1,'details',1,'TA','60/7','Original Submission','A full description of the artifact','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (16,1,2,'resolution_id',2,'SB','','Resolution','How you have decided to fix the artifact (Fixed, Work for me, Duplicate,..)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (20,1,1,'bug_group_id',2,'SB','','Group','Characterizes the nature of the artifact (e.g. Feature Request, Action Request, Crash Error, Documentation Typo, Installation Problem,...','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (11,1,1,'category_version_id',2,'SB','','Component Version','The version of the System Component (aka Category) impacted by the artifact','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (12,1,1,'platform_version_id',2,'SB','','Platform Version','The name and version of the platform your software was running on when the artifact occured (e.g. Solaris 2.8, Linux 2.4, Windows NT4 SP2,...)','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (13,1,2,'reproducibility_id',2,'SB','','Reproducibility','How easy is it to reproduce the artifact','S',0,0,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (14,1,2,'size_id',2,'SB','','Size (loc)','The size of the code you need to develop or rework in order to fix the artifact','S',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (15,1,2,'fix_release_id',2,'SB','','Fixed Release','The release in which the artifact was actually fixed','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (17,1,2,'hours',3,'TF','5/5','Effort','Number of hours of work needed to fix the artifact (including testing)','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (18,1,2,'plan_release_id',2,'SB','','Planned Release','The release in which you initially planned the artifact to be fixed','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (19,1,1,'component_version',1,'TF','10/40','Component Version','Version of the system component (or work product) impacted by the artifact. Same as the other Component Version field <u>except</u> this one is free text.','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (22,1,1,'priority',2,'SB','','Priority','How quickly the artifact must be fixed (Immediate, Normal, Low, Later,...)','S',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (23,1,1,'keywords',1,'TF','60/120','Keywords','A list of comma separated keywords associated with a artifact','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (24,1,1,'release_id',2,'SB','','Release','The release (global version number) impacted by the artifact','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (26,1,1,'originator_name',1,'TF','20/40','Originator Name','The name of the person who reported the artifact (if different from the submitter field)','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (27,1,1,'originator_email',1,'TF','20/40','Originator Email','Email address of the person who reported the artifact. Automatically included in the artifact email notification process.','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (28,1,1,'originator_phone',1,'TF','10/40','Originator Phone','Phone number of the person who reported the artifact','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (29,1,2,'close_date',4,'DF','','Close Date','Close Date','',0,1,0,0,NULL,0,NULL);
-- Tasks tracker
INSERT INTO artifact_field VALUES (2,2,4,'percent',2,'TF','3/3','Percentage of completion (1-100)','Integer value between 0-100','',0,0,1,0,NULL,'0',NULL);
INSERT INTO artifact_field VALUES (4,2,4,'hours',3,'TF','5/5','Effort','Number of hours of work needed to fix the artifact (including testing)','',0,1,1,0,NULL,'0.00',NULL);
INSERT INTO artifact_field VALUES (5,2,4,'start_date',4,'DF','','Start Date','Start Date','',0,1,1,0,NULL,0,NULL);
INSERT INTO artifact_field VALUES (6,2,4,'close_date',4,'DF','','Close Date','Close Date','',0,0,0,1,NULL,0,NULL);
INSERT INTO artifact_field VALUES (7,2,3,'summary',1,'TF','60/150','Summary','One line description of the artifact','',0,0,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (8,2,3,'details',1,'TA','60/7','Original Submission','A full description of the artifact','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (11,2,4,'status_id',2,'SB','','Status','Artifact Status','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (15,2,4,'stage',2,'SB','','Stage','Stage in the life cycle of the artifact','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (1,2,3,'artifact_id',2,'TF','6/10','Artifact ID','Unique artifact identifier','',0,0,0,1,NULL,'',NULL);
INSERT INTO artifact_field VALUES (10,2,3,'open_date',4,'DF','','Submitted on','Date and time for the initial artifact submission','',0,0,0,1,'','',NULL);
INSERT INTO artifact_field VALUES (9,2,3,'multi_assigned_to',5,'MB','','Assigned to (multiple)','Who is in charge of this artifact','',0,1,1,0,'group_members','100',NULL);
INSERT INTO artifact_field VALUES (12,2,3,'subproject_id',2,'SB','','Subproject','Generally correspond to high level modules or functionalities of your software (e.g. User interface, Configuration Manager, Scheduler, Memory Manager...)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (13,2,3,'submitted_by',5,'SB','','Submitted by','User who originally submitted the artifact','',0,1,0,1,'artifact_submitters','',NULL);
INSERT INTO artifact_field VALUES (14,2,3,'severity',2,'SB','','Priority','How quickly the artifact must be completed','',0,0,1,0,NULL,'5',NULL);
INSERT INTO artifact_field VALUES (16,2,3,'last_update_date',4,'DF','','Last Modified On','Date and time of the latest modification in an artifact','',0,0,0,1,'','',NULL);
INSERT INTO artifact_field VALUES (17,2,4,'due_date',4,'DF','','Due Date','Due Date','',0,1,1,0,NULL,0,NULL);
INSERT INTO artifact_field VALUES (18,2,4,'end_date',4,'DF','','End Date','End Date','',0,1,1,0,NULL,0,NULL);
-- SR tracker
INSERT INTO artifact_field VALUES (9,3,5,'submitted_by',5,'SB','','Submitted by','User who originally submitted the artifact','',0,1,0,1,'artifact_submitters','',NULL);
INSERT INTO artifact_field VALUES (7,3,6,'status_id',2,'SB','','Status','Artifact Status','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (12,3,6,'stage',2,'SB','','Stage','Stage in the life cycle of the artifact','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (6,3,6,'assigned_to',5,'SB','','Assigned to','Who is in charge of solving the artifact','',0,1,1,0,'group_members','100',NULL);
INSERT INTO artifact_field VALUES (5,3,5,'category_id',2,'SB','','Category','Generally correspond to high level modules or functionalities of your software (e.g. User interface, Configuration Manager, Scheduler, Memory Manager...)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (4,3,5,'open_date',4,'DF','','Submitted on','Date and time for the initial artifact submission','',0,0,0,1,'','',NULL);
INSERT INTO artifact_field VALUES (3,3,5,'details',1,'TA','60/7','Original Submission','A full description of the artifact','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (2,3,5,'summary',1,'TF','60/150','Summary','One line description of the artifact','',0,0,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (1,3,5,'artifact_id',2,'TF','6/10','Artifact ID','Unique artifact identifier','',0,0,0,1,NULL,'',NULL);
INSERT INTO artifact_field VALUES (10,3,6,'close_date',4,'DF','','Close Date','Close Date','',0,1,0,0,NULL,0,NULL);
INSERT INTO artifact_field VALUES (11,3,5,'severity',2,'SB','','Priority','How quickly the artifact must be completed','',0,0,1,0,NULL,'5',NULL);
INSERT INTO artifact_field VALUES (13,3,5,'last_update_date',4,'DF','','Last Modified On','Date and time of the latest modification in an artifact','',0,0,0,1,'','',NULL);
-- Empty tracker
INSERT INTO artifact_field VALUES (1,4,7,'submitted_by',5,'SB','','Submitted by','User who originally submitted the artifact','',0,1,0,1,'artifact_submitters','',NULL);
INSERT INTO artifact_field VALUES (2,4,7,'open_date',4,'DF','','Submitted on','Date and time for the initial artifact submission','',0,0,0,1,'','',NULL);
INSERT INTO artifact_field VALUES (3,4,7,'close_date',4,'DF','','Close Date','Close Date','',0,1,0,0,NULL,0,NULL);
INSERT INTO artifact_field VALUES (4,4,7,'summary',1,'TF','60/150','Summary','One line description of the artifact','',0,0,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (5,4,7,'artifact_id',2,'TF','6/10','Artifact ID','Unique artifact identifier','',0,0,0,1,NULL,'',NULL);
INSERT INTO artifact_field VALUES (6,4,7,'status_id',2,'SB','','Status','Artifact Status','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (11,4,7,'stage',2,'SB','','Stage','Stage in the life cycle of the artifact','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (7,4,7,'severity',2,'SB','','Severity','Impact of the artifact on the system (Critical, Major,...)','',0,0,1,0,NULL,'5',NULL);
INSERT INTO artifact_field VALUES (8,4,7,'details',1,'TA','60/7','Original Submission','A full description of the artifact','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (9,4,7,'assigned_to',5,'SB','','Assigned to','Who is in charge of solving the artifact','',0,1,1,0,'group_members','100',NULL);
...
INSERT INTO artifact_field VALUES (2,6,12,'status_id',2,'SB','','Status','Artifact Status','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (3,6,11,'category_id',2,'SB','','Category','Generally correspond to high level modules or functionalities of your software (e.g. User interface, Configuration Manager, Scheduler, Memory Manager...)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (4,6,12,'assigned_to',5,'SB','','Assigned to','Who is in charge of solving the artifact','',0,1,1,0,'group_members','100',NULL);
INSERT INTO artifact_field VALUES (5,6,11,'summary',1,'TF','60/150','Summary','One line description of the artifact','',0,0,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (6,6,11,'open_date',4,'DF','','Submitted on','Date and time for the initial artifact submission','',0,0,0,1,'','',NULL);
INSERT INTO artifact_field VALUES (7,6,11,'submitted_by',5,'SB','','Submitted by','User who originally submitted the artifact','',0,1,0,1,'artifact_submitters','',NULL);
INSERT INTO artifact_field VALUES (8,6,11,'severity',2,'SB','','Severity','Impact of the artifact on the system (Critical, Major,...)','',0,0,1,0,NULL,'5',NULL);
INSERT INTO artifact_field VALUES (9,6,11,'details',1,'TA','60/7','Original Submission','A full description of the artifact','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (10,6,11,'comment_type_id',2,'SB','','Comment Type','Specify the nature of the  follow up comment attached to this artifact (Workaround, Test Case, Impacted Files,...)','',0,1,0,1,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (11,6,11,'category_version_id',2,'SB','','Component Version','The version of the System Component (aka Category) impacted by the artifact','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (12,6,11,'platform_version_id',2,'SB','','Platform Version','The name and version of the platform your software was running on when the artifact occured (e.g. Solaris 2.8, Linux 2.4, Windows NT4 SP2,...)','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (13,6,12,'reproducibility_id',2,'SB','','Reproducibility','How easy is it to reproduce the artifact','S',0,0,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (14,6,12,'size_id',2,'SB','','Size (loc)','The size of the code you need to develop or rework in order to fix the artifact','S',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (15,6,12,'fix_release_id',2,'SB','','Fixed Release','The release in which the artifact was actually fixed','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (16,6,12,'resolution_id',2,'SB','','Resolution','How you have decided to fix the artifact (Fixed, Work for me, Duplicate,..)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (17,6,12,'hours',3,'TF','5/5','Effort','Number of hours of work needed to fix the artifact (including testing)','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (18,6,12,'plan_release_id',2,'SB','','Planned Release','The release in which you initially planned the artifact to be fixed','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (19,6,11,'component_version',1,'TF','10/40','Component Version','Version of the system component (or work product) impacted by the artifact. Same as the other Component Version field <u>except</u> this one is free text.','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (20,6,11,'bug_group_id',2,'SB','','Group','Characterizes the nature of the artifact (e.g. Feature Request, Action Request, Crash Error, Documentation Typo, Installation Problem,...','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (22,6,11,'priority',2,'SB','','Priority','How quickly the artifact must be fixed (Immediate, Normal, Low, Later,...)','S',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (23,6,11,'keywords',1,'TF','60/120','Keywords','A list of comma separated keywords associated with a artifact','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (24,6,11,'release_id',2,'SB','','Release','The release (global version number) impacted by the artifact','P',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (26,6,11,'originator_name',1,'TF','20/40','Originator Name','The name of the person who reported the artifact (if different from the submitter field)','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (27,6,11,'originator_email',1,'TF','20/40','Originator Email','Email address of the person who reported the artifact. Automatically included in the artifact email notification process.','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (28,6,11,'originator_phone',1,'TF','10/40','Originator Phone','Phone number of the person who reported the artifact','S',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (29,6,12,'close_date',4,'DF','','Close Date','Close Date','',0,1,0,0,NULL,0,NULL);
INSERT INTO artifact_field VALUES (30,6,12,'stage',2,'SB','','Stage','Stage in the life cycle of the artifact','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (31,6,13,'slm_environment',1,'TF','60/150','Environment','Associated Salomé TMF environment','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (32,6,13,'slm_campaign',1,'TF','60/150','Campaign','Associated Salomé TMF campaign','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (33,6,13,'slm_family',1,'TF','60/150','Family','Associated Salomé TMF family','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (34,6,13,'slm_suite',1,'TF','60/150','Suite','Associated Salomé TMF suite','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (35,6,13,'slm_test',1,'TF','60/150','Test','Associated Salomé TMF test','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (36,6,13,'slm_action',1,'TF','60/150','Action','Associated Salomé TMF action','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (37,6,13,'slm_execution',1,'TF','60/150','Execution','Associated Salomé TMF execution','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (38,6,13,'slm_dataset',1,'TF','60/150','Data Set','Associated Salomé TMF data set','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (39,6,11,'slm_priority',2,'SB','','Salome Priority','Salome Priority involved in QSScore calculation. Please do not modify it.','',0,1,1,0,NULL,'2',NULL);
INSERT INTO artifact_field VALUES (40,6,11,'last_update_date',4,'DF','','Last Modified On','Date and time of the latest modification in an artifact','',0,0,0,1,'','',NULL);
-- Scrum Backlog tracker
INSERT INTO artifact_field VALUES (1,7,14,'submitted_by',5,'SB', '', 'Submitted by','User who originally submitted the artifact','',0,1,1,1,'artifact_submitters','',NULL);
INSERT INTO artifact_field VALUES (2,7,14,'open_date',4,'DF', '', 'Submitted on','Date and time for the initial artifact submission','',0,0,0,1,NULL,'',NULL);
INSERT INTO artifact_field VALUES (3,7,14,'close_date',4,'DF', '', 'Close Date','Close Date','',0,0,0,0,NULL,0,NULL);
INSERT INTO artifact_field VALUES (4,7,14,'summary',1,'TF', '60/150', 'Summary','One line description of the artifact','',0,0,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (5,7,14,'artifact_id',2,'TF', '6/10', 'Artifact ID','Unique artifact identifier','',0,0,0,1,NULL,'',NULL);
INSERT INTO artifact_field VALUES (6,7,14,'severity',2,'SB', '', 'Priority','Customer priority','',0,0,1,0,NULL,'5',NULL);
INSERT INTO artifact_field VALUES (7,7,14,'details',1,'TA', '60/7', 'Original Submission','A full description of the artifact','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (8,7,14,'category',2,'SB', '', 'Category','Category this story belongs to (e.g. User interface, reporting, account management, etc.)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (9,7,14,'customer_value',2,'TF', '', 'Value','Customer value for this story (integer))','',0,1,1,0,NULL,'0',NULL);
INSERT INTO artifact_field VALUES (10,7,14,'acceptance_criteria',1,'TA', '80/3', 'Acceptance criteria','Description of customer acceptance criteria for this story','',0,1,1,0,NULL,'',NULL);
INSERT INTO artifact_field VALUES (11,7,14,'product',2,'SB', '80/3', 'Product','Product impacted by story (for multi-product project)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (12,7,14,'customer',2,'SB', '', 'Customer','Customer(s) that requested this story (for multi-customer projects)','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (13,7,15,'status_id',2,'SB', '', 'Status','Artifact Status','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (14,7,15,'assigned_to',5,'SB', '', 'Owner','Who is in charge of this story','',0,1,1,0,'group_members','100',NULL);
INSERT INTO artifact_field VALUES (15,7,15,'stage',2,'SB', '', 'Stage','Stage in the life cycle of the artifact','',0,0,1,0,NULL,'1',NULL);
INSERT INTO artifact_field VALUES (16,7,15,'initial_effort',2,'TF', '', 'Initial Effort Estimate','Initial estimation of effort','',0,1,1,0,NULL,'0',NULL);
INSERT INTO artifact_field VALUES (17,7,15,'current_effort',2,'TF', '', 'Current Effort Estimate','Current estimation of effort','',0,1,1,0,NULL,'0',NULL);
INSERT INTO artifact_field VALUES (18,7,15,'release',2,'SB', '', 'Release','Planned release for this story','',0,1,1,0,NULL,'100',NULL);
INSERT INTO artifact_field VALUES (19,7,15,'iteration',2,'TF', '', 'Iteration','Iteration number when the story is planned.','',0,1,1,0,NULL,'0',NULL);
INSERT INTO artifact_field VALUES (20,7,15,'rank',2,'TF', '', 'Rank','Rank of story in current sprint (i.e priority)','',0,1,1,0,NULL,'0',NULL);
INSERT INTO artifact_field VALUES (21,7,15,'backlog',2,'SB', '', 'Backlog','Sprint or Product backlog?','',0,0,1,0,NULL,'101',NULL);
INSERT INTO artifact_field VALUES (22,7,15,'remaining_effort',2,'TF', '', 'Remaining Effort','Remaining Effort','',0,1,1,0,NULL,'0',NULL);
INSERT INTO artifact_field VALUES (23,7,14,'last_update_date',4,'DF','','Last Modified On','Date and time of the latest modification in an artifact','',0,0,0,1,'','',NULL);
