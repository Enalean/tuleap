...
class b201701251415_user_lost_password_add_creation_date extends ForgeUpgrade_Bucket
{
    ...
    {
        return 'Add the creation date attribute to the user_lost_password table.';
    }
    ...
    public function up()
    {
        $sql = 'ALTER TABLE user_lost_password ADD COLUMN creation_date INTEGER UNSIGNED NOT NULL';
