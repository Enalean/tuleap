...
#
# Description
# Adds a new field 'username_display' in 'user' table, to choose the way users names are displayed:
# Codex internal login OR LDAP real name.
#
#
# References:
# no
...
ALTER TABLE user ADD username_display int(11) NOT NULL DEFAULT 0 AFTER language_id;
