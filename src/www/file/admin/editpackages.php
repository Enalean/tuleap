	...
	for ($i=0; $i<$rows; $i++) {
		...
		<TR class="'. util_get_alt_row_color($i) .'">
			<TD><FONT SIZE="-1"><INPUT TYPE="TEXT" NAME="package_name" VALUE="'. 
				db_result($res,$i,'package_name') .'" CLASS="small"></TD>
...
<table>
<tr><th>'.$Language->getText('file_admin_editpackages','p_name').':</th>  <td><input type="text" name="package_name" CLASS="small"></td></tr>
