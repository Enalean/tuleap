...
<html>
<head>
    <title>Tuleap Guidelines</title>

    <script src="_js/jquery-2.1.4.min.js"></script>
    <script src="_js/bootstrap-3.3.4.min.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="_css/highlight-solarized-light-8.5.min.css">
    <link rel="stylesheet" type="text/css" href="_css/guidelines.css">
</head>
<body>
    <div id="under-construction">
        <p>Under construction, please do not use.</p>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="75px" height="50px" viewBox="0 0 100 68">
            <g id="large">
                <g>
                <path d="M55.777,38.473l6.221-1.133c0.017-1.791-0.123-3.573-0.41-5.324l-6.321-0.19c-0.438-2.053-1.135-4.048-2.076-5.931
                    ...
                    c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="#DDD" stroke="none"/>
            ...
            <g id="small">
                <path d="M93.068,19.253L99,16.31c-0.371-1.651-0.934-3.257-1.679-4.776l-6.472,1.404c-0.902-1.436-2.051-2.735-3.42-3.819
                    ...
                    C84.573,16.331,86.05,20.549,84.365,24.062z" fill="#DDD" stroke="none"/>
            ...
            <div class="col-md-2">
                <nav id="menu" class="hidden-print hidden-xs hidden-sm affix">
                    ...
                    <ul class="nav">
                        <?php
                            foreach($sections as $section) {
                                include_once("$section/$section-menu.html");
                            }
                        ?>
                    </ul>
                </nav>
