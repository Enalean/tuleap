...
function initGettext() {
    const import_button = document.getElementById('project-admin-members-modal-import-users-button');
    if (! import_button) {
        return;
    }
...
function showFileFormatError() {
    const file_input_label = document.getElementById('project-admin-members-upload-file-form-element');
