...
export default function init(get, put, user_history_dropdown_trigger) {
    ...
    const loadHistoryAsynchronouslyOneTimeListener = () => {
        controller.loadHistoryAsynchronously().then(() => {
            user_history_dropdown_trigger.removeEventListener('click', loadHistoryAsynchronouslyOneTimeListener);
        });
    };
    user_history_dropdown_trigger.addEventListener('click', loadHistoryAsynchronouslyOneTimeListener);
...
class NavbarHistoryController {
    constructor(get, put) {
        ...
        this.error_message_fetch = document.getElementById('nav-dropdown-content-user-history-error-message-fetch');
        this.error_message_clear = document.getElementById('nav-dropdown-content-user-history-error-message-clear');
