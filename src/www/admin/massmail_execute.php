...
if (isset($body_format) && $body_format) {
...
if (isset($res_mail)) {
    ...
    $mail->setBcc($preview_destination, true);
    if ($mail->send()) {
        print "\n".$Language->getText('admin_massmail_execute','sending').": ".$preview_destination;
    } else {
        print "\n".$GLOBALS['Language']->getText('global', 'mail_failed', array($GLOBALS['sys_email_admin'])).": ".$preview_destination;
    }
}
