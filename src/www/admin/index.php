...
$wDoc->setContent('
<ul>
  <li><a href="/documentation/installation_guide/html/Tuleap_Installation_Guide.html">'.$Language->getText('admin_main', 'install_guide').'</a></li>
  <li><a href="/documentation/administration_guide/html/Tuleap_Administration_Guide.html">'.$Language->getText('admin_main', 'admin_guide').'</a></li>
</ul>');
