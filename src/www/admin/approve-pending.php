...
?>
        ...
        <INPUT type="submit" name="submit" class="tlp-button-secondary" value="<?php echo $Language->getText('admin_approve_pending','delete'); ?>">
        </FORM>
            </TD>
            </TR>
            </TABLE>
    ...
    echo '
        ...
        <INPUT type="submit" name="submit" class="tlp-button-primary" value="'.$Language->getText('admin_approve_pending','approve_all').'">
        </FORM>
        </center>
        ';
}
