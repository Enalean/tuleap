...
// Type definition
    ...
    $server->wsdl->addComplexType(
        ...
        'SOAP-ENC:Array',
        [],
        [['ref' => 'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:FRSPackage[]']],
        'tns:FRSPackage'
    );
    ...
    $server->wsdl->addComplexType(
        ...
        'SOAP-ENC:Array',
        [],
        [['ref' => 'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:FRSRelease[]']],
        'tns:FRSRelease'
    );
    ...
    $server->wsdl->addComplexType(
        ...
        'SOAP-ENC:Array',
        [],
        [['ref' => 'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:FRSFile[]']],
        'tns:FRSFile'
    );
