...
if ($group_id && user_ismember($group_id,'A')) {
    ...
    if (isset($add_list)) {
		...
		*/
		...
		if (user_is_super_user()) {
		    echo '<INPUT TYPE="TEXT" NAME="list_name" VALUE="'.group_getunixname($group_id).'-xxxxx" CLASS="small">@'.$GLOBALS['sys_lists_host'].'</B><BR>';		    
		} else {
		    echo '<B>'.group_getunixname($group_id).'-<INPUT TYPE="TEXT" NAME="list_name" VALUE="" CLASS="small">@'.$GLOBALS['sys_lists_host'].'</B><BR>';
		}
		echo '	<P>
