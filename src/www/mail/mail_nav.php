...
echo "<A HREF=\"/project/?group_id=$group_id\">".
    ...
    "<IMG SRC=\"".util_get_image_theme("ic/ofolder15.png")."\" HEIGHT=13 WIDTH=15 BORDER=0> &nbsp; ".$pm->getProject($group_id)->getPublicName()." ".$Language->getText('mail_nav','home_page')."</A><BR>";
