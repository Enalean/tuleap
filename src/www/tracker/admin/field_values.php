...
//
// $Id: field_values.php 1387 2005-03-08 16:41:17Z guerin $
//
//
...
echo '<H2>'.$Language->getText('tracker_import_admin','tracker').' \'<a href="/tracker/admin/?group_id='.$group_id.'&atid='.$atid.'">'.$ath->getName().'</a>\' '.$Language->getText('tracker_admin_field_values_details','values_admin').'</H2>';
