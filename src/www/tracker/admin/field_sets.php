...
echo '<H2>'.$Language->getText('tracker_import_admin','tracker').' \'<a href="/tracker/admin/?group_id='.(int)$group_id.'&atid='.(int)$atid.'">'. $hp->purify($ath->getName(), CODEX_PURIFIER_DISABLED) .'</a>\' '.$Language->getText('tracker_admin_fieldset','fieldset_admin').'</H2>';
