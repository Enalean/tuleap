...
final readonly class FileAlreadyUploadedInformation implements TusFileInformation
{
    public function __construct(private FileIdentifier $id, private string $name, private int $length)
    {
        if ($this->length < 0) {
