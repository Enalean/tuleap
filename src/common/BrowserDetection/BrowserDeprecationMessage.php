...
final class BrowserDeprecationMessage
{
    ...
    public const string DISABLE_OLD_BROWSER_WARNING                       = 'disable_old_browsers_warning';
    private const string DISABLE_OLD_BROWSER_WARNING_CONFIRMATION_MESSAGE = '2025W15_I_understand_this_only_hides_the_message_for_non_siteadmin_users_and_that_issues_related_to_old_browsers_will_still_be_present';
