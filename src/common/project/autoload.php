...
function autoload400fec2a38f5337e0aa00387d744a728($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'tuleap\\project\\rest\\projectresource' => '/REST/ProjectResource.class.php',
...
spl_autoload_register('autoload400fec2a38f5337e0aa00387d744a728');
