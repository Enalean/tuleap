 ...
 */
class URLVerification implements CheckUserCanAccessProject, CheckUserCanAccessProjectAndIsAdmin // phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace
{
