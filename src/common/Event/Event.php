...
class Event // phpcs:ignore PSR1.Classes.ClassDeclaration.MissingNamespace
{
     ...
     * No expected results
     */
    public const string SYSTEM_CHECK = 'system_check';
     ...
     * No expected results
     */
    public const string EDIT_SSH_KEYS = 'edit_ssh_keys';
     ...
     * No expected results
     */
    public const string DUMP_SSH_KEYS = 'dump_ssh_keys';
     ...
     * No expected results
     */
    public const string UPDATE_ALIASES = 'update_aliases';
     ...
     * No expected results
     */
    public const string USER_MANAGER_UPDATE_DB = 'user_manager_update_db';
     ...
     * No expected results
     */
    public const string PROJECT_RENAME = 'project_rename';
     ...
     * No expected results
     */
    public const string USER_RENAME = 'user_rename';
     ...
     */
    public const string USER_MANAGER_GET_USER_INSTANCE = 'user_manager_get_user_instance';

    public const string COMPUTE_MD5SUM = 'compute_md5sum';
     ...
     *  array of string
     */
    public const string SYSTEM_EVENT_GET_TYPES_FOR_DEFAULT_QUEUE = 'system_event_get_types_for_default_queue';
     ...
     *  array of string
     */
    public const string SYSTEM_EVENT_GET_TYPES_FOR_CUSTOM_QUEUE = 'system_event_get_types_for_custom_queue';
     ...
     */
    public const string WIKI_DISPLAY_REMOVE_BUTTON = 'wiki_display_remove_button';
     ...
     */
    public const string SVN_APACHE_AUTH = 'svn_apache_auth';
     ...
     */
    public const  string UGROUP_UPDATE_USERS_ALLOWED = 'ugroup_update_users_allowed';
     ...
     *     void
     */
    public const string UGROUP_MANAGER_UPDATE_UGROUP_BINDING_ADD = 'ugroup_manager_update_ugroup_binding_add';
     ...
     *     void
     */
    public const string UGROUP_MANAGER_UPDATE_UGROUP_BINDING_REMOVE = 'ugroup_manager_update_ugroup_binding_remove';
     ...
     */
    public const string GET_LDAP_LOGIN_NAME_FOR_USER = 'get_ldap_login_name_for_user';
     ...
     */
    public const string PROCCESS_SYSTEM_CHECK = 'proccess_system_check';
     ...
     */
    public const string IMPORT_XML_PROJECT = 'import_xml_project';
     ...
     */
    public const string COLLECT_ERRORS_WITHOUT_IMPORTING_XML_PROJECT = 'collect_errors_without_importing_xml_project';
     ...
     *   The various plugins create objects from the xml content
     */
    public const string IMPORT_XML_PROJECT_CARDWALL_DONE = 'import_xml_project_cardwall_done';
     ...
     *     Void
     */
    public const string SVN_UPDATE_HOOKS = 'svn_update_hooks';
     ...
     *
     */
    public const string SVN_INTRO = 'svn_intro';
     ...
     *     Void
     */
    public const string PROJECT_SET_PARENT_PROJECT = 'project_set_parent_project';
     ...
     *     Void
     */
    public const string PROJECT_UNSET_PARENT_PROJECT = 'project_unset_parent_project';
     ...
     */
    public const string LAYOUT_SEARCH_ENTRY = 'layout_search_entry';
     ...
     */
    public const string SEARCH_TYPES_PRESENTERS = 'search_types_presenters';
     ...
     */
    public const string REST_RESOURCES = 'rest_resources';
     ...
     *  'informations  => array
     */
    public const string REST_PROJECT_ADDITIONAL_INFORMATIONS = 'rest_project_additional_informations';
     ...
     */
    public const string GET_LOGIN_URL = 'get_login_url';
     ...
     *     'resources' => array
     */
    public const string REST_PROJECT_RESOURCES = 'rest_project_resources';
     ...
     */
    public const string GET_PROJECTID_FROM_URL = 'get_projectid_from_url';
     ...
     *    'can_access' => boolean
     */
    public const string HAS_USER_BEEN_DELEGATED_ACCESS = 'has_user_been_delegated_access';
     ...
     */
    public const string BACKEND_ALIAS_GET_ALIASES = 'backend_alias_get_aliases';
     ...
     *     'total_git_repo'  => int
     */
    public const string REST_PROJECT_GET_GIT = 'rest_project_get_git';
     ...
     *
     */
    public const string PROJECT_ACCESS_CHANGE = 'project_access_change';

    /**
     * When access level of platform changes
     */
    public const string SITE_ACCESS_CHANGE = 'site_access_change';
     ...
     */
    public const string SERVICES_ALLOWED_FOR_PROJECT = 'services_allowed_for_project';
     ...
     *     'services' => array
     */
    public const string SERVICES_TRUNCATED_EMAILS = 'services_truncated_emails';
     ...
     *   group_id  => int
     */
    public const string SERVICE_IS_USED = 'service_is_used';
     ...
     *
     */
    public const string SVN_REPOSITORY_CREATED = 'svn_repository_created';
     ...
     *
     */
    public const string UGROUP_DUPLICATION = 'ugroup_duplication';
     ...
     * @deprecated
     */
    public const string BURNING_PARROT_GET_STYLESHEETS = 'burning_parrot_get_stylesheets';
     ...
     * @deprecated
     */
    public const string BURNING_PARROT_GET_JAVASCRIPT_FILES = 'burning_parrot_get_javascript_files';
     ...
     *    'subject'     => <string>
     */
    public const string MASSMAIL = 'massmail';
     ...
     * Parameters:
     */
    public const string AFTER_MASSMAIL_TO_PROJECT_ADMINS = 'after_massmail_to_project_admins';
     ...
     */
    public const string CONTENT_SECURITY_POLICY_SCRIPT_WHITELIST = 'content_security_policy_script_whitelist';

    /**
     * Event sent at the beginning of display the homepage
     */
    public const string DISPLAYING_HOMEPAGE = 'displaying_homepage';
     ...
     */
    public const string GET_SITEADMIN_HOMEPAGE_USER_STATISTICS = 'get_siteadmin_homepage_user_statistics';
     ...
     */
    public const string GET_SITEADMIN_WARNINGS = 'get_siteadmin_warnings';
     ...
     */
    public const string POST_REFERENCE_EXTRACTED = 'post_reference_extracted';
     ...
     */
    public const string REMOVE_CROSS_REFERENCE = 'remove_cross_reference';
     ...
     */
    public const string GET_REFERENCE_ADMIN_CAPABILITIES = 'get_reference_admin_capabilities';
     ...
     *  - user    => PFUser (IN)
     */
    public const string USER_HISTORY_CLEAR = 'user_history_clear';
}
