...
class LoggerLoggingEvent
{
    ...
    * @param int $timeStamp the timestamp of this logging event.
    */
            ...
            if (function_exists('debug_backtrace')) {
                ...
                while ($hop !== null) {
                    if (isset($hop['class'])) {
                        ...
                        if (
                            ! empty($className) and ($className == 'logger' or $className == 'loggercategory' or
    ...
    public function getTime()
    {
        ...
        $eventStartTime = (float) self::getStartTime();
