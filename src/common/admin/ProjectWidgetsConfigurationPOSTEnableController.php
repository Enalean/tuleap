...
class ProjectWidgetsConfigurationPOSTEnableController implements DispatchableWithRequest
{
    /**
     * @var WidgetFactory
     */
    ...
    public function process(HTTPRequest $request, BaseLayout $layout, array $variables)
    {
        ...
        $this->disabled_project_widgets_dao->enableWidget($widget_name);

        $layout->addFeedback(
            \Feedback::INFO,
            _('Widget successfully enabled.')
        );
