...
class GroupSearchDisplay extends AdminSearchDisplay {
    ...
    function displaySearchFilter() {
        ...
        print '<p><input type="submit" value="'.$GLOBALS['Language']->getText('global','btn_browse').'" name="SUBMIT"/> <input type="text" value="'.$this->nbrows.'" maxlength="5" size="3" name="nbrows"/> groups at once.</p>';
