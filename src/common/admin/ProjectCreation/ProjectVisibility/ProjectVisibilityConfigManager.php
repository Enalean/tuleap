...
class ProjectVisibilityConfigManager
{
    ...
    public const string PROJECT_ADMIN_CAN_CHOOSE_VISIBILITY    = 'project_admin_can_choose_visibility';
    public const string SEND_MAIL_ON_PROJECT_VISIBILITY_CHANGE = 'send_mail_on_project_visibility_change';
