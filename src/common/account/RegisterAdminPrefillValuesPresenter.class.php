...
class Account_RegisterAdminPrefillValuesPresenter extends Account_RegisterPrefillValuesPresenter {
    ...
    public function __construct($login_name, $email, $realname, $register_purpose, $mail_site, $timezone, $restricted, $send_email) {
        parent::__construct($login_name, $email, $realname, $register_purpose, $mail_site, $timezone);
