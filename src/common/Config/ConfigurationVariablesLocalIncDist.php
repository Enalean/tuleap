...
final readonly class ConfigurationVariablesLocalIncDist
{
    ...
    public const string SUPPORTED_LANGUAGES = 'sys_supported_languages';

    #[ConfigKey('Default language')]
    #[ConfigCannotBeModifiedYet]
    #[ConfigKeyString('en_US')]
    public const string DEFAULT_LANG = 'sys_lang';

    #[ConfigKey('Is license approval mandatory when downloading a file from the FRS ?')]
    #[ConfigCannotBeModifiedYet]
    #[ConfigKeyLegacyBool(false)]
    public const string FRS_LICENSE_MANDATORY = 'sys_frs_license_mandatory';
    ...
    #[ConfigCannotBeModifiedYet]
    #[ConfigKeyString('')]
    public const string EXCHANGE_POLICY_URL = 'sys_exchange_policy_url';
    ...
    public const string SESSION_LIFETIME = 'sys_session_lifetime';
    ...
    EOT)]
    #[ConfigKeyInt(3600)]
    public const string LAST_ACCESS_RESOLUTION = 'last_access_resolution';

    #[ConfigKey('Duration before deleting pending accounts which have not been activated (in days)')]
    #[ConfigCannotBeModifiedYet]
    #[ConfigKeyInt(60)]
    public const string PENDING_ACCOUNT_LIFETIME = 'sys_pending_account_lifetime';

    #[ConfigKey('Suspend user account after a given period of inactivity (in days)')]
    #[ConfigCannotBeModifiedYet]
    #[ConfigKeyHelp('0 = no inactivity checking')]
    #[ConfigKeyInt(0)]
    public const string SUSPEND_INACTIVE_ACCOUNTS_DELAY = 'sys_suspend_inactive_accounts_delay';
    ...
    EOT)]
    #[ConfigKeyInt(0)]
    public const string SUSPEND_NON_PROJECT_MEMBER_DELAY = 'sys_suspend_non_project_member_delay';
    ...
    EOT)]
    #[ConfigKeyInt(3)]
    public const string FILE_DELETION_DELAY = 'sys_file_deletion_delay';
    ...
    * upload_max_filesize
    ...
    public const string MAX_SIZE_UPLOAD = 'sys_max_size_upload';

    #[ConfigKey('Enable project categorization')]
    #[ConfigCannotBeModifiedYet]
    #[ConfigKeyLegacyBool(true)]
    public const string USE_TROVE = 'sys_use_trove';

    #[ConfigKey('User\'ss avatar path')]
    #[ConfigCannotBeModifiedYet]
    #[ConfigKeyString('/var/lib/tuleap/user/avatar/')]
    public const string AVATAR_PATH = 'sys_avatar_path';
    ...
    EOT)]
    #[ConfigKeyLegacyBool(true)]
    public const string DISPLAY_PROJECT_PRIVACY_IN_SERVICE_BAR = 'sys_display_project_privacy_in_service_bar';
    ...
    EOT)]
    #[ConfigKeyInt(100)]
    public const string MAX_NUMBER_OF_EMAILED_PEOPLE = 'sys_max_number_of_emailed_people';
    ...
    EOT)]
    #[ConfigKeyLegacyBool(true)]
    public const string ALLOW_EMPTY_SVN_COMMIT_MESSAGE = 'sys_allow_empty_svn_commit_message';
    ...
    public const string LOGGER_LEVEL = 'sys_logger_level';
    ...
    EOT)]
    #[ConfigKeyString('')]
    public const string DEFAULT_MAIL_DOMAIN = 'sys_default_mail_domain';

    #[ConfigKey('Backup path for deleted projects')]
    #[ConfigCannotBeModifiedYet]
    #[ConfigKeyString('/var/tmp')]
    public const string PROJECT_BACKUP_PATH = 'sys_project_backup_path';
    ...
    EOT)]
    #[ConfigKeyString('')]
    public const string CSP_SCRIPT_SCR_WHITELIST = 'sys_csp_script_scr_whitelist';
    ...
    EOT)]
    #[ConfigKeyString('')]
    public const string TRUSTED_PROXIES = 'sys_trusted_proxies';
}
