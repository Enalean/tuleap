...
final class ProjectByNameRetrieverMiddleware implements MiddlewareInterface
{
    /**
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        $enriched_request = $request->withAttribute(
            \Project::class,
            $this->project_retriever->getProjectFromName($request->getAttribute('project_name'))
        );
