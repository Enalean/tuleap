...
class BackendAliases extends Backend {
     ...
     * - generic aliases like tuleap-admin
     * - mailing list aliases for mailman
     * - user aliases for addresses like user@tuleap.example.com
     *
     * @return bool
     */
    ...
    protected function writeGenericAliases($fp) {
        ...
        fwrite($fp, "# /usr/share/tuleap/src/common/backend/BackendAliases.class.php\n");
        ...
        fwrite($fp, "tuleap-contact:         codendi-admin\n\n");
