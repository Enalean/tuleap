...
class BackendSVN extends Backend {
    ...
    public function updateHooks($project) {
        ...
        $this->createPreRevpropChangeFile($svn_dir, $unix_group_name);
        $this->createPostRevpropChangeFile($svn_dir, $unix_group_name);
    ...
    private function createPreRevpropChangeFile($svn_dir, $unix_group_name) {
    ...
    private function createPostRevpropChangeFile($svn_dir, $unix_group_name) {
