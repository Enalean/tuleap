...
class DateHelper
{
    ...
    public const string PREFERENCE_NAME = 'relative_dates_display';

    public const string PREFERENCE_RELATIVE_FIRST_ABSOLUTE_SHOWN   = 'relative_first-absolute_shown';
    public const string PREFERENCE_ABSOLUTE_FIRST_RELATIVE_SHOWN   = 'absolute_first-relative_shown';
    public const string PREFERENCE_RELATIVE_FIRST_ABSOLUTE_TOOLTIP = 'relative_first-absolute_tooltip';
    public const string PREFERENCE_ABSOLUTE_FIRST_RELATIVE_TOOLTIP = 'absolute_first-relative_tooltip';
