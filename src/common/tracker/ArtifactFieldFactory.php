...
class ArtifactFieldFactory //phpcs:ignore
{
    ...
    public function extractFieldList($post_method = true, $prefix = null)
    {
      ...
      *
      * @see src/www/tracker/include/ArtifactHtml.php#displayAdd
      */
     ...
     */
    public function _getForeignUgroupName($ug, $atid_dest) //phpcs:ignore
    {
