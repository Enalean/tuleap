...
';
	...
	function getSearchBox() {
		...
		$output .= '<input style="font-size:0.8em" type="text" size="22" name="words" value="'. $this->purifier->purify(htmlentities(stripslashes($words), ENT_QUOTES, 'UTF-8'), CODENDI_PURIFIER_CONVERT_HTML).'" /><br />';
